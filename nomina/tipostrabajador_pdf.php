...
function Cabecera($pdf) {
	...
	$pdf->Cell(190, 10, 'Maestro de Tipos de Trabajador', 0, 1, 'C');	
...
Cabecera($pdf);
//	Cuerpo
$query=mysql_query("SELECT CodTipoTrabajador, TipoTrabajador, Estado FROM rh_tipotrabajador ORDER BY CodTipoTrabajador") or die ($sql.mysql_error());
