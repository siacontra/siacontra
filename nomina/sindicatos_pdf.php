...
function Cabecera($pdf) {
	...
	$pdf->Cell(190, 10, 'Maestro de Sindicatos', 0, 1, 'C');	
...
Cabecera($pdf);
//	Cuerpo
$query=mysql_query("SELECT CodSindicato, Nombre, Descripcion, Estado FROM rh_sindicatos ORDER BY CodSindicato") or die ($sql.mysql_error());
while ($field=mysql_fetch_array($query)) {
	$pdf->SetDrawColor(0, 0, 0); $pdf->SetFillColor(255, 255, 255); $pdf->SetTextColor(0, 0, 0);
	$pdf->SetFont('Arial', '', 6);
	$pdf->SetWidths(array(20, 50, 100, 20));
