...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Reporte de Cumplea&ntilde;os</td>
		<td align="right"><a class="cerrar"; href="framemain.php">[Cerrar]</a></td>
	</tr>
</table><hr width="100%" color="#333333" />

<form name="frmentrada" id="frmentrada" method="post" action="pdf_cumpleanios.php" target="iCumpleanio">
...
<br /><div class="divDivision">Listado de Cumplea&ntilde;os</div><br />

<center>
<iframe name="iCumpleanio" id="iCumpleanio" style="border:solid 1px #CDCDCD; width:1000px; height:750px;"></iframe>
</center>
</body>
</html>