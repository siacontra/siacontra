...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Reportes Proyeccion Partidas</td>
		<td align="right"><a class="cerrar"; href="framemain.php">[Cerrar]</a></td>
	</tr>
</table><hr width="100%" color="#333333" />

<form name="frmentrada" id="frmentrada" method="post" action="excel_proyeccion.php" target="iReporte" onsubmit="return validarProyeccion(this);">
