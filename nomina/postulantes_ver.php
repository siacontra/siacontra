...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Registro de Postulantes | Ver</td>
...
if ($rows!=0) {
	...
	<table width="905" class="tblForm">
	  ...
	  <tr>
		...
		<td><input name="apellido1" type="text" id="apellido1" size="25" maxlength="20" value="<?=$field['Apellido1']?>" readonly /></td>
		<td class="tagForm">Materno:</td>
		<td><input name="apellido2" type="text" id="apellido2" size="25" maxlength="20" value="<?=$field['Apellido2']?>" readonly /></td>
	  </tr>
	  <tr>
		<td class="tagForm">Nombres:</td>
		<td><input name="nombres" type="text" id="nombres" size="40" maxlength="30" value="<?=$field['Nombres']?>" readonly /></td>
		<td class="tagForm">Sexo:</td>
		<td>
			<select name="sexo">
				<?php getSexo($field['Sexo'], 1); ?>
			</select>
		</td>
	  </tr>
	</table>
	...
	<table width="905" class="tblForm">
		<tr><td align="center"><textarea name="resumen" id="resumen" cols="200" rows="2" readonly><?=$field['ResumenEjec']?></textarea></td></tr>
	</table>
		...
		<tr>
			...
			<td>
				<select name="pais" id="pais" class="selectMed">
					<?php getPaises($pais1, 1); ?>
				</select>
			</td>
			<td class="tagForm">Estado:</td>
			<td>
				<select name="estado" id="estado" class="selectMed">
					<?php getEstados($estado1, $pais1, 1); ?>
				</select>
			</td>
		</tr>
		<tr>
			...
			<td>
				<select name="municipio" id="municipio" class="selectMed">
					<?php getMunicipios($municipio1, $estado1, 1); ?>
				</select>
			</td>
			<td class="tagForm">Ciudad:</td>
			<td>
				<select name="ciudad" id="ciudad" class="selectMed">
					<?php getCiudades($field['CiudadNacimiento'], $municipio1, 1); ?>
				</select>
		</td>
	  </tr>
	  <tr>
	...
	<table width="905" class="tblForm">
	  <tr>
		...
		<td colspan="3"><input name="dir" type="text" id="dir" size="100" maxlength="255" value="<?=$field['Direccion']?>" readonly /></td>
	  </tr>
	  <tr>
		<td class="tagForm">Referencia:</td>
		<td colspan="3"><input name="referencia" type="text" id="referencia" size="100" maxlength="100" value="<?=$field['Referencia']?>" readonly /></td>
	  </tr>
		<tr>
		<td class="tagForm">Pais:</td>
		<td>
				<select name="pais2" id="pais2" class="selectMed">
					<?php getPaises($pais2, 1); ?>
				</select>
			</td>
		<td class="tagForm">Estado:</td>
		<td>
				<select name="estado2" id="estado2" class="selectMed">
					<?php getEstados($estado2, $pais2, 1); ?>
				</select>
			</td>
	  </tr>
		<tr>
		...
		<td>
				<select name="municipio2" id="municipio2" class="selectMed">
					<?php getMunicipios($municipio2, $estado2, 1); ?>
				</select>
			</td>
		<td class="tagForm">Ciudad:</td>
		<td>
	  ...
	  <tr>
		...
		<td><input name="tel" type="text" id="tel" size="25" maxlength="20" value="<?=$field['Telefono']?>" readonly /></td>
		<td class="tagForm">e-mail:</td>
		<td colspan="3"><input name="email" type="text" id="email" size="45" maxlength="30" value="<?=$field['Email']?>" readonly /></td>
	  </tr>
	</table>
	...
	<table width="905" class="tblForm">
		...
		<td>
				<select name="tdoc" id="tdoc" class="selectMed">
					<?php getMiscelaneos($field['TipoDocumento'], "TIPODOC", 1); ?>
				</select>
			</td>
		<td class="tagForm">Nro. Documento:</td>
		<td colspan="3"><input name="ndoc" type="text" id="ndoc" size="25" maxlength="20" value="<?=$field['Ndocumento']?>" readonly /></td>
	  </tr>
	  <tr>
		...
		<tr>
			...
			<td>
				<select name="gsan" id="gsan" class="selectMed">
					<?php getMiscelaneos($field['GrupoSanguineo'], "SANGRE", 1); ?>
				</select>
			</td>
			<td class="tagForm">Situaci&oacute;n Domicilio:</td>
			<td>
				<select name="sitdom" id="sitdom" class="selectMed">
					<?php getMiscelaneos($field['SituacionDomicilio'], "SITDOM", 1); ?>
				</select>
			</td>
		</tr>
		<tr>
			...
			<td>
				<select name="edocivil" id="edocivil" class="selectMed">
					<?php getMiscelaneos($field['EstadoCivil'], "EDOCIVIL", 1); ?>
				</select>
			</td>
			<td class="tagForm">Fecha Edo. Civil:</td>
			<td><input name="fedocivil" type="text" id="fedocivil" size="15" maxlength="10" value="<?=$fedocivil?>" readonly /></td>
		</tr>
	</table>
	<div style="width:905px" class="divFormCaption">Informaci&oacute;n Adicional</div>
	<table width="905" class="tblForm">
		<tr><td align="center"><textarea name="obs" id="obs" cols="200" rows="2" readonly><?=$field['InformacionAdic']?></textarea></td></tr>
	</table>
	...
	<table width="905" class="tblForm">
		<tr>
			...
			<td>
				<input type="checkbox" value="S" name="flagactividades" id="flagbeneficas" <?=$fbenefica?> onclick="enabledBeneficas(this.form);" disabled="disabled" />
				<textarea name="beneficas" id="beneficas" cols="50" rows="2" <?=$dbeneficas?> readonly><?=$field['Beneficas']?></textarea>
			</td>
			<td class="tagForm">Laborales:</td>
			<td>
				<input type="checkbox" value="S" name="flagactividades" id="flaglaborales" <?=$flaborales?> onclick="enabledLaborales(this.form);" disabled="disabled" />
				<textarea name="laborales" id="laborales" cols="50" rows="2" <?=$dlaborales?> readonly><?=$field['Laborales']?></textarea>
			</td>
		</tr>
		<tr>
			<td class="tagForm">Culturales:</td>
			<td>
				<input type="checkbox" value="S" name="flagactividades" id="flagculturales" <?=$fculturales?> onclick="enabledCulturales(this.form);" disabled="disabled" />
				<textarea name="culturales" id="culturales" cols="50" rows="2" <?=$dculturales?> readonly><?=$field['Culturales']?></textarea>
			</td>
			<td class="tagForm">Deportivas:</td>
			<td>
				<input type="checkbox" value="S" name="flagactividades" id="flagdeportivas" <?=$fdeportivas?> onclick="enabledDeportivas(this.form);" disabled="disabled" />
				<textarea name="deportivas" id="deportivas" cols="50" rows="2" <?=$ddeportivas?> readonly><?=$field['Deportivas']?></textarea>
			</td>
		</tr>
		<tr>
			<td class="tagForm">Religiosas:</td>
			<td>
				<input type="checkbox" value="S" name="flagactividades" id="flagreligiosas" <?=$freligiosas?> onclick="enabledReligiosas(this.form);" disabled="disabled" />
				<textarea name="religiosas" id="religiosas" cols="50" rows="2" <?=$dreligiosas?> readonly><?=$field['Religiosas']?></textarea>
			</td>
			<td class="tagForm">Sociales:</td>
			<td>
				<input type="checkbox" value="S" name="flagactividades" id="flagsociales" <?=$fsociales?> onclick="enabledSociales(this.form);" disabled="disabled" />
				<textarea name="sociales" id="sociales" cols="50" rows="2" <?=$dsociales?> readonly><?=$field['Sociales']?></textarea>
			</td>
		</tr>
	</table>
	</div>
	...
	<table align="center" cellpadding="0" cellspacing="0">
		<tr>
			<td colspan="2"><iframe class="frameTab" style="height:250px; width:905px;" src="postulantes_instruccion_ver.php?registro=<?=$registro?>"></iframe></td>
		</tr>
		<tr>
			<td align="center">
				<div style='width:527px' class='divFormCaption'>Idiomas</div>
				<iframe class="frameTab" style="height:200px; width:525px;" src="postulantes_idioma_ver.php?registro=<?=$registro?>"></iframe>
				</td>	
			<td align="center">
				<div style='width:377px' class='divFormCaption'>Idiomas</div>
				<iframe class="frameTab" style="height:200px; width:375px;" src="postulantes_informatica_ver.php?registro=<?=$registro?>"></iframe>
			</td>			
		</tr>
	</table>
	</div>
	...
	<table align="center" cellpadding="0" cellspacing="0">
		<tr>
			<td><iframe class="frameTab" style="height:450px; width:905px;" src="postulantes_cursos_ver.php?registro=<?=$registro?>"></iframe></td>
		</tr>
	</table>
	</div>
	...
	<table align="center" cellpadding="0" cellspacing="0">
		<tr>
			<td><iframe class="frameTab" style="height:250px; width:905px;" src="postulantes_experiencia_ver.php?registro=<?=$registro?>"></iframe></td>
		</tr>
		<tr>
			<td align="center">
				<div style='width:905px' class='divFormCaption'>Referencias</div>
				<iframe class="frameTab" style="height:200px; width:905px;" src="postulantes_referencias_ver.php?registro=<?=$registro?>"></iframe>
			</td>			
		</tr>
	</table>
	</div>
	...
	<table align="center" cellpadding="0" cellspacing="0">
		<tr>
			<td><iframe class="frameTab" style="height:450px; width:905px;" src="postulantes_documentos_ver.php?registro=<?=$registro?>"></iframe></td>
		</tr>
	</table>
	</div>
	...
	<table align="center" cellpadding="0" cellspacing="0">
		<tr>
			<td><iframe class="frameTab" style="height:450px; width:905px;" src="postulantes_cargos_ver.php?registro=<?=$registro?>"></iframe></td>
		</tr>
	</table>
	</div>
	...
	<table align="center" cellpadding="0" cellspacing="0">
		<tr>
			<td><iframe class="frameTab" style="height:450px; width:905px;" src="postulantes_personales_ver.php?registro=<?=$registro?>"></iframe></td>
		</tr>
	</table>
	</div>
