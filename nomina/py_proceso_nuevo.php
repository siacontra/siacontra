...
<form id="frmentrada" name="frmentrada" action="proyeccion_procesos.php" method="POST" onsubmit="return verificarProcesos(this, 'GUARDAR');">
<?php
include("fphp.php");
connect();
...
<table width="600" class="tblForm">
  ...
  <tr>
   ...
   <tr>
    ...
    <td>
     <select name="tx_nomina" id="tx_nomina" style="width:200px;" >
  ...
  <tr>
    ...
    <td >
     <select name="tx_proceso" id="tx_proceso" style="width:200px;" >
				 <?=
					...
					for ($i=0; $i<$rows; $i++) {
						$field=mysql_fetch_array($query);
						if ($field['Codigo']==$codigo) echo "<option value='".$field['Codigo']."' selected>".$field['Codigo']." - ".($field['Descripcion'])."</option>"; 
  ...
  <tr>
    ...
    <td>
    <select name="tx_periodo" id="tx_periodo" style="width:90px;" >
