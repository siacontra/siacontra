...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Plantilla de Competencias | Nuevo Registro</td>
	</tr>
</table><hr width="100%" color="#333333" />

<form id="frmentrada" name="frmentrada" action="pcompetencias.php" method="POST" onsubmit="return verificarPCompetencia(this, 'GUARDAR');">
...
<table width="700" class="tblForm">
	...
	<tr>
		...
		<td>
			<input type="radio" name="ftipo" id="M" value="M" checked="checked" /> M&uacute;ltiple 
			<input type="radio" name="ftipo" id="U" value="U" /> &Uacute;nico &nbsp;&nbsp;&nbsp;&nbsp;
	...
	<tr>
		...
		<td>
			<input id="A" name="status" type="radio" value="A" checked /> Activo
			<input id="I" name="status" type="radio" value="I" /> Inactivo
		</td>
	</tr>
	<tr>
...
<center><iframe name="iCompetencias" id="iCompetencias" class="frameTab" style="height:500px; width:900px;" src="pcompetencias_plantilla.php?accion=NUEVO"></iframe></center>
</body>
</html>
