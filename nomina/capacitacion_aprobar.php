...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Aprobar Capacitaci&oacute;n</td>
...
<input type='hidden' name='regresar' id='regresar' value='capacitacion_aprobar' />
	...
	<tr>
		...
		<td>
			...
			<select name='fstatus' id='fstatus' class='selectMed' $obj[11]>";
				getStatusCapacitacion($obj[12], 1);
				echo "
			</select>
		</td>
	</tr>
...
<center><input type='button' name='btBuscar' value='Buscar' onclick='filtroCapacitaciones(this.form, ".$limit.", \"capacitacion_aprobar.php\");'></center>
...
<table width="1000" class="tblBotones">
  <tr>
    ...
    <td align="right">
		...
		<input name="btAprobar" type="button" class="btLista" id="btAprobar" value="Aprobar" onclick="cargarOpcion(this.form, 'capacitacion_aprueba.php?tab1=1&tab2=1&tab3=1&tab4=1&tab5=0&tab6=0&tab7=0', 'SELF');" />
