...
<table width="1100" class="tblBotones">
	<tr>
		...
		<td align="right">
			...
			<input type="button" id="btPDF" style="width:100px;" value="PDF" />
		</td>
	</tr>
</table>
...
<table width="100%" class="tblLista">
	...
	$sql = "SELECT
			...
			FROM
				...
				LEFT JOIN pr_acumuladofideicomisodetalle afd ON (tnec.CodOrganismo = afd.CodOrganismo AND tnec.Periodo = afd.Periodo)
	...
	while ($field = mysql_fetch_array($query)) {
		...
		if ($cantidad > 0) $complemento = calculo_antiguedad_complemento_trimestral($fperiodo, $field['CodPersona'], $field['Fingreso']); else $complemento = 0;
