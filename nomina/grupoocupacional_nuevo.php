...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Maestro de Grupo Ocupacional | Nuevo Registro</td>
...
<form id="frmentrada" name="frmentrada" action="grupoocupacional.php" method="POST" onsubmit="return verificarGrupoOcupacional(this, 'GUARDAR');">
<?php
include("fphp.php");
connect();
...
<table width="700" class="tblForm">
  ...
  <tr>
    <td height="20" align="right">&Uacute;ltima Modif.:</td>
    <td>
