...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Tipo de Evaluaciones | Ver Registro</td>
...
<table width="500" class="tblForm">
	...
	<tr>
		...
		<td colspan="3"><input name="descripcion" type="text" id="descripcion" size="75" maxlength="50" value="<?=$field['Descripcion']?>" readonly /></td>
	</tr>
	<tr>
		<td class="tagForm">Estado:</td>
		<td colspan="3">
			<input id="a" name="status" type="radio" value="A" <?=$activo?> disabled="disabled" /> Activo
			<input id="i" name="status" type="radio" value="I" <?=$inactivo?> disabled="disabled" /> Inactivo
		</td>
	</tr>
	<tr>
