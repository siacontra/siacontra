...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo"> Crear Proceso | Editar Registro</td>
...
<form id="frmentrada" name="frmentrada" action="proyeccion_procesos.php" method="POST" onsubmit="return verificarProcesos(this, 'EDITAR');">
<?php
include("fphp.php");
connect();
