...
<form name="frmentrada" id="frmentrada" method="post" action="pdf_relacion_nomina.php" target="iReporte">
...
<table width="1000" class="tblFiltro">
    <tr>
     ...
     <tr>
         ...
         <td align="right">Perfil de la N&oacute;mina:</td>
		   <td>
        	<input type="checkbox" name="chkperfilnom" id="chkperfilnom" value="1" onclick="forzarCheck('chkperfilnom');" checked="checked" />
			<select name="fperfilnom" id="fperfilnom" class="selectBig" onchange="getFOptions_Periodo(this.id, 'fperiodo', 'chkperiodo', document.getElementById('forganismo').value, '6'); getFOptions_Proceso('fperfilnom', 'ftproceso', 'chktproceso', this.value, document.getElementById('forganismo').value, '6');">
				<?=getPNomina($fperfilnom, 0)?>
			</select>
        </td>
    </tr>
