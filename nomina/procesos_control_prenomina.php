...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Control de Procesos (Pre N&oacute;mina)</td>
		<td align="right"><a class="cerrar" href="framemain.php">[cerrar]</a></td>
	</tr>
</table><hr width="100%" color="#333333" />

<form name="frmentrada" id="frmentrada" action="procesos_control_prenomina.php" method="POST">
...
<table width="1000" class="tblBotones">
	<tr>
		...
		<td align="right">
			<input name="btIniciar" type="button" style="width:100px;" id="btIniciar" value="Iniciar Periodo" onclick="cargarPagina(this.form, 'procesos_control_prenomina_iniciar.php');" />
		</td>
	</tr>
</table>
...
<table width="1000" class="tblLista">
	...
	$sql="SELECT 
			...
			FROM 
				pr_procesoperiodoprenomina ppp 
