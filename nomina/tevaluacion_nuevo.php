...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Tipo de Evaluaciones | Nuevo Registro</td>
...
<form name="frmentrada" id="frmentrada" action="tevaluacion.php" method="POST" onsubmit="return verificarTEvaluacion(this, 'GUARDAR');">
...
<table width="500" class="tblForm">
	<tr>
		...
		<td colspan="3"><input name="codigo" type="text" id="codigo" size="5" /></td>
	</tr>
	<tr>
		<td class="tagForm">Descripci&oacute;n:</td>
		<td colspan="3"><input name="descripcion" type="text" id="descripcion" size="50" maxlength="40" />*</td>
	</tr>
	<tr>
