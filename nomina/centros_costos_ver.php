...
<table width="700" class="tblForm">
	...
	<tr>
		...
		<td><input name="descripcion" type="text" id="descripcion" style="width:80%;" maxlength="50" value="<?=($field['Descripcion'])?>" disabled="disabled" /></td>
	</tr>
	<tr>
...
<table width="700" class="tblForm">
	...
	<tr>
        ...
        <td>
            ...
            <input name="nomgrupo_cc" type="text" id="nomgrupo_cc" size="75" disabled="disabled" value="<?=($field['NomGrupoCentroCosto'])?>" />
