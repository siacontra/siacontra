...
<table width="800" class="tblBotones">
  <tr>
    ...
    <td align="right">
			...
			<input name="btNuevo" type="button" class="" id="btNuevo" value="Editar Conceptos de Empleado" onclick="cargarPagina(this.form, 'py_proyeccion_empleado_conceptos.php'); " width="30"/>
...
<table width="400" class="tblLista">
  <tr class="trListaHead">
    ...
    <th width="25" scope="col" align="center">Empleado</th>
...
mp.NomCompleto
FROM
py_empleadoproceso AS pye
INNER JOIN mastpersonas AS mp ON pye.CodPersona = mp.CodPersona
 ";
	...
	while ($field=mysql_fetch_array($query))
	{
        ...
        <td align='center'>".$field['NomCompleto']."</td>
		</tr>";
	}
	echo "
