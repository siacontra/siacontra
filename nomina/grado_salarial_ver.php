...
$query = mysql_query($sql) or die ($sl.mysql_error());
...
<table width="500" class="tblForm">
	...
	<tr>
		...
		<td><input name="codigo" type="text" id="codigo" size="4" maxlength="2" disabled="disabled" value="<?=$field['Grado']?>" /></td>
	</tr>
	<tr>
		<td class="tagForm">Descripci&oacute;n:</td>
		<td><input name="descripcion" type="text" id="descripcion" size="75" maxlength="45" value="<?=($field['Descripcion'])?>" disabled="disabled" /></td>
	</tr>
	<tr>
		<td class="tagForm">Sueldo Minimo:</td>
		<td><input name="sueldo_minimo" type="text" id="sueldo_minimo" size="25" value="<?=number_format($field['SueldoMinimo'], 2, ',', '.')?>" disabled="disabled" /></td>
	</tr>
	<tr>
		<td class="tagForm">Sueldo Maximo:</td>
		<td><input name="sueldo_maximo" type="text" id="sueldo_maximo" size="25" value="<?=number_format($field['SueldoMaximo'], 2, ',', '.')?>" disabled="disabled" /></td>
	</tr>
	<tr>
