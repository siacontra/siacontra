...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Control de Procesos (Pre N&oacute;mina) | Nuevo Registro</td>
	</tr>
</table><hr width="100%" color="#333333" />

<form name="frmentrada" id="frmentrada" action="procesos_control_prenomina.php" method="POST" onsubmit="return verificarProcesoControlIniciar(this, 'INICIAR-PRENOMINA');">
...
<table width="800" class="tblForm">    
    ...
    <tr>
        ...
        <td><input name="fprocesado" type="text" id="fprocesado" size="15" maxlength="10" value="<?=date("d-m-Y")?>" />*</td>
        <td class="tagForm">Fecha de Pago:</td>
        <td><input name="fpago" type="text" id="fpago" size="15" maxlength="10" value="<?=date("d-m-Y")?>" />*</td>
        <td width="125"></td>
    </tr>  
    <tr>
...
<input name="bt_cancelar" type="button" id="bt_cancelar" value="Cancelar" onclick="cargarPagina(this.form, 'procesos_control_prenomina.php');" />
</center><br />
</form>
