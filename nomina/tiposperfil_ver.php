...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Tipos de Perfil de N&oacute;mina | Ver Registro</td>
...
include("fphp.php");
connect();
$sql="SELECT * FROM tipoperfilnom WHERE CodPerfil='".$_GET['registro']."'";
...
if ($rows!=0) {
	...
	<table width='700' class='tblForm'>
	  ...
	  <tr>
	    ...
	    <td><input name='descripcion' type='text' id='descripcion' size='60' maxlength='30' value='".$field['Perfil']."' readonly /></td>
	  </tr>
	  <tr>
