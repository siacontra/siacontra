...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Maestro de Tipos de Contrato | Nuevo Registro</td>
...
<form id="frmentrada" name="frmentrada" action="tiposcontrato.php" method="POST" onsubmit="return verificarTipoContrato(this, 'GUARDAR');">
...
<table width="700" class="tblForm">
  ...
  <tr>
    ...
    <td>
			<input name="nomina" type="radio" value="S" checked /> Si
			<input name="nomina" type="radio" value="N" /> No
		</td>
  </tr>
  <tr>
    <td class="tagForm">Tiene Vencimiento?:</td>
    <td>
			<input name="vence" type="radio" value="S" checked /> Si
			<input name="vence" type="radio" value="N" /> No
		</td>
  </tr>
  <tr>
