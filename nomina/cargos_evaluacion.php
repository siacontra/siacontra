...
<table width="550" class="tblLista">
	...
	<?php
	$sql="SELECT ce.*, e.Descripcion AS Evaluacion FROM rh_cargoevaluacion ce INNER JOIN rh_evaluacion e ON (ce.Evaluacion=e.Evaluacion) WHERE ce.CodCargo='".$codcargo."'";
