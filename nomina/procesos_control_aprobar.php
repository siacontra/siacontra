...
if ($field['FlagAprobado']=="N") $bt="Aprobar Periodo"; else $bt="Desaprobar Periodo";
?>
...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Control de Procesos | Aprobaci&oacute;n</td>
	</tr>
</table><hr width="100%" color="#333333" />

<form name="frmentrada" id="frmentrada" action="procesos_control_aprobacion.php" method="POST" onsubmit="return verificarProcesoControlAprobar(this, 'APROBAR');">
...
<input type="hidden" name="chkaprobados" id="chkaprobados" value="<?=$chkaprobados?>" />
...
<table width="800" class="tblForm">
    ...
    <tr>
        ...
        <td><input name="fdesde" type="text" id="fdesde" size="15" maxlength="10" value="<?=$fdesde?>" readonly="readonly" /></td>
        <td class="tagForm">Hasta:</td>
        <td><input name="fhasta" type="text" id="fhasta" size="15" maxlength="10" value="<?=$fhasta?>" readonly="readonly" /></td>
    </tr>
    <tr>
        <td class="tagForm">Estado:</td>
        <td>
            <input name="status" id="activo" type="radio" value="A" <?=$chkactivo?> disabled="disabled" /> Activo
            <input name="status" id="inactivo" type="radio" value="I" <?=$chkinactivo?> disabled="disabled" /> Inactivo
        </td>
        <td>&nbsp;</td><td><input type="checkbox" name="flagmensual" id="flagmensual" value="S" <?=$chkflagmensual?> disabled="disabled" /> Proceso mensual?</td>
    </tr>
</table>
...
<table width="800" class="tblForm">    
    ...
    <tr>
        ...
        <td><input name="fprocesado" type="text" id="fprocesado" size="15" maxlength="10" value="<?=$fprocesado?>" readonly="readonly" /></td>
        <td class="tagForm">Fecha de Pago:</td>
        <td><input name="fpago" type="text" id="fpago" size="15" maxlength="10" value="<?=$fpago?>" readonly="readonly" /></td>
        <td width="125"></td>
    </tr>  
    <tr>
...
<input name="bt_cancelar" type="button" id="bt_cancelar" value="Cancelar" onclick="cargarPagina(this.form, 'procesos_control_aprobacion.php');" />
</center><br />
</form>
</body>
</html>
