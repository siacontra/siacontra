...
echo "
<form name='frmentrada' action='postulantes_referencias.php' method='POST' onSubmit='return verificarPostReferencias(this, \"".$registro."\");'>
...
<table width='800' class='tblForm'>
  ...
  <tr>
	...
	<td><input type='text' name='empresa' id='empresa' size='35' maxlength='200' />*</td>
    <td class='tagForm'>Cargo:</td>
	<td><input type='text' name='cargo' id='cargo' size='35' maxlength='100' />*</td>
  </tr>	
  <tr>
...
<table width='800' class='tblBotones'>
	<tr>
		<td bgcolor='#CCCCCC' align='right'>
			...
			<input name='btBorrar' type='button' id='btBorrar' value='Eliminar' onClick='eliminarReferencia(this.form, \"postulantes_referencias.php?accion=ELIMINAR&registro=".$_GET['registro']."\");' />
		</td>
	</tr>
</table>";
