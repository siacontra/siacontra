...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Ingresar Acumulado de Fideicomiso</td>
...
<form name="frmentrada" id="frmentrada" action="fideicomiso.php?filtro=<?=$filtro?>&limit=0" method="POST" onsubmit="return verificarFideicomiso(this, 'GUARDAR');">
...
<table width="800" class="tblForm">
	...
	<tr>
		...
		<td><input name="acumuladoinicialdias" type="text" id="acumuladoinicialdias" size="15" />*</td>
	</tr>
	<tr>
		<td class="tagForm">Acumulado Inicial Antiguedad:</td>
		<td><input name="acumuladoinicialprov" type="text" id="acumuladoinicialprov" size="30" />*</td>
	</tr>
	<tr>
		<td class="tagForm">Acumulado Inicial Fideicomiso:</td>
		<td><input name="acumuladoinicialfide" type="text" id="acumuladoinicialfide" size="30" />*</td>
	</tr>
	<tr>
		<td class="tagForm">Acumulado Dias Adicionales:</td>
		<td><input name="acumuladoinicialdiasadicional" type="text" id="acumuladoinicialdiasadicional" size="15" />*</td>
	</tr>
	<tr>
		<td class="tagForm">Periodo Inicial:</td>
		<td><input name="periodoinicial" type="text" id="periodoinicial" size="15" maxlength="7" />*</td>
	</tr>
	<tr>
		<td class="tagForm">Acumulado Dias:</td>
		<td><input name="acumuladodias" type="text" id="acumuladodias" size="15" disabled="disabled" /></td>
	</tr>
	<tr>
		<td class="tagForm">Acumulado Actual Antiguedad:</td>
		<td>
			<input name="acumuladoprov" type="text" id="acumuladoprov" size="30" disabled="disabled" /> - 
			<input name="acumuladoprov2" type="text" id="acumuladoprov2" size="30" disabled="disabled" />
		</td>
	</tr>
	<tr>
		<td class="tagForm">Acumulado Actual Fideicomiso:</td>
		<td>
			<input name="acumuladofide" type="text" id="acumuladofide" size="30" disabled="disabled" /> - 
			<input name="acumuladofide2" type="text" id="acumuladofide2" size="30" disabled="disabled" />
		</td>
	</tr>
	<tr>
