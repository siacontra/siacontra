...
if ($chkaprobados=="S") $caprobados="checked"; else $filtro.="AND ppp.FlagAprobado='N'";
//	----------------------------
?>
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Aprobaci&oacute;n de Procesos</td>
		<td align="right"><a class="cerrar" href="framemain.php">[cerrar]</a></td>
	</tr>
</table><hr width="100%" color="#333333" />

<form name="frmentrada" id="frmentrada" action="procesos_control_aprobacion.php" method="POST">
...
<table width="1000" class="tblFiltro">
    ...
    <tr><td>&nbsp;</td><td><input type="checkbox" name="chkaprobados" id="chkaprobados" value="S" <?=$caprobados?> /> Mostrar Procesos Aprobados</td></tr>
</table>
</div>
...
<table width="1000" class="tblBotones">
	<tr>
		...
		<td align="right">
			<input name="btAprobar" type="button" style="width:150px;" id="btAprobar" value="Aprobar / Desaprobar" onclick="cargarOpcion(this.form, 'procesos_control_aprobar.php', 'SELF');" />
		</td>
	</tr>
</table>
...
<script type="text/javascript" language="javascript">
	totalRegistrosProcesosControlAprobar(<?=$rows?>, "<?=$_ADMIN?>", "<?=$_INSERT?>", "<?=$_UPDATE?>", "<?=$_DELETE?>");
</script>
</table>
</form>
</body>
