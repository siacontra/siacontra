...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Tipos de Perfil de N&oacute;mina | Nuevo Registro</td>
...
<form id="frmentrada" name="frmentrada" action="tiposperfil.php" method="POST" onsubmit="return verificarTipoPerfil(this, 'GUARDAR');">
