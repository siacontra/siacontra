...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Maestro de Profesiones | Nuevo Registro</td>
...
<form id="frmentrada" name="frmentrada" action="profesiones.php" method="POST" onsubmit="return verificarProfesion(this, 'GUARDAR');">
<?php
include("fphp.php");
connect();
...
<table width="700" class="tblForm">
  <tr>
    ...
    <td><input name="codigo" type="text" id="codigo" size="8" maxlength="6" readonly /></td>
  </tr>
  <tr>
    <td class="tagForm">Descripci&oacute;n:</td>
    <td><input name="descripcion" type="text" id="descripcion" size="75" maxlength="200" />*</td>
  </tr>
	<tr>
