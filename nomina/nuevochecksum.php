...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Realizar Check Sum del Archivo a Banco </td>
		<td align="right"><a class="cerrar"; href="framemain.php">[Cerrar]</a></td>
	</tr>
</table><hr width="100%" color="#333333" />

<form enctype="multipart/form-data" name="frmentrada" id="frmentrada" onsubmit="return checkSumTxtNomina(this);">
...
<table width="1000" class="tblFiltro">
    <tr>
        ...
        <td align="right">Archivo a verificar:</td>
        <td>
		<input type="file" style="width:200px; display:block;" class="ui-corner-all" id="archivoSubir" name="archivoSubir">
   		<input type="hidden" name="archivo" id="archivo" size="50" value="archivoSistema" /></td>
    </tr>
    <tr>
        <td align="right">Per&iacute;odo:</td>
        <td><input type="checkbox" name="chkperiodo" id="chkperiodo" value="1" onclick="forzarCheck('chkperiodo');" checked="checked" />
        ...
        <td>
        	<!--<input type="button" id="archivoValidar"  value="Cargar archivo..." />-->
    ...
    <tr>
      <td colspan="4" align="right"><div id="capaRespuesta" align="center" ></div></td>
      </tr>
    <tr>
      <td align="right">&nbsp;</td>
      <td>&nbsp;</td>
...
var upload_input = document.querySelectorAll('#archivoSubir')[0];
