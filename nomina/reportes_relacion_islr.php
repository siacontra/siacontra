...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Reporte de Retenciones de Impuesto Sobre la Renta</td>
		<td align="right"><a class="cerrar"; href="framemain.php">[Cerrar]</a></td>
	</tr>
</table><hr width="100%" color="#333333" />

<form name="frmentrada" id="frmentrada" method="post" action="pdf_relacion_islr.php" target="iReporte">
...
<br /><div class="divDivision">Reporte de Retenciones de Impuesto Sobre la Renta</div><br />
