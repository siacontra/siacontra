...
<table width="100%" cellspacing="0" cellpadding="0">
 <tr>
  <td class="titulo">Reporte | Cierre Mes</td>
  <td align="right">
...
?>
<? echo"
<form name='frmentrada' action='rp_cierremes.php?limit=0' method='POST'>
...
<center><input type='submit' name='btBuscar' value='Buscar' onclick='cargarCierreMesPresupuestarioRP(this.form);'></center>
...
<center>
<iframe name="rp_cierremespdf" id="rp_cierremespdf" style="border:solid 1px #CDCDCD; width:900px; height:400px; visibility:false; display:false;" ></iframe>
</center>
<form/>
</body>
</html>