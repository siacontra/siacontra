...
$sql="SELECT MAX(UltimaFecha) FROM pv_antepresupuesto";
$query=mysql_query($sql) or die ($sql.mysql_error());
if(mysql_num_rows($query)!=0){
  $field=mysql_fetch_array($query);
  $sqlAnt="SELECT * FROM pv_antepresupuesto WHERE UltimaFecha='".$field['0']."'";
...
<table width="800" class="tblForm">
	...
	<tr><td></td>
	  ...
	  <td><input name="montorestante" id="montorestante" type="text" size="20" maxlength="15" value="0.00" readonly/></td>
	</tr>
	<tr><td></td></tr>
	<tr><td></td>
