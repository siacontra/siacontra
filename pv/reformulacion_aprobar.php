...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Reformulaci&oacute;n | Aprobar</td>
...
if(!$_POST) $cstatus = "checked"; else $cstatus = "checked";
...
//	-------------------------------------------------------------------------------
echo "
<form name='frmentrada' action='reformulacion_aprobar.php?limit=0' method='POST'>";
...
<table width="900" class="tblBotones">
 <tr>
  ...
  <td align="center">
	<?php 
	echo"<input type='hidden' name='regresar' id='regresar' value='reformulacion_aprobar'/>" ;
...
<input name="btVer" type="button" class="btLista" id="btVer" value="Ver" onclick="cargarOpcion(this.form, 'reformulacion_ver.php', 'BLANK', 'height=500, width=950, left=200, top=200, resizable=no');" /> 
...
<input name="btMostrar" type="button" class="btLista" id="btMostrar" value="Aprobar" onclick="cargarPagina(this.form, 'reformulacion_aprobar2.php');"/>
