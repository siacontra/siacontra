...
if($rows!=0) {
  ...
  //////   PRUEBA  //////    //////    //////  //////    //////
  echo "
  <form name='frmentrada' action='msector.php?accion=editarSector' method='POST' onsubmit='return verificarSector(this, \"EDITAR\");'>
  ...
  <tr>
    ...
    <td><input name='cod' type='text' id='cod' size='4' maxlength='2' value='".$field['cod_sector']."' readonly /></td>
	        <td><input name='codigo' type='hidden' id='codigo' size='4' maxlength='2' value='".$field['cod_sector']."' readonly /></td>
  </tr>
  <tr>
