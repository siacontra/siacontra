...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Reporte | Ejecuci&oacute;n por Espec&iacute;fica</td>
...
if ($fpartida2 != "") $cPartida = "checked";else $dPartida = "disabled";
//	-------------------------------------------------------------------------------
//// ------------------------------------------------------------------------------
echo "
<form name='frmentrada' id='frmentrada' method='POST' action='rp_ejecucionespecificapdf.php'  target='reporte'>
...
<tr>
  ...
  <td>
	...
	<input type='text' name='fPartida' id='fPartida' size='11' maxlength='12' $dPartida value='$fPartida' onclick='valorDestino(this.form,this.id)'/> - 
	<input type='text' name='fPartida2' id='fPartida2' size='11' maxlength='12' $dPartida value='$fPartida2' onclick='valorDestino(this.form,this.id)'/>";?> <input type='button' id='btPartida' name='btPartida' value='...' onclick="cargarVentanaListaPatidas(this.form, 'rp_listapartidas.php?limit=0&campo=2', 'height=500, width=800, left=200, top=200, resizable=yes');" disabled/>
  <? echo"</td>
  <td align='right'>P. Ejecuci&oacute;n:</td>
  <td><input type='checkbox' id='chkPEjecucion' name='chkPEjecucion' value='1' $cPEjecucion onclick='this.checked=true;'/>
...
<tr>
  ...
  <td>
	...
	<input type='text' name='fNumPresupuesto' id='fNumPresupuesto' size='6' maxlength='4' $dNumPresupuesto value='$fNumPresupuesto'/>";?> <input type='button' id='btPresupuesto' name='btPresupuesto' value='...' onclick="cargarVentanaRpNumeroPresupuesto(this.form, 'rp_listapresupuestos.php?limit=0&campo=3', 'height=500, width=850, left=200, top=200, resizable=yes');" disabled/>
  <? echo"  </td>
  <td align='right'></td>
  <td align='left'></td>
</tr>
...
<center><input type='hidden' id='selector' name='selector' value=''/><input type='submit' name='btBuscar' value='Buscar' onclick='filtroReporteEjecucionEspecifica(this.form, 0);'></center>
