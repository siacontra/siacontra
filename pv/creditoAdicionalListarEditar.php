...
<?php
	...
	echo 'cargarDatosCreditoAdicional('.$coCreditoAdicional.');';
	echo '</script>';
?>
...
<tr>
 <td class="titulo">Credito Adicional | Editar</td>
 <td align="right"><a class="cerrar"  href="#"; onclick="javascritp:location.href='framemain.php'">[Cerrar]</a></td>
</tr>
...
<tr>
 ...
 <td width="80"><input name="gaceta" id="gaceta" type="text" size="8" />*</td>
 <td width="88" align="right">F. Oficio:</td>
 <td width="150"><input name="fgaceta" id="fgaceta" type="text" size="8" maxlength="10" onchange="validaFormatoFecha()" />*<i>(dd-mm-aaaa)</i></td>
 <td colspan="2" width="178"></td>
</tr>
<tr>
 <td width="164"></td>
 <td width="112" align="right">Nro. Decreto:</td>
 <td width="80"><input name="decreto" id="decreto" type="text" size="8" />*</td>
 <td width="88" align="right">F. Decreto:</td>
 <td width="150"><input name="fdecreto" id="fdecreto" type="text" size="8" maxlength="10" onchange="validaFormatoFecha()" />*<i>(dd-mm-aaaa)</i></td>
 <td colspan="2" width="178"></td>
</tr>
...
<tr>
  ...
  <td colspan="2"><input type="text" name="txt_monto" id="txt_monto" onkeypress="return(formatoMoneda(this,'.',',',event));" value="0,00" style="text-align:right"/></td>
  <td>&nbsp;</td>
  <td colspan="2"></td>
</tr>
<tr>
...
<tr>
 <td width="164"></td>
 <td align="left" colspan="4"><textarea name="txt_motivo" id="txt_motivo" cols="50" rows="5" style="width:100%; resize: none;" onKeyDown="contador('txt_motivo',1000)" ></textarea></td>
...
<!---/////////////////// ********   CARGAR SELECT SECTOR PRESUPUESTO  *******   /////////////////////-->
 <table width="800" class="tblForm" border="0px">
    ...
    <tr>
	 ...
	 -->
      <td width="45"><input name="txt_partida" id="txt_partida" type="text" onkeyup="campoSiguiente(event,'txt_partida','txt_general','txt_actividad');validaSoloNumeros(id)"  size="3" maxlength="3" /></td>
      <td width="45"><input name="txt_general" id="txt_general" type="text" onkeyup="campoSiguiente(event,'txt_general','txt_especifico','txt_partida');validaSoloNumeros(id)" size="3" maxlength="2" /></td>
	  <td width="45"><input name="txt_especifico" id="txt_especifico" type="text" onkeyup="campoSiguiente(event,'txt_especifico','txt_sub_especifico','txt_general');validaSoloNumeros(id)" size="3" maxlength="2" /></td>
	  <td width="45"><input name="txt_sub_especifico" id="txt_sub_especifico" type="text" onkeyup="campoSiguiente(event,'txt_sub_especifico','txt_ordinal','txt_especifico');validaSoloNumeros(id)" size="3" maxlength="2" /></td>
      <td width="45"><input name="txt_ordinal" id="txt_ordinal" type="text"  onkeyup="campoSiguiente(event,'txt_ordinal','txt_monto_item','txt_sub_especifico');validaSoloNumeros(id)" size="3" maxlength="3" /></td>
      <td width="75">&nbsp;</td>
	  <td width="75"><input name="txt_monto_item" id="txt_monto_item" type="text" value="0,00" onChange="" size="auto" maxlength="*" style="text-align:right" onkeypress="return(formatoMoneda(this,'.',',',event));" 	onkeyup="agregarItemEnter(event)" /></td>
	  <td width="150">&nbsp;</td>                       
	</tr>
...
<tr><td></td>
   ...
   <td> 	     
	    ...
	    <input name='fecha_aprobada' type='text' id='fecha_aprobada' size='22' readonly /> 
           <input name="bt_examinar" id="bt_examinar" type="button" value="..." onclick="cargarVentana2(this.form,  'lista_empleados.php?limit=0&campo=1', 'height=500, width=800, left=200, top=200, resizable=yes,  self=yes','vEmerjente3');" />* 
...
<center>
<input name="btguardar" type="submit" id="btguardar" value="Guardar Registro" onclick="validarCampoCreditoAdicionalEditar()"/>
