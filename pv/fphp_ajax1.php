...
elseif ($_POST['modulo']=="GRUPOOCUPACIONAL") {
	...
	if ($_POST['accion']=="GUARDAR") {		
		...
		if ($rows!=0)	$error="REGISTRO EXISTENTE";
			...
			// $codigo=getCodigo("rh_grupoocupacional", "CodGrupOcup", 3); se comenta debido a que el codigo es de cinco digitos y debe ser ingresado por el usuario
			//	INSERTO EL NUEVO REGISTRO
