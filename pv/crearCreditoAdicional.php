...
<tr>
 <td class="titulo">Credito Adicional | Nuevo</td>
...
<tr>
  ...
  <td class="tagForm">Preparado por:</td><?  $sql3=mysql_query("SELECT * FROM usuarios WHERE Usuario='".$_SESSION['USUARIO_ACTUAL']."'");
										  ...
										  ?>
   <td><input name="prepor" id="prepor" type="text" size="60" value="<?=htmlentities($field4['NomCompleto'])?>" readonly/>
...
<center>
<input name="btguardar" type="submit" id="btguardar" value="Guardar Registro" onclick="validarCampoCreditoAdicional()"/>
