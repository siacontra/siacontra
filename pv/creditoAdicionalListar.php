...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Listar Credito Adicional</td>
...
<td align="right">
<input name="btNuevo" type="button" class="btLista" id="btNuevo" value="Nuevo" onclick="cargarPagina(this.form, 'crearCreditoAdicional.php');" />
<input name="btEditar" type="button" class="btLista" id="btEditar" value="Editar" onclick="cargarOpcion(this.form, 'creditoAdicionalListarEditar.php?accionE=EDITAR','SELF');"/>
<!--<input name="btEliminar" type="button" class="btLista" id="btEliminar" value="Eliminar" onclick="eliminarCreditoAdicional(this.form, 'creditoAdicionalListar.php?accion=ELIMINARCREDITO', '1', 'APLICACIONES');" />-->
<input name="btVer" type="button" class="btLista" id="btVer" value="Ver" onclick="cargarOpcion(this.form, 'creditoAdicionalListarVer.php?accion=VER', 'BLANK', 'height=500, width=950, left=200, top=200, resizable=no');" /> 
...
if($registros!=0){ 
	  ...
	  <td align='justify'>".htmlentities($field['tx_motivo'])."</td>";
