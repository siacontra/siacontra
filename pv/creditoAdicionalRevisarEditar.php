...
<tr>
 <td class="titulo">Credito Adicional | Revisar</td>
 <td align="right"><a class="cerrar"  href="creditoAdicionalRevisar.php">[Cerrar]</a></td>
</tr>
...
<center>
<input name="btguardar" type="submit" id="btguardar" value="Revisar" onclick="guardarRevisarCreditoAdicional(this.form)"/>
<input name="btcancelar" type="button" id="btcancelar" value="Cancelar" onclick="javascript:location.replace('creditoAdicionalRevisar.php')"/>
</center></div>
...
function guardarRevisarCreditoAdicional()
{		
	//alert('asdasdds');
	var revisadoPor=xGetElementById('usuarioActual').value;
	...
	if(confirm('¿Esta seguro de REVISAR el crédito adicional?'))
	{	
			...
			AjaxRequest.post
														...
														(

															{
																...
																,'url':url
																,'onSuccess': respGuardarRevisarCreditoAdicional
...
function respGuardarRevisarCreditoAdicional(req)
{
	...
	{
		alert('Se ha Revisado con exito el crédito adicional');
	...
	{
		alert('Error al Revisar el crédito adicional');
	}
	location.replace('creditoAdicionalRevisar.php');
     /*if (!theForm) {
