...
<script type="text/javascript" language="javascript" src="fscriptpresupuesto.js"></script><link href="js/Calendario/jsDatePick_ltr.css"  media="all" rel="stylesheet" type="text/css" />
...
if($row!=0){
 for($i=0; $i<$row; $i++){
  ...
  echo "<tr class='trListaBody'>
	  ...
	  <td align='right'><b><input class='inputP' type='text' style='text-align:right' size='12' maxlength='12' name='partida_preDMA[]' id='partida_preDMA' value='$m_ajustado' />Bs.F
