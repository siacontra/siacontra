...
function cargarVentana2(form, pagina, param, name) {
	window.open(pagina, name, "toolbar=no, menubar=no, location=no, scrollbars=yes, "+param);
}
//	FUNCION PARA CARGAR UNA NUEVA VENTANA
...
//// **** FUNCION ELIMINAR AJUSTE
function eliminarReintegro(form, pagina, foraneo, modulo) {
	var codigo=form.registro.value;
	if (codigo=="") msjError(1000);
	else {
		//	PREGUNTO SI DESEA ELIMINAR
		...
		if (eliminar) {
			if (foraneo) {
				...
				ajax.open("POST", "fphp.php", true);
				ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
				ajax.send("modulo="+modulo+"&accion=ELIMINARAREINTEGRO&codigo="+codigo);
				ajax.onreadystatechange=function() {
					if (ajax.readyState==4)	{
						var error=ajax.responseText;
						if (error!=0) alert ("¡"+error+"!");
...
//	FUNCION PARA BLOQUEAR/DESBLOQUEAR
function enabledAprobado(form) {
	if (form.chkaprobado.checked) form.faprobado.disabled=false; 
	else{ form.faprobado.disabled=true; form.faprobado.value=""; }
}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
function presupuesto_ajusteAnular(form) {
	...
	if (codigo=="") msjError(1000);
		 ...
		 arrayResult= codigo.split("|");
		//	PREGUNTO SI DESEA ANULAR
		var anular=confirm("¡Esta seguro de anular este Ajuste?  \n\n Codigo de Ajuste: "+arrayResult[0]+" \n\n Nota: No se pueden anular los que esten Aprobados");
		if (anular) {
			//	CREO UN OBJETO AJAX PARA VERIFICAR QUE EL NUEVO REGISTRO NO EXISTA EN LA BASE DE DATOS
			var ajax=nuevoAjax();
			ajax.open("POST", "fphp.php", true);
			ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
			ajax.send("modulo=AJUSTES&accion=ANULAR&codigo="+codigo);
			ajax.onreadystatechange=function() {
				if (ajax.readyState==4)	{
					var error=ajax.responseText;
					if (error!=0) alert ("¡"+error+"!");
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
function ProcesoAnularReintegros(form) {
	...
	if (codigo=="") msjError(1000);
		...
		if (anular) {
			...
			ajax.open("POST", "fphp.php", true);
			ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
			ajax.send("modulo=REINTEGRO&accion=ANULAR&codigo="+codigo);
			ajax.onreadystatechange=function() {
				if (ajax.readyState==4)	{
					var error=ajax.responseText;
					if (error!=0) alert ("¡"+error+"!");
					else cargarPagina(form, "ProcesoListarReintegro.php");
				}
			}
		}	
	}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////***********   APROBAR CREDITOS  *******/////////////////////////////////
function aprobarCreditoAdicional(form){
	...
	if (codigo=="") msjError(1000);
		...
		//	PREGUNTO SI DESEA ANULAR
		var anular=confirm("¡Esta seguro de APROBAR el Credito adicional?");
		if (anular) {
			//	CREO UN OBJETO AJAX PARA VERIFICAR QUE EL NUEVO REGISTRO NO EXISTA EN LA BASE DE DATOS
			var ajax=nuevoAjax();
			ajax.open("POST", "fphp.php", true);
			ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
			ajax.send("modulo=CREDITO&accion=APROBARCREDITO&codigo="+codigo);
			ajax.onreadystatechange=function() {
				if (ajax.readyState==4)	{
					var error=ajax.responseText;
					if (error!=0) alert ("¡"+error+"!");
					else cargarPagina(form,"creditoAdicionalAprobar.php");
				}
			}
		}	
	}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////***********   REVISAR CREDITOS  *******/////////////////////////////////
function revisarCreditoAdicional(form){
	...
	if (codigo=="") msjError(1000);
		...
		//	PREGUNTO SI DESEA ANULAR
		var anular=confirm("¡Esta seguro de haber revisado el Credito adicional?");
		if (anular) {
			//	CREO UN OBJETO AJAX PARA VERIFICAR QUE EL NUEVO REGISTRO NO EXISTA EN LA BASE DE DATOS
			var ajax=nuevoAjax();
			ajax.open("POST", "fphp.php", true);
			ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
			ajax.send("modulo=CREDITO&accion=REVISARCREDITO&codigo="+codigo);
			ajax.onreadystatechange=function() {
				if (ajax.readyState==4)	{
					var error=ajax.responseText;
					if (error!=0) alert ("¡"+error+"!");
					else cargarPagina(form,"creditoAdicionalRevisar.php");
				}
			}
		}	
	}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////***********   ANULAR CREDITOS  *******/////////////////////////////////
function AnularCreditoAdicional(form){
	...
	if (codigo=="") msjError(1000);
		...
		//	PREGUNTO SI DESEA ANULAR
		var anular=confirm("¡Esta seguro de ANULAR el Credito adicional?");
		if (anular) {
			//	CREO UN OBJETO AJAX PARA VERIFICAR QUE EL NUEVO REGISTRO NO EXISTA EN LA BASE DE DATOS
			var ajax=nuevoAjax();
			ajax.open("POST", "fphp.php", true);
			ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
			ajax.send("modulo=CREDITO&accion=ANULARCREDITO&codigo="+codigo);
			ajax.onreadystatechange=function() {
				if (ajax.readyState==4)	{
					var error=ajax.responseText;
					if (error!=0) alert ("¡"+error+"!");
					else cargarPagina(form,"creditoAdicionalListar.php");
				}
			}
		}	
	}
...
//// **** FUNCION ELIMINAR CREDITO ADICIONAL
function eliminarCreditoAdicional(form, pagina, foraneo, modulo) {
	...
	if (codigo=="") msjError(1000);
		...
		if (eliminar) {
			if (foraneo) {
				...
				ajax.open("POST", "fphp.php", true);
				ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
				ajax.send("modulo="+modulo+"&accion=ELIMINARCREDITOADICIONAL&codigo="+codigo);
				ajax.onreadystatechange=function() {
					if (ajax.readyState==4)	{
						var error=ajax.responseText;
						if (error!=0) alert ("¡"+error+"!");
