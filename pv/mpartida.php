...
<table width="950" class="tblBotones">
 <tr>
  ...
  <td width="250"><?php echo "
   ...
   <input name="btVer" type="button" class="btLista" id="btVer" value="Ver" onclick="cargarOpcion(this.form, 'ver_partida.php', 'BLANK', 'height=350, width=750, left=250, top=250, resizable=no');" />
