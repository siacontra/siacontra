...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Reporte | Compromisos</td>
...
if ($partida !="") $cnpartida = "checked"; else $dnpartida = "disabled";
//	-------------------------------------------------------------------------------
$MAXLIMIT=30;
//// ------------------------------------------------------------------------------
echo "
<form name='frmentrada' action='rp_compromisos.php?limit=0' method='POST'>";
...
<tr>
  <td width='90' align='right'>Nro. Partida:</td>
  <td width='100'>
	<input type='checkbox' name='chkpartida' id='chkpartida' value='1' $cnpartida onclick='enabledPPartida(this.form);' />
	<input type='text' name='fpartida' id='fpartida' size='11' maxlength='12' $dnpartida value='$fnpresupuesto' />
  </td>
...
<center><input type='submit' name='btBuscar' value='Buscar' onclick='cargarReporteCompromiso(this.form);'></center>
...
<center>
<iframe name="rp_compromisos" id="rp_compromisos" style="border:solid 1px #CDCDCD; width:1000px; height:400px; visibility:false; display:false;" ></iframe>
</center>
<form/>
</body>
</html>