...
<tr>
 <td class="titulo">Reporte | Rresupuesto</td>
...
$sqlP="SELECT * FROM pv_presupuesto WHERE CodPresupuesto='".$_GET['registro']."'";
	  ...
	  <td>
	    <table width="642" height="5">
		 <tr>
		  ...
		  <td colspan="3"></td>
		  <td width="59" align="center">EJECUTADO</td>
		  <td colspan="3"></td>
		  <td width="62" align="center">DISPONIBLE</td>
		 </tr>
		 <tr>
		  <td colspan="2" width="180" align="right">Totales:</td><? $m_presupuestado=$fieldP['MontoAprobado']; $m_presupuestado=number_format($m_presupuestado,2,',','.')?>
		  ...
		  <td colspan="3"></td>
		  <td align="center"><input type="text" class="inputG" size="14" style="text-align:right" name="comprometido2" id="comprometido2" readonly /></td>
		  <td colspan="3"></td>
		  <td align="center"><input type="text" class="inputG" size="14" style="text-align:right" name="ejecutado" id="ejecutado" readonly /></td>
		  <td colspan="3"></td>
		  <td align="center"><input type="text" class="inputG" size="14" style="text-align:right" name="disponible" id="disponible" value="<?=$m_presupuestado?>" readonly /></td>
		 </tr>
		</table>
	  </td>
	 </tr>
...
<div style="width:850px; height:15px" class="divFormCaption">Detalle de Presupuesto</div>
...
<table width="100%" class="tblLista" border="0">
  <tr class="trListaHead">
		...
		<th width="44" scope="col">T.Ejecutado</th>
...
$sql="SELECT * 
        FROM pv_presupuesto 
       WHERE CodPresupuesto='".$_GET['registro']."' AND
   ...
   if(($fielDet['partida']!=00) and (($cont1==0) or ($pCapturada!=$fielDet['partida']))){
    ...
    if(mysql_num_rows($qryP)!=0){
	 ...
	 echo "<tr class='trListaBody6'>
	  ...
	  <td align='center'><input type='text' class='inputP' size='12' maxlength='12' id='MontoAprobadoPar' style='text-align:right' value='$montoAprobado' readonly/></td>
	  <td align='center'><input type='text' class='inputP' size='12' maxlength='12' readonly/></td>
	   <td align='center'><input type='text' class='inputP' size='12' maxlength='12' readonly/></td>
	  <td align='right'><b><input class='inputP' type='text' size='12' maxlength='12' id='".$codigo_partida."' style='text-align:right' name='".$fielDet['CodPresupuesto']."' value='$montoAprobado' readonly/></td></b>         
	     </tr>";
	    }
	  }
  //////////////////////////////////////////////////////////////////////////////////////
  ...
  if(($fielDet['generica']!=00) and (($cont2==0) or ($gCapturada!=$fielDet['generica']) or ($pCapturada2!=$fielDet['partida']))){
	 ...
	 if(mysql_num_rows($qryP)){
	  ...
	  $gCapturada = $fieldP[generica];
	   echo "<tr class='trListaBody5'>
		 <td align='center'>".$fieldP['cod_partida']."</td>
		 <td>".$fieldP['denominacion']."</td>
		 <td align='center'><b><input type='text' class='inputG' size='12' maxlength='12' style='text-align:right' id='MontoAprobadoGen' value='$montoGen' readonly/></td>
		 <td align='center'><b><input type='text' class='inputG' size='12' maxlength='12' readonly/></td>
		 <td align='center'><b><input type='text' class='inputG' size='12' maxlength='12' readonly/></td>
		 <td align='right'><b><input type='text' class='inputG' size='12' maxlength='12' style='text-align:right' id='".$codigo_generica."' name='".$fielDet['CodPresupuesto']."' value='$montoGen' readonly/></td></b>         
	   </tr>";
	  }
   }
	   //////////////////////////////////////////////////////////////////////////////////////
   ...
   if($fielDet['partida']!=00){
    ...
    echo "<tr class='trListaBody' onclick='mClk(this,\"registro2\");'>
		...
		<td align='right'><input type='text' size='12' maxlength='12' id='MontoDetalle' style='text-align:right' value='$montoD' readonly/></td>
		<td align='right'><input type='text' size='12' maxlength='12' readonly/></td>
		<td align='right'><input type='text' size='12' maxlength='12' readonly/></td>
		<td align='right'><input type='text' size='11' class='montoA' maxlength='12' style='text-align:right' id='$codigo_partida|$codigo_generica' name='".$fielDet['CodPresupuesto']."' value='$montoD' onchange='sumarPartida(this.value, this.id);' onfocus='obtener(this.value);' readonly/></td>         
	   </tr>";
	   }
			   ...
			   <td align='center'><input type='text' style='text-align:right' id='totalAnt' name='totalAnt' size='13'  readonly</td>
			   <td align='center'><input type='text' style='text-align:right' id='totalAnt' name='totalAnt' size='13'  readonly</td>
...
<table align="center">
  ...
  <?
   $SPOS="SELECT * FROM pv_ajustepresupuestario 
                  WHERE CodPresupuesto='".$_GET['registro']."' AND
                        TipoAjuste='IN' AND
     ...
     for($i=0; $i<$RPOS; $i++){
	   ...
	   $SQL="SELECT p.cod_partida,p.partida1 as partida, p.cod_tipoCuenta as tcuenta 
			 ...
			 WHERE a.cod_partida=p.cod_Partida AND 
			       a.CodPresupuesto='".$_GET['registro']."' AND 
				   a.CodAjuste='".$FPOS['CodAjuste']."'";
	   $QRY=mysql_query($SQL) or die ($SQL.mysql_error());
	   $FIELD=mysql_fetch_array($QRY);
	   $mostrar='00.00.00';
	   $mostrar2=$FIELD['tcuenta'].$FIELD['partida'].".".$mostrar;
	   $monto=number_format($FPOS['TotalAjuste'],2,',','.');
	   ...
	   echo"
	    <tr class='trListaBody' onclick='mClk(this,\"registro2\");'>
		 ...
		 <td align='center'>".$FPOS['Estado']."</td>
  ...
  <?
   ...
   if($RPOS!=0){
     for($i=0; $i<$RPOS; $i++){
	   ...
	   $mostrar='00.00.00';
	   $mostrar2=$FIELD['tcuenta'].$FIELD['partida'].".".$mostrar;
	   $monto2=number_format($FPOS['TotalAjuste'],2,',','.');
