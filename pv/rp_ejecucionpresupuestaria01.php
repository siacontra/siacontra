...
//// ------------------------------------------------------------------------------
echo "
<form name='frmentrada' action='rp_ejecucionpresupuestaria01.php?limit=0' method='POST'>";
...
<center><input type='submit' name='btBuscar' value='Buscar' onclick='cargarReportePresupuestoEjecucionPresupuestaria01(this.form);'></center>
...
<center>
<iframe name="rp_ejecucionPresupuestaria01" id="rp_ejecucionPresupuestaria01" style="border:solid 1px #CDCDCD; width:1000px; height:400px; visibility:false; display:false;" ></iframe>
</center>
<form/>
</body>
</html>