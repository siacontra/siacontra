...
for($i=0; $i<$rows ; $i++){
 ...
 $montoIncremento1 = 0;$montoReintegro1 = 0;$montoReintegroTotal = 0; $montoDisminucion1 = 0; $montoIncrementoTotal1 = 0; $montoDisminucionTotal1 = 0;
 ...
 if(($fieldet['partida']!=00) and (($cont1==0) or ($pCapturada!=$fieldet['partida']))){
  ...
  if($rwPar!=0){
   ...
   for($a=0; $a<$rwdet; $a++){/*$pdf->Cell(5, 3.5,$rwdet);$pdf->Cell(5, 3.5,$a);*/
	...
	$montoDisponPresupuestaria1 = ($montoPptoAjustado1 - $montoCompromiso1) + $montoReintegroTotal;
	$montoDisponFinanciera1 = ((($montoP - $montoP) + $montoPptoAjustado1) - $montoPagado1 )+ $montoReintegroTotal;
	...
	$pdf->Row(array($codigo_partida,$fpar['denominacion'],$montoPar,$montoPar,$montoReintegroTotal,$montoIncrementoTotal1,$montoDisminucionTotal1,$montoPptoAjustado1,$montoCompromisoTotal1,$montoCausadoTotal1,$montoPagadoTotal1,$montoDisponPresupuestaria1,$montoDisponFinanciera1,$montoVariacion1));
  }
 }
 //// **** **** **** Capturando Partida Tipo "T" 301-01-00-00
 $montoIncremento2 = 0;$montoReintegro2 = 0;$montoReintegroTotal2 = 0; $montoDisminucion2 = 0; $montoIncrementoTotal2 = 0; $montoDisminucionTotal2 = 0;
 ...
 if(($fieldet['partida']!=00) and (($cont2==0) or ($gCapturada!=$fieldet['generica']) or ($pCapturada2!=$fieldet['partida']))){
	...
	if($rows2!=0){
	  ...
	  /// ************ Calculo Monto Ajustado / Disponibilidad Presupuestaria
	   ...
	   $montoDisponPresupuestaria2 = ($montoPptoAjustado2 - $montoCompromiso2) +$montoReintegroTotal2;
	   $montoDisponFinanciera2 = ((($montoG - $montoG) + $montoPptoAjustado2) - $montoPagado2) + $montoReintegroTotal2;
	  ...
	  $pdf->SetWidths(array(18, 80,20,20,20,20,20,20,20,20,20,20,20,20));
	  $pdf->SetAligns(array('C','L','R','R','R','R','R','R','R','R','R','R','R','R'));
	  $pdf->Row(array($codigo_partida,$fpar2['denominacion'],$montoGen,$montoGen,$montoReintegroTotal2,$montoIncrementoTotal2,$montoDisminucionTotal2,$montoPptoAjustado2,$montoCompromisoTotal2,$montoCausadoTotal2,$montoPagadoTotal2,$montoDisponPresupuestaria2, $montoDisponFinanciera2,$montoVariacion2));
   }
  }
 //// **** **** **** Capturando Partida Tipo "D" 301-01-01-00 ó 301-01-01-01
 $montoIncremento3 = 0;$montoReintegro3 = 0;$montoReintegroTotal3 = 0; $montoDisminucion3 = 0; $montoIncrementoTotal3 = 0; $montoDisminucionTotal3 = 0; 
 ...
 if($fieldet['partida']!=00){
	 ...
	 /// ************ Calculo Monto Ajustado / Disponibilidad Presupuestaria
	   ...
	   $montoDisponPresupuestaria3 = ($montoPptoAjustado3 - $montoCompromiso3) + $montoReintegroTotal3;
	   $montoDisponPresupuestTotal = $montoDisponPresupuestTotal + $montoDisponPresupuestaria3;
	   
	   $montoDisponFinanciera3 = ((($fieldet['MontoAprobado'] - $fieldet['MontoAprobado']) + $montoPptoAjustado3) - $montoPagado3) + $montoReintegroTotal3;
	 ...
	 $pdf->SetWidths(array(18, 80,20,20,20,20,20,20,20,20,20,20,20,20));
	 $pdf->SetAligns(array('C','L','R','R','R','R','R','R','R','R','R','R','R','R'));
	 $pdf->Row(array($fieldet['cod_partida'],$field['denominacion'],$monto,$monto,$montoReintegroTotal3,$montoIncrementoTotal3,$montoDisminucionTotal3,$montoPptoAjustado3,$montoCompromisoTotal3,$montoCausadoTotal3,$montoPagadoTotal3,$montoDisponPresupuestaria3,$montoDisponFinanciera3,$montoVariacion3));
 }
}
	///// *** Mostrar *** /////
...
for($i=0; $i<$rows ; $i++){
 ...
 if(($fieldet['partida']!=00) and (($cont1==0) or ($pCapturada!=$fieldet['partida']))){
  ...
  if($rwPar!=0){
   ...
   //// -------------------------------------------------------------------------
	...
	$montoDisponPresupuestaria1 = ($montoPptoAjustado1 - $montoCompromiso1)+ $montoReintegroTotal;
	$montoDisponFinanciera1 = ((($montoDisFinan - $montoDisPresu) + $montoPptoAjustado1) - $montoPagado1) + $montoReintegroTotal;
	$montoVariacion1 = $montoDisponFinanciera1 - $montoDisponPresupuestaria1;
	...
	$pdf->SetWidths(array(18, 80,20,20,20,20,20,20,20,20,20,20,20,20));
	$pdf->SetAligns(array('C','L','R','R','R','R','R','R','R','R','R','R','R','R'));
	$pdf->Row(array($codigo_partida,$fpar['denominacion'],$montoDP,$montoDF,$montoReintegroTotal,$montoIncrementoTotal1,$montoDisminucionTotal1,$montoPptoAjustado1,$montoCompromisoTotal1,$montoCausadoTotal1,$montoPagadoTotal1,$montoDisponPresupuestaria1,$montoDisponFinanciera1,$montoVariacion1));
  }
 }
 //// ----------------------------------------------------------------------------------------------- */
 //// **** **** **** Capturando Partida Tipo "T" 301-01-00-00
 ...
 if(($fieldet['partida']!=00) and (($cont2==0) or ($gCapturada!=$fieldet['generica']) or ($pCapturada2!=$fieldet['partida']))){
	...
	if($rows2!=0){
	  ...
	  /// ************ Calculo Monto Ajustado / Disponibilidad Presupuestaria
	   ...
	   $montoDisponPresupuestaria2 = ($montoPptoAjustado2 - $montoCompromiso2)+$montoReintegroTotal2;
	   $montoDisponFinanciera2 = ((($montoDispFinan2 - $montoDispPresu2) + $montoPptoAjustado2) - $montoPagado2)+$montoReintegroTotal2;
	   $montoVariacion2 = $montoDisponFinanciera2 - $montoDisponPresupuestaria2;
	  ...
	  $pdf->SetWidths(array(18, 80,20,20,20,20,20,20,20,20,20,20,20,20));
	  $pdf->SetAligns(array('C','L','R','R','R','R','R','R','R','R','R','R','R','R'));
	  $pdf->Row(array($codigo_partida,$fpar2['denominacion'],$montoDP2,$montoDF2,$montoReintegroTotal2,$montoIncrementoTotal2,$montoDisminucionTotal2,$montoPptoAjustado2,$montoCompromisoTotal2,$montoCausadoTotal2,$montoPagadoTotal2,$montoDisponPresupuestaria2, $montoDisponFinanciera2,$montoVariacion2));
   }
  }
 //// **** **** **** Capturando Partida Tipo "D" 301-01-01-00 ó 301-01-01-01
 $montoIncremento3 = 0;$montoReintegro3 = 0;$montoReintegroTotal3 = 0; $montoDisminucion3 = 0; $montoIncrementoTotal3 = 0; $montoDisminucionTotal3 = 0; 
 ...
 if($fieldet['partida']!=00){
	 ...
	 /// ************ Calculo Monto Ajustado / Disponibilidad Presupuestaria
	   ...
	   $montoDisponPresupuestaria3 = ($montoPptoAjustado3 - $montoCompromiso3) + $montoReintTotal;
	   $montoDisponPresupuestTotal = $montoDisponPresupuestTotal + $montoDisponPresupuestaria3;
	   
	   $montoDisponFinanciera3 = ((($fieldet['MontoAprobado'] - $fieldet['MontoAprobado']) + $montoPptoAjustado3) - $montoPagado3) + $montoReintTotal;
	   $montoDisponFinancieraTotal = $montoDisponFinancieraTotal + $montoDisponFinanciera3;
	...
	$pdf->SetFont('Arial', 'B', 8.5);
	 $pdf->SetWidths(array(18, 80,20,20,20,20,20,20,20,20,20,20,20,20));
	$pdf->SetAligns(array('C','R','R','R','R','R','R','R','R','R','R','R','R','R'));
	$pdf->Row(array('' ,'Total:',$montoTotal,$montoTotal,$montoReintTotal,$montoIncTotal,$montoDismTotal,$montoPptoAjusTotal,$montoCompTotal,$montoCausTotal,$montoPagaTotal,$montoDisponPresupuestTotal,$montoDisponFinancieraTotal,$montoVariacionTotal));
	/////
}
//---------------------------------------------------*/
