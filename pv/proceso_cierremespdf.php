...
for($i=0; $i<$rows ; $i++){
 ...
 if(($fieldet['partida']!=00) and (($cont1==0) or ($pCapturada!=$fieldet['partida']))){
  ...
  if($rwPar!=0){
   ...
   for($a=0; $a<$rwdet; $a++){/*$pdf->Cell(5, 3.5,$rwdet);$pdf->Cell(5, 3.5,$a);*/
	...
	$pdf->SetWidths(array(18, 80,20,20,20,20,20,20,20,20,20,20,20));
	$pdf->SetAligns(array('C','L','R','R','R','R','R','R','R','R','R','R','R','R','R'));
	$pdf->Row(array($codigo_partida,$fpar['denominacion'],$montoPar,$montoIncrementoTotal1,$montoDisminucionTotal1,$montoCreditoT1,$montoPptoAjustado1,$montoCompromisoTotal1,$montoCausadoTotal1,$montoPagadoTotal1,$montoDisponPresupuestaria1,$montoDisponFinanciera1,$montoVariacion1));
  }
 }
 ...
 if(($fieldet['partida']!=00) and (($cont2==0) or ($gCapturada!=$fieldet['generica']) or ($pCapturada2!=$fieldet['partida']))){
	...
	if($rows2!=0){
	  ...
	  $pdf->Row(array($codigo_partida,$fpar2['denominacion'],$montoGen,$montoIncrementoTotal2,$montoDisminucionTotal2,$montoCreditoT2,$montoPptoAjustado2,$montoCompromisoTotal2,$montoCausadoTotal2,$montoPagadoTotal2,$montoDisponPresupuestaria2, $montoDisponFinanciera2,$montoVariacion2));
   }
  }
 ...
 if($fieldet['partida']!=00){
	 ...
	 $pdf->SetWidths(array(18, 80,20,20,20,20,20,20,20,20,20,20,20));
	 $pdf->SetAligns(array('C','L','R','R','R','R','R','R','R','R','R','R','R'));
	 $pdf->Row(array($fieldet['cod_partida'],$field['denominacion'],$monto,$montoIncrementoTotal3,$montoDisminucionTotal3,$montoCreditoT3,$montoPptoAjustado3,$montoCompromisoTotal3,$montoCausadoTotal3,$montoPagadoTotal3,$montoDisponPresupuestaria3,$montoDisponFinanciera3,$montoVariacion3));
 }
}
	///// *** Mostrar *** /////
	...
	$pdf->Row(array('' ,'Total:',$montoTotal,$montoIncTotal,$montoDismTotal,$montoCreditoTotal,$montoPptoAjusTotal,$montoCompTotal,$montoCausTotal,$montoPagaTotal,$montoDisponPresupuestTotal,$montoDisponFinancieraTotal,$montoVariacionTotal));
	/////
}else{
//// --------------------------------------------------------------------------------- */
...
for($i=0; $i<$rows ; $i++){
 ...
 if(($fieldet['partida']!=00) and (($cont1==0) or ($pCapturada!=$fieldet['partida']))){
  ...
  if($rwPar!=0){
   ...
   //// -------------------------------------------------------------------------
	...
	$pdf->SetFillColor(202, 202, 202); 
	$pdf->SetFont('Arial', 'B', 7);
	$pdf->SetWidths(array(18, 80,20,20,20,20,20,20,20,20,20,20,20,20,20,20));
	$pdf->SetAligns(array('C','L','R','R','R','R','R','R','R','R','R','R','R','R','R','R'));
	$pdf->Row(array($codigo_partida,$fpar['denominacion'],$montoP,$montoAjustadoAT,$montoIncrementoTotal1,$montoDisminucionTotal1,$montoCreditoT1,$montoPptoAjustado1,$montoDisPresu1,$montoDisFinan1,$montoCompromisoTotal1,$montoCausadoTotal1,$montoPagadoTotal1,$montoDisponPresupuestaria1,$montoDisponFinanciera1,$montoVariacion1));
  }
 }
 //// ----------------------------------------------------------------------------------------------- */
 //// **** **** **** Capturando Partida Tipo "T" 301-01-00-00
 ...
 if($fieldet['partida']!=00){
	 ...
	 $pdf->SetAligns(array('C','L','R','R','R','R','R','R','R','R','R','R','R','R','R','R'));
	 $pdf->Row(array($fieldet['cod_partida'],$field['denominacion'],$montos,  number_format($f_ejecucion3['PptoAjustado'],2,',','.'),$montoIncrementoTotal3,$montoDisminucionTotal3,$montoCreditoT3,$montoPptoAjustadoAT33,  number_format($f_ejecucion3['DispPresupuestaria'], 2, ',', '.'),  number_format($f_ejecucion3['DispFinanciera'], 2, ',', '.'),$montoCompromisoTotal3,$montoCausadoTotal3,$montoPagadoTotal3,$montoDisponPresupuestaria3,$montoDisponFinanciera3,$montoVariacion3));
 }
}
	///// *** Mostrar *** /////
	$montoT=number_format($montoT,2,',','.');
	...
	$pdf->SetFont('Arial', 'B', 7.5);
	 $pdf->SetWidths(array(18, 80,20,20,20,20,20,20,20,20,20,20,20,20,20,20));
	$pdf->SetAligns(array('C','R','R','R','R','R','R','R','R','R','R','R','R','R','R','R'));
	$pdf->Row(array('' ,'Total:',$montoTotal,$montoAjusteA33,$montoIncTotal,$montoDismTotal,$montoCreditoTotal,$montoPptoAjusAT3Total,$montoDispPresuT,$montoDispFinanT,$montoCompTotal,$montoCausTotal,$montoPagaTotal,$montoDisponPresupuestTotal,$montoDisponFinancieraTotal,$montoVariacionTotal));
	/////
}
//---------------------------------------------------*/
