...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Reporte | Presupuesto Incrementado</td>
...
//	-------------------------------------------------------------------------------
echo "
<form name='frmentrada' id='frmentrada' method='POST' action='rp_presincrementado.php'>";
...
<center><input type='submit' name='btBuscar' value='Buscar' onclick='cargarReportePresupuestoIncremento(this.form);'></center>
...
<center>
<iframe name="rp_PresupuestoIncrementado" id="rp_PresupuestoIncrementado" style="border:solid 1px #CDCDCD; width:1000px; height:500px; visibility:false; display:false;" ></iframe>
</center>
<form/>
</body>
</html>