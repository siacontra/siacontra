<? echo "
<form name='frmentrada' action='anteproyecto_listar.php?limit=0' method='POST'>";
//////////  ORGANISMO //////////
...
if($_POST['chkstatus']=="1"){
  ...
  $obj[17]=""; $obj[18]="disabled"; $obj[19]=$_POST['fstatus']; 
}
////////////////////////////////
...
<table width='900' class='tblFiltro'>
 <tr>
  ...
  <td>
	...
	<input type='text' name='fnanteproyecto' size='6' maxlength='4' $obj[4] value='$obj[5]' />
  </td>
 </tr>
...
<tr>
		...
		<td>
			<input type='checkbox' name='chkstatus' id='chkstatus' value='1' $obj[17] onclick='enabledStatus(this.form);' />
			<select name='fstatus' id='fstatus' class='selectMed' $obj[18]>
				<option value=''></option>";
				getEstadoAntp($_POST['fstatus'], 0);
				echo "
			</select>
		</td>
	</tr>
