...
if($rows!=0) {
  ...
  //////   PRUEBA  //////    //////    //////  //////    //////
  echo "
  <form name='frmentrada' action='mtipocuenta.php?accion=editarTcuenta' method='POST' onsubmit='return verificarTcuenta(this, \"EDITAR\");'>
  ...
  <tr>
	...
	<input name='bt_cancelar' type='button' id='bt_cancelar' value='Cancelar' onclick='cargarPagina(this.form, \"mtipocuenta.php\");' />
	</center><br />
	</form>
