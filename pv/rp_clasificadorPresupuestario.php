...
<body onload="cargarClasificadorPresupuestario()">
...
"
<script>
	cargarClasificadorPresupuestario();
</script>
";
*/
?>
<form name='frmentrada' action='rp_clasificadorPresupuestario.php' method='POST'>
<div style="width:1000px" class="divFormCaption"></div>
<center>
<iframe name="rp_clasificador" id="rp_clasificador" style="border:solid 1px #CDCDCD; width:1000px; height:400px; visibility:false; display:false;" ></iframe>
</center>
<form/>
</body>
</html>