...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Conformar Credito Adicional</td>
...
//---------------------------------------------------------------------------------
echo "
<form name='frmentrada' action='creditoAdicionalConformar.php?limite=0' method='POST'>";
...
echo "<td width='125' align='right'>Preparado Por:</td>
  <td><input type='checkbox' name='chkpreparado' value='1' $cpreparado $cstatus />
...
<input name="btAnular" type="button" class="btLista" id="btAnular" value="Conformar" onclick="cargarOpcion(this.form, 'creditoAdicionalConformarEditar.php?accion=CONFORMAR','SELF');"   /></td>
