...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td align="right"><a class="cerrar" href="../nomina/framemain.php">[Cerrar]</a></td>
	</tr>
</table><hr width="100%" color="#333333" />

<form name="frmentrada" id="frmentrada" action="../nomina/usuarios.php" method="POST">
