...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Reporte | Causados</td>
...
//// ------------------------------------------------------------------------------
echo "
<form name='frmentrada' action='rp_causados.php?limit=0' method='POST'>";
...
<center><input type='submit' name='btBuscar' value='Buscar' onclick='cargarReporteCausados(this.form);'></center>
...
<center>
<iframe name="rp_causados" id="rp_causados" style="border:solid 1px #CDCDCD; width:1000px; height:400px; visibility:false; display:false;" ></iframe>
</center>
<form/>
</body>
</html>