...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Reporte | Presupuesto Ajustado</td>
...
//// ------------------------------------------------------------------------------
echo "
<form name='frmentrada' action='r_presupuestoajustadopdf.php' method='POST' target='reporte'>";
...
<center><input type='submit' name='btBuscar' value='Buscar'  onclick='filtroPresupuesto2(this.form,0)'></center>
<br/><br/>";?>
