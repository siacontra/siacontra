...
<div style="width:800px" class="divFormCaption">Informaci&oacute;n de Antepresupuesto</div>
<table width="800" class="tblForm">
	...
	<!--<tr>
	    <td></td>
		<td class="tagForm">Solicitante:</td><? $sql2="SELECT UltimoUsuario,NomCompleto FROM mastpersonas WHERE UltimoUsuario='".$_SESSION['USUARIO_ACTUAL']."'";
			                                    $query2=mysql_query($sql2); 
												$field2=mysql_fetch_array($query2);?>
		<td><input name="solicitante" type="text" id="solicitante" size="50" value="<?=$field2['NomCompleto']?>" readonly/></td>
		<td rowspan="2"></td>		
	</tr>-->
	<tr>
	<td></td>		
