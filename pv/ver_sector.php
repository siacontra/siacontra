...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Maestro de Sector | Ver Registro</td>
...
include("fphp.php");
connect();
$sql="SELECT * FROM pv_sector WHERE cod_sector='".$_GET['registro']."'";
	...
	<table width='700' class='tblForm'>
	  <tr>
	    ...
	    if($field[cod_sector]<=9){
	      echo"<td><input name='codigo' type='text' id='codigo' size='3' maxlength='2' value='".$field['cod_sector']."' readonly /></td>";
        }else{ 
	       echo"<td><input name='codigo' type='text' id='codigo' size='3' maxlength='2' value='".$field['cod_sector']."' readonly /></td>";
	    }
        echo"</tr>
	  ...
	  <tr>
	    ...
	    <td><input name='descripcion' type='text' id='descripcion' size='60' maxlength='60' value='".htmlentities($field['descripcion'])."' readonly /></td>
	  </tr>
	  <tr>
