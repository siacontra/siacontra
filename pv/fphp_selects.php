...
elseif($_POST['accion']=="getOptionsEd_3") {
	if($_POST['tabla']=="subprograma") {
	  echo "
	   <select name='subprograma' id='subprograma' class='selectMed' onchange='getOptionsEd_2(this.id, \"proyecto\")'>
			<option value=''>";
				getSubprograma2("", $_POST['opcion'], 0);
		echo "</select>*";
	}
...
elseif ($_POST['accion']=="getOptionsEd_4") {
	if ($_POST['tabla']=="programa") {
	echo"
		<select name='programa' id='programa' class='selectMed' onchange='getOptionsEd_3(this.id, \"subprograma\", \"proyecto\")'>
			<option value=''>";
				getPrograma2("", $_POST['opcion'], 0);
		echo "</select>*";
	}
	elseif ($_POST['tabla']=="subprograma") {
		echo "
		<select name='subprograma' id='subprograma' class='selectMed' onchange='getOptionsEd_3(this.id, \"proyecto\", \"actividad\")'>
			<option value=''>";
				getSubprograma2("", $_POST['opcion'], 0);
		echo "</select>*";
}
...
elseif($_POST['accion']=="getOptionsEd_5") {
	if($_POST['tabla']=="programa") {
	  echo"
	   <select name='programa' id='programa' class='selectMed' onchange='getOptionsEd_4(this.id, \"subprograma\", \"proyecto\",\"actividad\")'>
			<option value=''>";
				getPrograma2("", $_POST['opcion'], 0);
		echo "</select>*";
	}
