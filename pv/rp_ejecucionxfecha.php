...
<td align='right'>Fecha:</td>
  <td align='left'>
    ...
    <input type='text' name='fdesde' id='fdesde' size='15' maxlength='10' $dFechaDocumento value='$fdesde' class='datepicker' onkeyup='setFechaDMA(this);'/> - 
    <input type='text' name='fhasta' id='fhasta' size='15' maxlength='10' $dFechaDocumento value='$fhasta' class='datepicker' onkeyup='setFechaDMA(this);'/>
  </td>
<td>
</tr>
...
<center>
<iframe name="rp_ejecucionxfechapdf" id="rp_ejecucionxfechapdf" style="border:solid 1px #CDCDCD; width:100%; height:400px; visibility:false; display:false;" ></iframe>
</center>
<form/>
</body>
</html>
