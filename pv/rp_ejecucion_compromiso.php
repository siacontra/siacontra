...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Reporte | Ejecuci&oacute;n Presupuestaria Compromisos</td>
...
//// ------------------------------------------------------------------------------
echo "
<form name='frmentrada' action='rp_ejecucion_compromiso.php?limit=0' method='POST'>";
...
<center><input type='submit' name='btBuscar' value='Buscar' onclick='cargarReportePresupuestoEjecucionCompromiso(this.form);'></center>
...
<center>
<iframe name="rp_ejecucion_compromiso" id="rp_ejecucion_compromiso" style="border:solid 1px #CDCDCD; width:1000px; height:400px; visibility:false; display:false;" ></iframe>
</center>
<form/>
</body>
</html>
