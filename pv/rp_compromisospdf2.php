...
FROM
    ...
    INNER JOIN lg_ordencompra oc ON (oc.CodOrganismo = dc.CodOrganismo AND
                                     oc.Anio = dc.Anio AND
                                     oc.NroOrden = dc.NroDocumento and oc.Estado<>'AN' and oc.Estado<>'PR')
WHERE
    dc.Origen = 'OC' and 
...
FROM
    ...
    INNER JOIN lg_ordenservicio os ON (os.CodOrganismo = dc.CodOrganismo AND
                                       os.Anio = dc.Anio AND
                                       os.NroOrden = dc.NroDocumento and dc.Estado<>'AN' AND os.Estado<>'PR')
WHERE
    dc.Origen = 'OS' and 
	dc.cod_partida='".$fieldet['cod_partida']."' and 
...
FROM
    ...
    INNER JOIN ap_obligaciones o ON (o.CodProveedor = dc.CodProveedor AND
                                     ...
                                     o.NroDocumento = dc.NroDocumento and dc.Estado<>'AN')
...
FROM
    ...
    INNER JOIN ap_bancotransaccion bt ON (bt.CodOrganismo = dc.CodOrganismo AND
                                          ...
                                          bt.CodProveedor = dc.CodProveedor and dc.Estado<>'AN')
    INNER JOIN mastpersonas ps ON (ps.CodPersona = dc.CodProveedor)
WHERE
    dc.Origen = 'TB' and 
	dc.cod_partida='".$fieldet['cod_partida']."' and 
...
$r_distcomp03 = mysql_num_rows($q_distcomp03);
			...
			$total_compromiso_partida=$total_compromiso_partida+$f_distcomp03['Monto'];
			     ...
			     $pdf->Cell(28, 5, $monto03 /*.'total= '.number_format($total_compromiso_partida,2,'.',',')*/, 0, 1, 'R');
			   }
			 }
		 }
     }
			     ...
			     $pdf->Cell(28, 5, number_format($total_compromiso_partida,2,',','.') , 0, 1, 'R');
