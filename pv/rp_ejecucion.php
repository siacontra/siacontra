...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Reporte | Ejecuci&oacute;n Presupuestaria a la Fecha</td>
...
//// ------------------------------------------------------------------------------
echo "
<form name='frmentrada' action='rp_ejecucion.php?limit=0' method='POST'>";
...
<center><input type='submit' name='btBuscar' value='Buscar' onclick='cargarReportePresupuestoEjecucion(this.form);'></center>
...
<center>
<iframe name="rp_ejecucion" id="rp_ejecucion" style="border:solid 1px #CDCDCD; width:1000px; height:400px; visibility:false; display:false;" ></iframe>
</center>
<form/>
</body>
</html>