...
<tr>
 <td class="titulo">Credito Adicional | Aprobar</td>
 <td align="right"><a class="cerrar"  href="#"; onclick="javascript:location.replace('creditoAdicionalConformar.php')">[Cerrar]</a></td>
</tr>
...
<center>
<input name="btguardar" type="submit" id="btguardar" value="Aprobar" onclick="validarCampoCreditoAdicionalAprobar(this.form)"/>
