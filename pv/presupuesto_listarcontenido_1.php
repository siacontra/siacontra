...
<td align="right">
		...
		<input name="btNuevo" id="btNuevo" type="button" class="btLista" value="Nuevo" onclick="cargarPagina(this.form,'anteproyecto_datosgenerales.php','SELF');"/>
		<input name="btMostrar" type="button" class="btLista" id="btMostrar" value="Ver" onclick="cargarOpcion(this.form, 'presupuesto_datosgenerales.php', 'BLANK', 'height=600, width=900, left=200, top=100, resizable=no');" />
		...
		<input name="btPDF" type="button" class="btLista" id="btPDF" value="PDF" onclick="cargarOpcion(this.form, 'presupuesto_pdf01.php', 'BLANK', 'height=800, width=800, left=200, top=200, resizable=yes');" /> |  
