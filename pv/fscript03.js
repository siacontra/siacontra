...
function totalLista(rows) {
	var numreg = document.getElementById("rows"); //alert('paso='+numreg);
	numreg.innerHTML="Registros: "+rows;
}
//	FUNCION QUE IMPRIME EL NUMERO DE REGISTROS Y BLOQUEA/DESBLOQUEA LAS OPCIONES
...
function enabledNomEmpleado(form) {
	if (form.chkempleado.checked) form.cargarAgente.disabled=false;
	else { form.cargarAgente.disabled=true; form.nomempleado.value=""; form.codempleado.value=""; }
}
//	FUNCION PARA BLOQUEAR/DESBLOQUEAR
