<? echo "
<form name='frmentrada' action='presupuesto_ajusteaprobar.php?limit=0' method='POST'>";
//////////  ORGANISMO //////////
...
echo "<td width='90' align='right'>Nro. Presupuesto:</td>
  ...
  <td><input type='checkbox' name='chkstatus' id='chkstatus' value='1' checked onclick='this.checked=true'/>
	  <select name='fstatus' id='fstatus' class='selectMed'>";
				getEstadoAjuste("PE", 1);
				echo "
			</select>
  </td>
</tr>
...
<tr>
  ...
  <td width='180' align='left'>
	<input type='checkbox' name='chktajuste' id='chktajuste' value='1' $ctajuste onclick='enabledTajuste(this.form);' />
	<select name='ftajuste' id='ftajuste' class='selectMed' $dtajuste>
	   <option value=''></option>";
				getTipoAjuste($ftajuste, 0);
				echo "
			</select>
 </td>
</tr>
