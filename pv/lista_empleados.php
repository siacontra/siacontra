...
<table width="700" class="tblLista">
	...
	if ($registros!=0) {
		...
		for ($i=0; $i<$rows; $i++) {
			...
			echo "
			<tr class='trListaBody' onclick='mClk(this,\"registro\"); selEmpleado(\"".htmlentities($field['Busqueda'])."\", ".$_GET['campo'].");' onmouseover='mOvr(this);' onmouseout='mOut(this);' id='".$field['CodPersona']."'>
