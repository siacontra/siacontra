...
<body onload="document.getElementById('nrocuenta').focus();">
<?php
include("fphp_ap.php");
connect();
?>
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Cuentas Bancarias | Nuevo Registro</td>
...
<form name="frmentrada" id="frmentrada" action="ap_cuentas_bancarias.php" method="POST" onsubmit="return verificarCuentaBancaria(this, 'INSERTAR');">
...
<table width="700" class="tblForm">
	...
	<tr>
		...
		<td><input type="text" id="nrocuenta" maxlength="20" style="width:125px;" />*</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input type="text" id="ctabanco" maxlength="20" style="width:125px;" />*</td>
	</tr>
</table>
    	...
    	<td width="50%" valign="top">
            ...
            <table width="100%">
                ...
                <tr>
                    ...
                    <td><input type="text" id="fapertura" maxlength="10" style="width:100px;" />*</td>
                </tr>
                <tr>
    	...
    	<td width="50%" valign="top">
            ...
            <table width="100%">
                <tr>
                    ...
                    <td><input type="text" id="agencia" maxlength="100" style="width:200px;" /></td>
                </tr>
                <tr>
                    <td class="tagForm">Distrito:</td>
                    <td><input type="text" id="distrito" maxlength="100" style="width:200px;" /></td>
                </tr>
                <tr>
                    <td class="tagForm">Atenci&oacute;n:</td>
                    <td><input type="text" id="atencion" maxlength="100" style="width:200px;" /></td>
                </tr>
                <tr>
                    <td class="tagForm">Cargo:</td>
                    <td><input type="text" id="cargo" maxlength="100" style="width:200px;" /></td>
                </tr>
            </table>
        </td>
    </tr>
...
<table width="700" class="tblForm">
	<tr>
		<td width="125">&nbsp;</td>
		<td><input type="checkbox" id="flagconciliacionb" value="S" /> Conciliaci&oacute;n Bancaria Contable</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td><input type="checkbox" id="flagconciliacionr" value="S" /> Conciliaci&oacute;n Resumida en CxP</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td><input type="checkbox" id="flagdebito" value="S" /> ITF/Debito Bancario</td>
	</tr>
</table>
