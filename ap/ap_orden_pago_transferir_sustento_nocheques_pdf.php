...
function chequeVenezuela($pdf) {
	...
	$pdf->Cell(25, 5, $field['NroCuenta'], 0, 0, 'L');
	$pdf->Ln(10);
}
//---------------------------------------------------
...
/*		
		...
		$this->SetWidths(array(20, 25, 25, 21, 21));
		$this->SetAligns(array('C', 'C', 'C', 'R', 'R'));
		$this->Row(array('EMITIDO POR','CONFORMADO POR','REVISADO POR','APROBADO POR'));
*/
