...
if (mysql_num_rows($query_iva) != 0) {
	...
	$pdf->SetXY(20, 9); $pdf->Cell(100, 5, utf8_decode('DIRECCIÓN DE ADMINISTRACIÓN Y PRESUPUESTO'), 0, 0, 'L');
	$pdf->SetXY(20, 13); $pdf->Cell(100, 5, $_SESSION['RIF_ORGANISMO_ACTUAL'], 0, 0, 'L');
	$pdf->Ln(15);
	$pdf->SetFont('Arial', 'B', 14);
	$pdf->Cell(195, 5, utf8_decode('Comprobante de Retención I.V.A.'), 0, 1, 'C');
	$pdf->Cell(195, 5,'Nro. '.$nrocomprobante, 0, 0, 'C');
	$pdf->Ln(20);
	$pdf->SetFont('Arial', '', 10);
	//$pdf->Cell(70, 5, utf8_decode('Número de Comprobante: '), 0, 0, 'L');
	$pdf->Cell(60, 5, ('Fecha: '), 0, 0, 'L');
	$pdf->Cell(70, 5, ('Periodo Fiscal: '), 0, 0, 'L');
	$pdf->Cell(70, 5, utf8_decode('Número de Orden de Pago: '), 0, 0, 'L');
	$pdf->Ln(6);
	$pdf->SetFont('Arial', 'B', 10);
	//$pdf->Cell(70, 5, $nrocomprobante, 0, 0, 'L');
	$pdf->Cell(60, 5, formatFechaDMA($field_iva['FechaComprobante']), 0, 0, 'L');
	$pdf->Cell(70, 5, $periodo_fiscal, 0, 0, 'L');
	$pdf->Cell(70, 5, $field_iva['NroOrden'], 0, 0, 'L');
	$pdf->Ln(10);
	$pdf->SetFont('Arial', '', 10);
	...
	$pdf->SetWidths(array(20, 25, 25, 21, 21, 19, 21, 21, 21));
...
if (mysql_num_rows($query_islr) != 0) {
	...
	$pdf->Ln(15);
	$pdf->SetFont('Arial', 'B', 14);
	$pdf->Cell(195, 5, utf8_decode('Comprobante de Retención I.S.L.R.'), 0, 1, 'C');
	$pdf->Cell(195, 5,'Nro. '.$nrocomprobante, 0, 0, 'C');
	$pdf->Ln(15);
	$pdf->SetFont('Arial', '', 10);
	//$pdf->Cell(70, 5, utf8_decode('Número de Comprobante: '), 0, 0, 'L');
	...
	$pdf->Cell(70, 5, $periodo_fiscal, 0, 0, 'L');
	$pdf->Cell(70, 5, $field_islr['NroOrden'], 0, 0, 'L');
	$pdf->Ln(10);
	$pdf->SetFont('Arial', '', 10);
	$pdf->Cell(130, 5, utf8_decode('Nombre o Razón Social Agente de Retención: '), 0, 0, 'L');
	$pdf->Cell(80, 5, utf8_decode('R.I.F. del Agente de Retención: '), 0, 0, 'L');
	...
	$pdf->SetDrawColor(255, 255, 255);
	$pdf->SetFont('Arial', '', 9);
	$pdf->Row(array(formatFechaDMA($field_islr['FechaFactura']),
					$field_islr['NroControl'],
					$field_islr['NroDocumento'],
					number_format($field_islr['MontoAfecto'], 2, ',', '.'),
					number_format($field_islr['MontoNoAfecto'], 2, ',', '.'),
					number_format($field_islr['MontoImpuesto'], 2, ',', '.'),
					number_format($field_islr['MontoFactura'], 2, ',', '.'),
					number_format($field_islr['Porcentaje'], 2, ',', '.'),
					number_format(abs($field_islr['MontoRetenido']), 2, ',', '.')));
...
if (mysql_num_rows($query_mil) != 0) {
	...
	$pdf->Ln(15);
	$pdf->SetFont('Arial', 'B', 14);
	$pdf->Cell(195, 5, utf8_decode('Comprobante de Retención 1x1000'), 0, 1, 'C');
	$pdf->Cell(195, 5,'Nro. '.$nrocomprobante, 0, 0, 'C');
	$pdf->Ln(20);
	$pdf->SetFont('Arial', '', 10);
	//$pdf->Cell(70, 5, utf8_decode('Número de Comprobante: '), 0, 0, 'L');
	...
	$pdf->Cell(70, 5, $periodo_fiscal, 0, 0, 'L');
	$pdf->Cell(70, 5, $field_mil['NroOrden'], 0, 0, 'L');
	$pdf->Ln(10);
	$pdf->SetFont('Arial', '', 10);
	$pdf->Cell(130, 5, utf8_decode('Nombre o Razón Social Agente de Retención: '), 0, 0, 'L');
	$pdf->Cell(80, 5, utf8_decode('R.I.F. del Agente de Retención: '), 0, 0, 'L');
...
$pdf->SetFont('Arial', 'B', 8);
	...
	$pdf->SetDrawColor(255, 255, 255);
	$pdf->SetFont('Arial', '', 9);
	$pdf->Row(array(formatFechaDMA($field_mil['FechaFactura']),
					$field_mil['NroControl'],
					$field_mil['NroDocumento'],
					number_format($field_mil['MontoAfecto'], 2, ',', '.'),
					number_format($field_mil['MontoNoAfecto'], 2, ',', '.'),
					number_format($field_mil['MontoImpuesto'], 2, ',', '.'),
					number_format($field_mil['MontoFactura'], 2, ',', '.'),
					number_format($field_mil['Porcentaje'], 2, ',', '.'),
					number_format(abs($field_mil['MontoRetenido']), 2, ',', '.')));
