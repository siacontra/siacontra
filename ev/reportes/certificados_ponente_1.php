<?php
	...
	$sql= "select A.co_id_persona_evento, A.CodPersona, A.bo_culmino_evento, A.bo_recibio_certificado, A.bo_ponente, A.bo_ponente_1, A.tx_nu_certificado, A.co_id_evento, A.eliminado, B.NomCompleto, B.Ndocumento from ev_persona_evento as A, mastpersonas as B  where A.CodPersona=B.CodPersona and A.bo_ponente=0 and A.bo_ponente_1=1 and A.eliminado=false and A.co_id_evento=".$evento." order by tx_nu_certificado";
	...
	$sql= "select tx_nombre_evento, nu_horas from ev_evento_capacitacion where co_id_evento=".$evento.";";
