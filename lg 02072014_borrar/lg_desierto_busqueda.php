...
<body onload="consultarEstadoReq('');buscarInformeDesierto();">
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Busqueda Procedimientos Desiertos</td>
		...
		<td colspan="2" class="tagForm"><table width="846" border="0" align="center" cellpadding="0" cellspacing="1">
                      <tr>
                        ...
                        <td width="83" align="center" valign="middle">
                          <input type="button" name="Submit3" value="Buscar" onclick="buscarInformeDesierto();" />
                      </td>
                        ...
                        <td width="57">
                          <input type="button" name="Submit2" value="Generar Informe" onclick="generarInformeDesierto();" />
                         </td>
          </tr>
                    </table>
