...
<body onload="consultarEstadoReq('');buscarInformeRecomendacionParaAdjudicacion();">
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Informe de Adjudicación</td>
		...
		<td colspan="2" class="tagForm"><table width="846" border="0" align="center" cellpadding="0" cellspacing="1">
                      <tr>
                        ...
                        <td width="83" align="center" valign="middle">
                          <input type="button" name="Submit3" value="Buscar" onclick="buscarInformeRecomendacionParaAdjudicacion();" />
                      </td>
                        ...
                        <td align="center" valign="middle"><!--<input type="button" name="Submit5" value="Modificar" onclick="cargarDatosModificarEvaluacion();" />-->
                          ...
                          <input type="button" name="Submit" value="Informe Adjudicación" onclick="cargarPaginaAdjudicacion();" />                        </td>
                        <td width="57"><input type="button" name="Submit2" value="Modificar Adjudicaci&oacute;n" onclick="location.href='lg_adjudicacion_busqueda.php'"; /></td>
          </tr>
                    </table>
					...
					<table width="100%" border="0" class="tblLista" align="center" cellpadding="0" cellspacing="2">
						<thead>
						  <tr class="trListaHead" width="100%" >
							<td width="14%"><div align="center">CÓDIGO</div></td>
							<td width="22%"><div align="center">ASUNTO</div></td>
                            <td width="25%"><div align="center">OBJETO</div></td>
                            <td width="39%"><div align="center">PROVEEDOR RECOMENDADO</div></td>
						  </tr>
					  	</thead>
