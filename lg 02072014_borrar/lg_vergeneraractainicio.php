...
<body onload="consultarEstadoReq('');inicializarCodRequerimientoSecuencia('<? echo $cadena = implode(',',$registro); ?>');buscarActa();">
...
<div style="width:895px; height:15px" class="divFormCaption">Acta Inicio de la Adquisición</div>
		...
		<td colspan="2" class="tagForm"><table width="846" border="0" align="center" cellpadding="0" cellspacing="1">
                      <tr>
                        ...
                        <td width="83" align="center" valign="middle">
                          <input type="button" name="Submit3" value="Buscar" onclick="buscarActa();" />
                      </td>
                        ...
                        <td width="81" align="center" valign="middle"><input type="button" name="Submit5" value="Modificar" onclick="cargarDatosModificarActa();" /></td>
                        <td width="114" align="center" valign="middle"><input type="button" name="input" value="Generar Acta" onclick="generarActaInicio();" /></td>
                        <td width="57"><input type="button" name="input" value="Anular Procedimiento" onclick="anular_proc_CP();" /></td>
          </tr>
                    </table>
		  ...
		  <input type="hidden" id="estado" name="hiddenField4" value="0"/>
					...
					<table width="100%" border="0" class="tblLista" align="center" cellpadding="0" cellspacing="2">
						<thead>
						  <tr class="trListaHead" width="100%">
							...
							<td width="80%"><div align="center">REQUERIMIENTOS</div></td>
