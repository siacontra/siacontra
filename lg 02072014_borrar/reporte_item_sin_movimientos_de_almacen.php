...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Ítems sin Movimientos en el Almacen</td>
		<td align="right"><a class="cerrar"; href="framemain.php">[Cerrar]</a></td>
	</tr>
</table><hr width="100%" color="#333333" />

<form name="frmentrada" id="frmentrada" method="post" action="reporte_item_sin_movimientos_de_almacen_pdf.php" target="iReporte" onsubmit="return validar_reporte_movimientos_de_almacen_pdf();">
...
<table width="1000" class="tblFiltro">
    <tr>
		...
		<td>
			...
			<select name="" id="" style="width:200px;" disabled="disabled">
	...
	<tr>
		<td align="right" style="">Periodo:</td>
		<td style="">
