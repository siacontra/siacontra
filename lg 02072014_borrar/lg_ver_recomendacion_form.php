<?php
	...
	$numeroVisualActa = 'DA-CPAI-'.rellenarConCero($resultado1['NroVisualActaInicio'], 3).'-'.$resultado1['AnioActa'];
	$numeroVisualEvaluacion= 'DA-CPECC-'.rellenarConCero($resultado1['NroVisualEvaluacion'], 3).'-'.$resultado1['AnioEvaluacion'];
	$numeroVisualRecomendacion = 'DA-CPIR-'.rellenarConCero($resultado1['NroVisualRecomendacion'], 3).'-'.$resultado1['AnioRecomendacion'];
