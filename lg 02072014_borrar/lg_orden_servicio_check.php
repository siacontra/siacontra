...
<table width="1100" class="tblForm">
    ...
    <tr>
		...
		<td>
        	<input type="text" id="MontoIva" value="<?=number_format($field_orden['MontoIva'], 2, ',', '.')?>" style="width:150px; text-align:right;" class="disabled" onfocus="numeroFocus(this);" onblur="numeroBlur(this);" onchange="setNuevoMontoIvaOS();" />
        </td>
	</tr>
    <tr>
...
<table width="100%" class="tblLista">
	...
	while ($field_obligacion = mysql_fetch_array($query_obligacion)) {
		...
		<tr class="trListaBody">
			...
			<td align="right"><?=number_format($field_obligacion['MontoAfecto'], 2, ',', '.')?></td>
