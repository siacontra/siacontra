...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Invitar Proveedores a Cotizar</td>
...
<table width="800" align="center" cellpadding="0" cellspacing="0">
    <tr>
        <td>
            ...
            <ul id="tab">
            <!-- CSS Tabs -->
            <li id="li1" class="current" onclick="currentTab('tab', this);"><a href="#" onclick="mostrarTab('tab', 1, 2);">Invitaciones</a></li>
...
<table width="2000" class="tblLista">
	...
	while ($field_req = mysql_fetch_array($query_req)) {
		...
		<tr class="trListaBody" onclick="mClk(this, 'sel_requerimiento');
			...
			<td align="right"><?=number_format($field_req['CantidadPedida'], 2, ',', '.')?></td>
