...
<script language="javascript" >
	function llamadoTabReporte(tab) {
		...
		if (tab == "stockProveedor") form.action = "reporte_ingreso_stock_por_proveedor_pdf.php";
		else if (tab == "stockItemProveedor") form.action = "reporte_ingreso_stock_por_item_pdf.php";
		else form.action = "reporte_ingreso_commodities_por_proveedor_pdf.php";	
		form.submit();
	}
</script>
</head>
...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Ingreso Por Proveedor</td>
		<td align="right"><a class="cerrar"; href="framemain.php">[Cerrar]</a></td>
	</tr>
</table><hr width="100%" color="#333333" />

<form name="frmentrada" id="frmentrada" method="post" action="reporte_ingreso_stock_por_proveedor_pdf.php" target="iReporte">
...
<!--<br />
<div class="divDivision">Ordenes de Servicios</div><br />-->
...
<table width="1000" align="center">
  <tr>
		<td>
			...
			<ul>
			<!-- CSS Tabs -->
			<li><a onclick="llamadoTabReporte('stockProveedor');" href="#">O/C Stock por Proveedor</a></li>
			<li><a onclick="llamadoTabReporte('stockItemProveedor');" href="#">O/C Stock por Item (Agrupado porItems)</a></li>
            <li><a onclick="llamadoTabReporte('stockItemItem');" href="#">O/C Commodities por Proveedor</a></li>
			</ul>
			</div>
		</td>
	</tr>
