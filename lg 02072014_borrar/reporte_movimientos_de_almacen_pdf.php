...
class PDF extends FPDF {
	...
	function Header() {
		...
		$this->SetXY(5, 20); $this->Cell(195, 5, utf8_decode('Movimientos de Almacén Resumido'), 0, 1, 'C', 0, 'reporte_movimientos_de_almacen_pdf.php');
		$this->Ln(5);
	...
	function Footer() {
		...
		$this->SetXY(5, 250);
		$this->Cell(68.5, 5, utf8_decode('Francisco Gil'), 0, 1, 'L', 0);
		$this->SetXY(73.5, 250);
		$this->Cell(68.5, 5, utf8_decode('Enrique Luis Figueroa Lares'), 0, 1, 'L', 0);
		$this->SetXY(142, 250);
		$this->Cell(68, 5, utf8_decode('Licdo. Vicente Arcia'), 0, 1, 'L', 0);
		
		$this->SetXY(5, 255);
		$this->Cell(68.5, 5, utf8_decode('ASISTENTE TÉC. ADMINISTRATIVO II'), 0, 1, 'C', 0);
		$this->SetXY(73.5, 255);
		$this->Cell(68.5, 5, utf8_decode('DIRECTOR ADMINISTRACIÓN'), 0, 1, 'C', 0);
		$this->SetXY(142, 255);
		$this->Cell(68, 5, utf8_decode('DIRECTOR GENERAL'), 0, 1, 'C', 0);
	}
}
//---------------------------------------------------
