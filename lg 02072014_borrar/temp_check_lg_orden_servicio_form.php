...
?>
<input name="Bot&oacute;n" type="<?=$tipoBoton?>" style=" <?=$display_submit?>" value="<?=$label_submit?>" onclick="<? echo $llamado; ?>" />
...
<table width="1500" class="tblLista">
	...
	$sql = "SELECT
			...
			WHERE
				...
				c.CodRequerimiento IN (SELECT rd2.CodRequerimiento 
									   FROM 
