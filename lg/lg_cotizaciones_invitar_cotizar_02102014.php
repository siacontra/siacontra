...
<table width="1000" class="tblForm">
	<tr>
		...
		<td width="75"><input type="text" id="cantidad" style="width:60px;" value="<?=number_format($field['CantidadPedida'], 4, '.', '')?>" disabled="disabled" /></td>
	</tr>
	<tr>
	...
	while ($field_detalle = mysql_fetch_array($query_detalle)) {
		...
		if($field_detalle['CodProveedor'] != $codProveedorAux)
		{
			...
			<tr class="trListaBody" onclick="mClk(this, 'sel_detalle');" id="<?=$field_detalle['CodProveedor']?>">
				...
				<td align="center">
					<input type="text" name="cant" value="<?=number_format($field_detalle['Cantidad'], 4, '.', '')?>" onFocus="this.value=''" style="width:97%; text-align:right;" class="cell" onblur="this.className='cell';" onfocus="this.className='cellFocus';" onchange="setMontosProveedorItem();" />
				</td>
				
				<td align="center">
					<input type="text" name="pu" value="<?=number_format($field_detalle['PrecioUnitInicio'], 4, '.', '')?>" onFocus="this.value=''" style="width:97%; text-align:right;" class="cell" onblur=" this.className='cell';" onfocus="this.className='cellFocus';" onchange="setMontosProveedorItem();" />
				</td>
				...
				<td align="center">
					<input type="text" name="descp" value="<?=number_format($field_detalle['DescuentoPorcentaje'], 4, '.', '')?>" onFocus="this.value=''"  style="width:97%; text-align:right;" class="cell" onblur="this.className='cell';" onfocus="this.className='cellFocus';" onchange="setMontosProveedorItem();" />
				</td>
				
				<td align="center">
					<input type="text" name="descf" value="<?=number_format($field_detalle['DescuentoFijo'], 4, '.', '')?>" onFocus="this.value=''"  style="width:97%; text-align:right;" class="cell" onblur="this.className='cell';" onfocus=" this.className='cellFocus';" onchange="setMontosProveedorItem();" />
				</td>
