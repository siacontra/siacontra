...
<body onload="consultarEstadoReq('');buscarActaEvaluacion();">
...
<div style="width:900px; height:15px" class="divFormCaption">Acta Inicio de la Adquisición</div>
...
<tr> <!-- ///////////  PRIMER ////////// -->
  <td><form id="fromActa"></form></td>
   ...
   <tr>
		<td colspan="2" class="tagForm"><table width="893" border="0" align="center" cellpadding="0" cellspacing="1">
                      <tr>
                        ...
                        <td width="83" align="center" valign="middle">
                          <input type="button" name="Submit3" value="Buscar" onclick="buscarActaEvaluacion();" />
                      </td>
                        ...
                        <td width="81" align="center" valign="middle"><input type="button" name="Submit5" value="Establecer Evaluación" onclick="mostrarPaginaEvaluacion();" /></td>
                        <td align="center" valign="middle"><input type="button" name="input" value="Modificar Evaluaciones Realizadas" onclick="location.href='lg_evaluacion_busqueda.php';" /></td>
          </tr>
                    </table>
