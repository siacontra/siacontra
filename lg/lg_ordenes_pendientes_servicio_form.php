...
<table width="1100" class="tblForm">
    ...
    <tr>
		...
		<td>
			<select id="CodDependencia" style="width:300px;" onchange="getOptionsSelect(this.value, 'centro_costo', 'CodCentroCosto', true);">
				<?=getDependencias($field_orden['CodDependencia'], $field_orden['CodOrganismo'], 3)?>
			</select>
		</td>
        <td class="tagForm">Monto Afecto:</td>
		<td>
        	<input type="text" id="MontoOriginal" value="<?=number_format($MontoOriginal, 4, '.', '')?>" style="width:150px; text-align:right;" class="disabled" disabled="disabled" />
		</td>
	</tr>
    <tr>
		...
		<td>
        	<input type="text" id="MontoNoAfecto" value="<?=number_format($MontoNoAfecto, 4, '.', '')?>" style="width:150px; text-align:right;" class="disabled" disabled="disabled" />
		</td>
	</tr>
    <tr>
		...
		<td>
        	<input type="text" id="MontoIva" value="<?=number_format($MontoIva, 4, '.', '')?>" style="width:150px; text-align:right;" class="disabled" disabled="disabled" />
        </td>
	</tr>
    <tr>
		...
		<td>
        	<input type="text" id="TotalMontoIva" value="<?=number_format($TotalMontoIva, 4, '.', '')?>" style="width:150px; text-align:right; font-size:12px; font-weight:bold;" class="disabled" disabled="disabled" />
        </td>
	</tr>
    <tr>
		...
		<td>
        	<input type="text" id="MontoGastado" value="<?=number_format($MontoGastado, 4, '.', '')?>" style="width:150px; text-align:right;" class="disabled" disabled="disabled" />
        </td>
	</tr>
    <tr>
		...
		<td>
        	<input type="text" id="MontoPendiente" value="<?=number_format($MontoPendiente, 4, '.', '')?>" style="width:150px; text-align:right; font-size:12px; font-weight:bold;" class="disabled" disabled="disabled" />
        </td>
	</tr>
    <tr>
...
<table width="2200" class="tblLista">
	...
	while ($field_detalles = mysql_fetch_array($query_detalles)) {
		...
		<tr class="trListaBody" onclick="mClk(this, 'sel_detalles');" id="detalles_<?=$nrodetalles?>">
			...
			<td align="center">
            	<input type="text" name="CantidadPedida" class="cell" style="text-align:right;" value="<?=number_format($field_detalles['CantidadPedida'], 4, '.', '')?>"  onchange="setMontosOrdenServicio(this.form);" />
            </td>
			<td align="center">
            	<input type="text" name="PrecioUnit" class="cell" style="text-align:right;" value="<?=number_format($field_detalles['PrecioUnit'], 4, '.', '')?>" onchange="setMontosOrdenServicio(this.form);" />
            </td>
			<td align="center">
			...
			<td align="center">
            	<input type="text" name="Total" class="cell2" style="text-align:right;" value="<?=number_format($field_detalles['Total'], 4, '.', '')?>" readonly="readonly" />
            </td>
			<td align="center">
