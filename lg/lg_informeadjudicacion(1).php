...
//-------------------------------------------------------------------------------------------------------------------------------------//
	...
	$sql4 = "select A.CodRequerimiento, A.Secuencia
					...
					join lg_adjudicaciondetalle as D on (A.CodRequerimiento = D.CodRequerimiento and A.Secuencia<>D.Secuencia) or
					          (A.CodRequerimiento <> D.CodRequerimiento and A.Secuencia=D.Secuencia)
					where C.CodEvaluacion=".$resultadoEva['CodEvaluacion'];
...
/*select A.CodRequerimiento, A.Secuencia
					from lg_requedetalleacta as A
					join lg_actainicio as B on A.CodActaInicio=B.CodActaInicio
					join lg_evaluacion as C on C.CodActaInicio=B.CodActaInicio
          
          join lg_informerecomendacion as F on C.CodEvaluacion=F.CodEvaluacion
          join lg_adjudicaciondetalle as D on (A.CodRequerimiento = D.CodRequerimiento and A.Secuencia<>D.Secuencia) or          (A.CodRequerimiento <> D.CodRequerimiento and A.Secuencia=D.Secuencia)
          join lg_informeadjudicacion as E on E.CodInformeRecomendacion=F.CodInformeRecomendacion
					where C.CodEvaluacion=2
                    
          -- and (A.CodRequerimiento <> (select D.CodRequerimiento from lg_adjudicaciondetalle as D)
          -- and A.Secuencia <> (select D.Secuencia from lg_adjudicaciondetalle as D))*/
