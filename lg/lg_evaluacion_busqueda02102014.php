...
<body onload="consultarEstadoReq('');buscarEvaluacion();">
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Búsqueda Evaluaci&oacute;n Cualitativa-Cuantitativa</td>
...
<div style="width:895px; height:15px" class="divFormCaption">Evaluaci&oacute;n Cualitativa-Cuantitativa</div>
		...
		<td colspan="2" class="tagForm"><table width="894" border="0" align="center" cellpadding="0" cellspacing="1">
                      <tr>
                        ...
                        <td width="70" align="center" valign="middle">
                          <input type="button" name="Submit3" value="Buscar" onclick="buscarEvaluacion();" />
                      </td>
                        <td width="58" align="center" valign="middle">
                          <input type="button" name="Submit4" value="Limpiar" onclick="xGetElementById('codigoActaBusqueda').value='';" />
                       </td>
                        <td width="68" align="center" valign="middle"><input type="button" name="Submit5" value="Modificar" onclick="cargarDatosModificarEvaluacion();" /></td>
                        <td width="155"><!--<input type="button" name="input" value="Generar Acta" onclick="generarActaInicio();" />-->
                          <input type="button" name="Submit" value="Informe Recomendaci&oacute;n" onclick="cargarPaginaInformeRecomendacion();" />
                        </td>
                        <td width="151"><input type="button" name="button" id="button" value="Generar Evaluación" onclick="generarInformeEvaluacion();"  /></td>
          </tr>
                    </table>
