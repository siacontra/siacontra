<?php
	...
	$sqlDirector="select p.Nombres, p.Apellido1,p.Apellido2,p.CodPersona, pu. DescripCargo
	from lg_evaluacion as A
...
";
		...
		$totalPP = ($menor/$sumaTotalProveedor [$i])*60;
