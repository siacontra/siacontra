...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Inventario Valorizado</td>
		<td align="right"><a class="cerrar"; href="framemain.php">[Cerrar]</a></td>
	</tr>
</table><hr width="100%" color="#333333" />

<form name="frmentrada" id="frmentrada" method="post" action="reporte_inventario_valorizado_pdf.php" target="iReporte" onsubmit="return validar_reporte_inventario_valorizado_pdf();">
...
<br /><div class="divDivision">Reporte Inventario Valorizado</div><br />
