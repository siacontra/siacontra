...
<table width="100%" class="tblLista">
	...
	foreach ($detalle as $linea) {
		...
		<tr class="trListaBody" onclick="mClk(this, 'sel_detalles');" id="detalles_<?=$nrodetalles?>">
			...
			<td align="center">
            	<input type="text" name="StockActual" class="cell2" style="text-align:right;" value="<?=number_format($StockActual, 4,  '.', '')?>" readonly="readonly" />
            </td>
			<td align="center">
            	...
            	<input type="text" name="CantidadRecibida" class="cell" style="text-align:right;" value="<?=number_format($CantidadPendiente, 4,  '.', '')?>" onBlur="numeroBlur(this);" onFocus="numeroFocus(this);" onchange="setMontosAlmacen(this.form);" />
            </td>
			<td align="center">
			...
			<td align="center">
            	<input type="text" name="Total" class="cell2" style="text-align:right;" value="<?=number_format($Total, 4, '.', '')?>" readonly="readonly" />
            </td>
			<td align="center">
