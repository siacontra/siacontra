...
<tr>
    ...
    <tr>
		<td class="tagForm"><input name="" type="hidden" value="" />*Asistente Administradtivo:</td>
		<td class="gallery clearfix">
			<!--<input type="hidden" id="asistenteActaInicio" value="<?=$field_requerimiento['asistenteActaInicio']?>" />
   ...
   <tr>
		...
		<td class="gallery clearfix">
			<input type="hidden" id="directorActaInicio" value="Lcda. ROXAIDA ESTRADA" />
			<input type="text" disabled="disabled" class="disabled" id="NomDirectorActaInicio" style="width:220px;" value="Lcda. ROXAIDA ESTRADA" />
			</td>
	</tr>
...
<div class="divMsj" style="width:1100px">Campos Obligatorios *</div>
    <input type="button" value="Guardar Registro" onclick="guardarPliego('<? echo $resp2[0]['Numero'].'/'.$resp2[0]['CodRequerimiento'].'/'.$resp2[0]['Secuencia']  ?>','guardar','<? echo $resp2[0]['Numero']?>');" />
