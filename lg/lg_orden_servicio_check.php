...
<table width="1100" class="tblForm">
    ...
    <tr>
		...
		<td>
        	<input type="text" id="MontoOriginal" value="<?=number_format($field_orden['MontoOriginal'], 4, ',', '.')?>" style="width:150px; text-align:right;" class="disabled" disabled="disabled" />
		</td>
	</tr>
    <tr>
		<td class="tagForm">* Centro de Costo:
			</td>
		<td>
    ...
    <tr>
		...
		<td>
        	<input type="text" id="TotalMontoIva" value="<?=number_format($field_orden['TotalMontoIva'], 4, ',', '.')?>" style="width:150px; text-align:right; font-size:12px; font-weight:bold;" class="disabled" disabled="disabled" />
        </td>
	</tr>
    <tr>
		...
		<td>
        	<input type="text" id="MontoGastado" value="<?=number_format($field_orden['MontoGastado'], 4, ',', '.')?>" style="width:150px; text-align:right;" class="disabled" disabled="disabled" />
        </td>
	</tr>
    <tr>
		...
		<td>
        	<input type="text" id="MontoPendiente" value="<?=number_format($field_orden['MontoPendiente'], 4, ',', '.')?>" style="width:150px; text-align:right; font-size:12px; font-weight:bold;" class="disabled" disabled="disabled" />
        </td>
	</tr>
    <tr>
...
<?php
	...
	{
		$tipoBoton = 'button';
		$llamado = 'mostrarVentanaVerificarImpuSer(this.form)';
		$label_submit = "Verificar Imputaci&oacute;n Correcta";
		$display_submit = "display:block;";
		
		$resul = $objConexion->consultar("select count(*) as cant from lg_verificarimpuordenser where Anio= '".$Anio."' and CodOrganismo='".$CodOrganismo."' and NroOrden='".$NroOrden."'",'fila');
	...
	} else if($_GET['boton'] == 'verificarPresupuesto')
	{
		...
		$tipoBoton = 'button';
		$llamado = 'mostrarVentanaVerificarPresuSer(this.form);';
		$label_submit = "Verificar Presupuestariamente";
		$display_submit = "display:block;";
		
		$resul = $objConexion->consultar("select count(*) as cant from lg_verificarpresuordenser where Anio= '".$Anio."' and CodOrganismo='".$CodOrganismo."' and NroOrden='".$NroOrden."'",'fila');
