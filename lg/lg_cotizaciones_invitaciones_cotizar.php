...
<table width="2250" class="tblLista">
	...
	while ($field_detalle = mysql_fetch_array($query_detalle)) {
        ...
        <tr class="trListaBody" onclick="mClk(this, 'sel_detalle');" id="<?=$field_detalle['CotizacionSecuencia']?>">
            ...
            <td align="center">
            	<input type="text" name="cant" value="<?=number_format($field_detalle['Cantidad'], 4, ',', '.')?>" style="width:97%; text-align:right;" class="cell" onblur="this.className='cell';" onfocus="this.className='cellFocus';" onchange="setMontosItemProveedor();" />
            </td>
            
            <td align="center">
            	<input type="text" name="pu" value="<?=number_format($field_detalle['PrecioUnitInicio'], 4, ',', '.')?>" style="width:97%; text-align:right;" class="cell" onblur="this.className='cell';" onfocus="this.className='cellFocus';" onchange="setMontosItemProveedor();" />
			</td>
            ...
            <td align="center">
            	<input type="text" name="descp" value="<?=number_format($field_detalle['DescuentoPorcentaje'], 4, ',', '.')?>" style="width:97%; text-align:right;" class="cell" onblur="this.className='cell';" onfocus="this.className='cellFocus';" onchange="setMontosItemProveedor();" />
            </td>
            
            <td align="center">
            	<input type="text" name="descf" value="<?=number_format($field_detalle['DescuentoFijo'], 4, ',', '.')?>" style="width:97%; text-align:right;" class="cell" onblur="this.className='cell';" onfocus="this.className='cellFocus';" onchange="setMontosItemProveedor();" />
            </td>
            
            <td align="center">
            	<input type="text" name="pu_desc" value="<?=number_format($field_detalle['PrecioUnit'], 4, ',', '.')?>" style="width:98%; text-align:right;" class="cell" readonly="readonly" />
            </td>
