...
function items(form, accion) {
	...
	for(var i=0; n=form.elements[i]; i++) {
		...
		else if (isNaN((n.value)) && n.id == "StockMax") { error = "Monto de stock maximo incorrecto"; break; }
		else if (isNaN((n.value)) && n.id == "StockMin") { error = "Monto de stock minimo incorrecto"; break; }
...
function commodity(form, accion) {
	...
	for(var i=0; n=frm_detalle.elements[i]; i++) {
		...
		else if (n.name == "FlagPresupuesto") if (n.checked) detalles += 'S' + "|"; else detalles += 'N' + "|";
...
function orden_compra(form, accion) {
	...
	for(var i=0; n=frm_detalles.elements[i]; i++) {
		if (n.name == "CodItem") detalles += n.value + ";char:td;";
			...
			var CantidadPedida =  new Number(n.value);//parseFloat((n.value));//isNaN(CantidadPedida) ||
			if (( isNaN(CantidadPedida) || CantidadPedida < 0) && accion!='anular') { error = "Se encontraron <strong>Cantidades</strong> en la ficha de <strong>Items/Commodities</strong> incorrectas"; break; }
			else detalles += CantidadPedida + ";char:td;";
		}
		else if (n.name == "PrecioUnit") {
			var PrecioUnit =  new Number(n.value);//parseFloat((n.value));//isNaN(PrecioUnit) || 
			if ((isNaN(PrecioUnit) ||  PrecioUnit < 0) && accion!='anular') { error = "Se encontraron <strong>Precios</strong> en la ficha de <strong>Items/Commodities</strong> incorrectos"; break; }
			else detalles += PrecioUnit + ";char:td;";
		}
		else if (n.name == "DescuentoPorcentaje") {
			var DescuentoPorcentaje =  new Number(n.value);//parseFloat((n.value));//isNaN(DescuentoPorcentaje) || 
			if ((isNaN(DescuentoPorcentaje) ||  DescuentoPorcentaje < 0) && accion!='anular') { error = "Se encontraron <strong>Porcentajes de Descuentos</strong> en la ficha de <strong>Items/Commodities</strong> incorrectos"; break; }
			else detalles += DescuentoPorcentaje + ";char:td;";
		}
		else if (n.name == "DescuentoFijo") {
			var DescuentoFijo =  new Number(n.value);//parseFloat((n.value));//isNaN(DescuentoFijo) || 
			if ((isNaN(DescuentoFijo) ||  DescuentoFijo < 0) && accion!='anular') { error = "Se encontraron <strong>Descuentos Fijos</strong> en la ficha de <strong>Items/Commodities</strong> incorrectos"; break; }
			...
			var PrecioUnitTotal =  new Number(n.value);//parseFloat((n.value));//isNaN(PrecioUnitTotal) || 
			if ((isNaN(PrecioUnitTotal) || PrecioUnitTotal < 0) && accion!='anular') { error = "Se encontraron <strong>Precios Totales</strong> en la ficha de <strong>Items/Commodities</strong> incorrectos"; break; }
			else detalles += PrecioUnitTotal + ";char:td;";
		}
		else if (n.name == "Total") {
			var Total =  new Number(n.value);//parseFloat((n.value));//isNaN(Total) || 
			if ((isNaN(Total) || Total < 0) && accion!='anular') { error = "Se encontraron <strong>Totales</strong> en la ficha de <strong>Items/Commodities</strong> incorrectos"; break; }
			else detalles += Total + ";char:td;";
		}
		else if (n.name == "FechaPrometida") {
			if (!valFecha(n.value) && accion!='anular') { error = "Se encontraron <strong>Fechas Prometidas</strong> en la ficha de <strong>Items/Commodities</strong> incorrectas"; break; }
	...
	for(var i=0; n=frm_partidas.elements[i]; i++) {
		...
		}//se quitaron las validaciones de '<=' y se dejo solo el '<' para que la orden de compra con valor 0 pueda generarse
	}
...
function orden_servicio_confirmar(form) {
	...
	for(var i=0; n=form.elements[i]; i++) {
		...
		else if ((isNaN((n.value)) || parseFloat(n.value) == 0) && n.id == "PorRecibirTotal") { error = "<strong>Cantidad</strong> incorrecta"; break; }
	}
...
function almacen_despacho(form) {
	...
	for(var i=0; n=frm_detalles.elements[i]; i++) {
		if (n.name == "CodItem") detalles += n.value + ";char:td;";
			...
			var CantidadRecibida = new Number((n.value));
		...
		else if (n.name == "PrecioUnit") detalles += (n.value) + ";char:td;";
		else if (n.name == "Total") detalles += (n.value) + ";char:td;";
		else if (n.name == "CodCentroCosto") detalles += n.value + ";char:td;";
...
function transaccion_cajachica_recepcion(form) {
	...
	for(var i=0; n=frm_detalles.elements[i]; i++) {
		if (n.name == "CodItem") detalles += n.value + ";char:td;";
			...
			var PrecioUnit = new Number((n.value));
