	...
	foreach ($detalle as $linea) {
		...
		<tr class="trListaBody" onclick="mClk(this, 'sel_detalles');" id="detalles_<?=$nrodetalles?>">
			...
			<td align="center">
            	...
            	<input type="text" name="CantidadRecibida" class="cell" style="text-align:right;" value="<?=number_format($CantidadPendiente, 4, '.', '')?>" />
            </td>
			<td align="center">
			...
			<td align="center">
            	...
            	<input type="hidden" name="ReferenciaNroDocumento" value="<?=$field_requerimiento['CodInterno']?>" />
