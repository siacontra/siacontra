<?php
	...
	$sql7 = "SELECT p.Nombres, p.Apellido1, p.Apellido2, p.Ndocumento, pu.DescripCargo
			...
			JOIN mastempleado AS me ON p.CodPersona = me.CodPersona
			JOIN rh_puestos AS pu ON me.CodCargo = pu.CodCargo
			WHERE me.CodEmpleado = '".$resultado1['RevisadoPor']."'";
   ...
   <tr>
		<td colspan="2" class="tagForm"><table width="" border="0" align="center" cellpadding="0" cellspacing="1">
                        ...
                        <td height="28" colspan="6"  align="right"><table width="800" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <?php 
						  		...
						  		for($i = 0; $i < count($resp2); $i++)
								{
									  ...
									  <td width="400" colspan="2" align="center">'. str_replace(".",",",$resp2[$i]['Cantidad']).'</td>
                      ...
                      <tr>
                        ...
                        <td colspan="5" align="center" valign="middle"><div align="left">
                          <input name="textfield3" type="text" size="50" value="<? echo $_SESSION['NOMBRE_USUARIO_ACTUAL']; ?>" disabled="disabled" />
                        </div></td>
                      </tr>
                        </table></td>
                      </tr>
					...
					<div class="capaResultadoBusqueda">
		              ...
		              <div align="center">
		                <table width="135" border="0">
                          <tr>
                            <td width="58"><input type="button" name="Submit" onclick="guardarAprobacion();" value="Aprobar" /></td>
                            <td width="67"><input type="button" name="Submit2" onclick="location.href='lg_aprobar_recomendacion.php'" value="Cancelar" /></td>
                          </tr>
                        </table>
		                <label></label>
		              </div>
