...
<table width="1000" class="tblBotones">
	<tr>
		...
		<td align="right">
			<input type="button" class="btLista" id="btInvitar_stock" value="Sel. Prov." onclick="cargarOpcionMultiple(this.form, 'lg_cotizaciones_invitar_proveedor.php?', 'BLANK', 'height=725, width=875, left=100, top=100, resizable=no', 'stock', 'registro', false);" />
            ...
            <input type="button" class="btLista" style="width:125px;" id="botonActaInicio" value="Acta Inicio" onclick="iniciarActaInicioCompra(this.form, 'lg_acta_inicio_compra.php?tipoReque=stock&opcion=ver', 'SELF', 'height=700, width=950, left=100, top=0, resizable=no', 'stock', 'registro', false);" /> | 
             <!-- BOTON PARA imprimir el pliego de condicones-->
             
             <input type="button" value="Pliego de Condiciones" id="botonPliego" onclick="iniciarActaInicioCompra(this.form, 'lg_pliego_form.php?tipoReque=stock&opcion=ver', 'SELF', 'height=700, width=950, left=100, top=0, resizable=no', 'stock', 'registro', false);" /> 
            <!-- BOTON PARA REALIZAR EL ACTA DE INICIO-->
...
<table width="2800" class="tblLista">
	...
	while ($field_stock = mysql_fetch_array($query_stock)) {
		...
		<tr class="trListaBody <?=estiloGrupo($t)?>"  onclick="mClkMultiReque(this,<?=$t?>);" id="row_<?=$id?>">
			...
			<td align="right"><?=number_format($field_stock['CantidadPedida'], 4, ',', '.')?></td>
	...
	<tr>
		...
		<td align="right">
            ...
            <input type="button" class="btLista" style="width:125px;" id="botonActaInicio" value="Acta Inicio" onclick="iniciarActaInicioCompra(this.form, 'lg_acta_inicio_compra.php?tipoReque=commodity&opcion=ver', 'SELF', 'height=700, width=950, left=100, top=0, resizable=no', 'commodity', 'registro', true);" /> | 
             ...
             <input type="button" value="Pliego de Condiciones" id="botonPliego" onclick="iniciarActaInicioCompra(this.form, 'lg_pliego_form.php?tipoReque=commodity&opcion=ver', 'SELF', 'height=700, width=950, left=100, top=0, resizable=no', 'commodity', 'registro', true);" /> 
            <!-- BOTON PARA REALIZAR EL ACTA DE INICIO--> 
...
<table width="2750" class="tblLista">
	...
	while ($field_comm = mysql_fetch_array($query_comm)) {
		...
		<tr class="trListaBody <?=estiloGrupo($t)?>" onclick="mClkMultiReque(this,<?=$t?>);" id="row_<?=$id?>">
			...
			<td align="right"><?=number_format($field_comm['CantidadPedida'], 4, ',', '.')?></td>
