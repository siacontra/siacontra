	...
	<tr style=" <?=$display_pa?>">
		<td colspan="2" class="tagForm"><table width="853" height="181" border="0" align="center" cellspacing="1" class="tblLista">
		  ...
		  <tr style="font-size:10px;cursor:default" class="trListaBody">
		    ...
		    <td align="center"><table width="43" border="0" cellspacing="0">
		      ...
		      <tr  style="font-size:10px;">
				...
				{
					echo 'restablecerLista(\'proveedorRequeTec'.$i.'\',\''.$resultado6[$i]['PuntajeRequeTec'].'\');
						restablecerLista(\'proveedorTiempoEntrega'.$i.'\',\''.$resultado6[$i]['PuntajeTiempoEntrega'].'\');
						restablecerLista(\'proveedorCondicionPago'.$i.'\',\''.$resultado6[$i]['PuntajeCondicionPago'].'\');';
				}
				echo '</script>';
          ...
          <tr style="background-color: #000066;color: #EFEFEF; font-size:10px;">
		      <td colspan="3" align="center"  >Total de la Puntuación Técnica</th>
              ...
              <?php 
				...
				{
					echo '<td align="center">
					  <input  style="font-weight:bold;" name="textfield10" type="text" id="totalPuntuacionProvee'.$i.'" value="'.$resultado6[$i]['TotalPuntajeCuali'].'" size="5" maxlength="2" disabled="disabled" />
					</th>';
				}
			?>
