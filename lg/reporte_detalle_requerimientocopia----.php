...
<form name="frmentrada" id="frmentrada" method="post" action="reporte_detalle_requerimiento_pdf copia.php" target="iTab1" onsubmit="return reporte_detalle_requerimiento(this);">
