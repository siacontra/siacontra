...
<table width="2400" class="tblLista">
	...
	while ($field_detalles = mysql_fetch_array($query_detalles)) {
		...
		<tr class="trListaBody" onclick="mClk(this, 'sel_detalles');" id="detalles_<?=$nrodetalles?>">
			...
			<td align="center">
            	<input type="text" name="CantidadPedida" class="cell2" style="text-align:right;" value="<?=number_format($field_detalles['CantidadPedida'], 4, '.', '')?>" onchange="setMontosOrdenCompra(this.form);" readonly />
            </td>
			<td align="center">
            	<input type="text" name="PrecioUnit" class="cell2" style="text-align:right;" value="<?=number_format($field_detalles['PrecioUnit'], 4,  '.', '')?>" onchange="setMontosOrdenCompra(this.form);" readonly />
            </td>
			<td align="center">
            	<input type="text" name="DescuentoPorcentaje" class="cell2" style="text-align:right;" value="<?=number_format($field_detalles['DescuentoPorcentaje'], 4,  '.', '')?>" onchange="setMontosOrdenCompra(this.form);" readonly />
            </td>
			<td align="center">
            	<input type="text" name="DescuentoFijo" class="cell" style="text-align:right;" value="<?=number_format($field_detalles['DescuentoFijo'], 4,  '.', '')?>" onchange="setMontosOrdenCompra(this.form);" readonly />
            </td>
			<td align="center">
			...
			<td align="center">
            	<input type="text" name="PrecioUnitTotal" class="cell2" style="text-align:right;" value="<?=number_format($PrecioUnitTotal, 4,  '.', '')?>" readonly="readonly" />
            </td>
			<td align="center">
