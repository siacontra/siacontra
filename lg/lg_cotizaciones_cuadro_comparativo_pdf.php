...
for($i=0; $i<$r; $i++) {
	...
	$pdf->Row(array(utf8_decode($field_items['Descripcion']),
					...
					number_format($cantidad[0], 4, ',', '.'),
					number_format($preciounit[0], 4, ',', '.'),
					number_format($total[0], 4, ',', '.'),
					number_format($cantidad[1], 4, ',', '.'),
					number_format($preciounit[1], 4, ',', '.'),
					number_format($total[1], 4, ',', '.'),
					number_format($cantidad[2], 4, ',', '.'),
					number_format($preciounit[2], 4, ',', '.'),
					number_format($total[2], 4, ',', '.')));	
	$sum_total[0] += $total[0];
	$sum_total[1] += $total[1];
	$sum_total[2] += $total[2];	
...
$pdf->Cell(25, 5, number_format($sum_total[0], 4, ',', '.'), 1, 0, 'R');
if ($_ROWS_PROVEEDORES == 2) $pdf->Cell(62, 5, number_format($sum_total[1], 4, ',', '.'), 1, 0, 'R');
elseif ($_ROWS_PROVEEDORES == 3) {
	$pdf->Cell(62, 5, number_format($sum_total[1], 4, ',', '.'), 1, 0, 'R');
	$pdf->Cell(62, 5, number_format($sum_total[2], 4, ',', '.'), 1, 1, 'R');
}
//---------------------------------------------------
//	Impuesto
...
$pdf->Cell(25, 5, number_format($sum_total_iva[0], 4, ',', '.'), 1, 0, 'R');
if ($_ROWS_PROVEEDORES == 2) $pdf->Cell(62, 5, number_format($sum_total_iva[1], 4, ',', '.'), 1, 0, 'R');
elseif ($_ROWS_PROVEEDORES == 3) {
	$pdf->Cell(62, 5, number_format($sum_total_iva[1], 4, ',', '.'), 1, 0, 'R');
	$pdf->Cell(62, 5, number_format($sum_total_iva[2], 4, ',', '.'), 1, 0, 'R');
}
//---------------------------------------------------
$pdf->SetDrawColor(0, 0, 0);
$pdf->SetFillColor(0, 0, 0);
...
$pdf->Cell(25, 5, number_format($sum_total[0]+$sum_total_iva[0], 4, ',', '.'), 1, 0, 'R');
if ($_ROWS_PROVEEDORES == 2) $pdf->Cell(62, 5, number_format($sum_total[1]+$sum_total_iva[1], 4, ',', '.'), 1, 0, 'R');
elseif ($_ROWS_PROVEEDORES == 3) {
	$pdf->Cell(62, 5, number_format($sum_total[1]+$sum_total_iva[1], 4, ',', '.'), 1, 0, 'R');
	$pdf->Cell(62, 5, number_format($sum_total[2]+$sum_total_iva[2], 4, ',', '.'), 1, 0, 'R');
}
//---------------------------------------------------
$pdf->SetDrawColor(0, 0, 0);
