	...
	foreach ($detalle as $linea) {
		...
		<tr class="trListaBody" onclick="mClk(this, 'sel_detalles');" id="detalles_<?=$nrodetalles?>">
			...
			<td align="center">
            	...
            	<input type="text" name="CantidadRecibida" class="cell" style="text-align:right;" value="<?=number_format($_CantidadPendiente, 4, '.', '')?>" onchange="setMontosAlmacen(this.form);" />
            </td>
			<td align="center"><!-- onBlur="numeroBlur(this);" onFocus="numeroFocus(this);" -->
            	<input type="text" name="PrecioUnit" class="cell" style="text-align:right;" value="<?=number_format($_PrecioUnit, 4,  '.', '')?>" onFocus="this.value=''"   onchange="setMontosAlmacen(this.form);" />
            </td>
			<td align="center">
