...
<body onload="consultarEstadoReq('');buscarInformeRecomendacion();">
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Declaraci&oacute;n Desierto</td>
		...
		<td colspan="2" class="tagForm"><table width="846" border="0" align="center" cellpadding="0" cellspacing="1">
                      <tr>
                        ...
                        <td width="83" align="center" valign="middle">
                          <input type="button" name="Submit3" value="Buscar" onclick="buscarInformeRecomendacion();" />
                      </td>
                        ...
                        <td align="center" valign="middle"><!--<input type="button" name="Submit5" value="Modificar" onclick="cargarDatosModificarEvaluacion();" />-->
                          ...
                          <input type="button" name="Submit" value="Declarar Desierto" onclick="cargarDeclararDesierto();" />                        </td>
                        <td width="57"><input type="button" name="Submit2" value="Procedimientos Desiertos" onclick="location.href='lg_desierto_busqueda.php'"; /></td>
          </tr>
                    </table>
