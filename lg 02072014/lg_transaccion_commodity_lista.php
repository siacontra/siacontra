	...
	<tr>
		...
		<td align="right">
			...
			<input type="button" id="btVer" value="Ver" style="width:75px; <?=$btVer?>" onclick="cargarOpcion2(this.form, 'gehen.php?anz=lg_transaccion_commodity_form&opcion=ver', 'SELF', '', $('#registro').val());" />
			 ...
			 <input type="button" id="btImprimir" value="Imprimir" style="width:75px; <?=$btImprimir?>" onclick="cargarOpcion2(this.form, 'gehen.php?anz=lg_transaccion_commodity_reportes', 'BLANK', 'height=800, width=1050, left=50, top=50, resizable=no', $('#registro').val());" /> | 
			...
			<input type="button" id="btReversa" value="Reversa" style="width:75px; <?=$btReversa?>" onclick="cargarOpcionValidar2(this.form, $('#registro').val(), 'accion=transaccion_almacen_reversa', 'gehen.php?anz=lg_transaccion_commodity_form&opcion=reversa', 'SELF', '');" />
