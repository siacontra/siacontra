...
<table width="833" class="tblForm">
	...
	<tr>
		<td class="tagForm"><input type="hidden" id="cantidadProveedores" maxlength="10" value="<? echo count($resp); ?>" /><input type="hidden" id="codActaInicio" maxlength="10" value="<? echo $codActa; ?>" />* Objeto:</td>
		...
		<td colspan="2" class="tagForm"><table width="853" height="181" border="0" align="center" cellspacing="1" class="tblLista">
		  ...
		  <tr class="trListaBody" style="font-size:10px;cursor:default;">
		    ...
		    <?php 
				...
				echo '<td align="center"><input  id="proveedorRequeTec'.$i.'" onblur="sumarAspectoCualitativo('.$i.');" type="text" size="6" maxlength="5"  /></td>';
					 /*'<td align="center">
		  ...
		  <tr style="font-size:10px;cursor:default" class="trListaBody">
		    <td>Condiciones de Pago (5 días después de emitida la factura)</td>
		    <!--<td align="center"><table width="43" border="0" cellspacing="0">
		      <tr style="font-size:10px;">
		        <td width="41" align="center">SI</td>
	          </tr>
          ...
          <tr style="background-color: #000066;color: #EFEFEF; font-size:10px;">
		      <td  align="center"  >Total de la Puntuación Técnica</th>
			...
			{////'.$menor.';
				echo 'xGetElementById(\'ofertaEconomica'.$i.'\').value=(parseFloat(('.$menor.'))).toFixed(2);
						...
						if(xGetElementById(\'oferta'.$i.'\').value > 0)
						{
							...
							xGetElementById(\'PMO_POE'.$i.'\').value=(parseFloat(('.$menor.'/PMO_POE))).toFixed(2);
							var PP = xGetElementById(\'PP'.$i.'\').value;
							xGetElementById(\'PP'.$i.'\').value = (xGetElementById(\'PMO_POE'.$i.'\').value)*60;
