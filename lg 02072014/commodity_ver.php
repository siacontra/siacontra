...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Commodities | Ver Registro</td>
...
<table width="500" class="tblForm">
	...
	<tr>
		...
		<td>
			<select name="clasificacion" id="clasificacion" style="width:175px;" disabled="disabled">
				<?=loadSelect("lg_commodityclasificacion", "Clasificacion", "Descripcion", $field['Clasificacion'], 1)?>
			</select>*
		</td>
	</tr>
	<tr>
...
<center>
<iframe name="frameSub" id="frameSub" class="frameTab" style="height:350px; width:900px;" src="commodity_sub_clasificacion.php?accion=VER&commoditymast=<?=$registro?>"></iframe>
</center>
