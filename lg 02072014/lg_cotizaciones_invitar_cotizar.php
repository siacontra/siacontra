	...
	while ($field_detalle = mysql_fetch_array($query_detalle)) {
		...
		if($field_detalle['CodProveedor'] != $codProveedorAux)
		{
			...
			<tr class="trListaBody" onclick="mClk(this, 'sel_detalle');" id="<?=$field_detalle['CodProveedor']?>">
				...
				<td align="center">
					<input type="text" name="cant" value="<?=number_format($field_detalle['Cantidad'], 2, ',', '.')?>" style="width:97%; text-align:right;" class="cell" onblur="numeroBlur(this); this.className='cell';" onfocus="numeroFocus(this); this.className='cellFocus';" onchange="setMontosProveedorItem();" />
				</td>
				
				<td align="center">
					<input type="text" name="pu" value="<?=number_format($field_detalle['PrecioUnitInicio'], 2, ',', '.')?>" style="width:97%; text-align:right;" class="cell" onblur="numeroBlur(this); this.className='cell';" onfocus="numeroFocus(this); this.className='cellFocus';" onchange="setMontosProveedorItem();" />
				</td>
				...
				<td align="center">
					<input type="text" name="descp" value="<?=number_format($field_detalle['DescuentoPorcentaje'], 2, ',', '.')?>" style="width:97%; text-align:right;" class="cell" onblur="numeroBlur(this); this.className='cell';" onfocus="numeroFocus(this); this.className='cellFocus';" onchange="setMontosProveedorItem();" />
				</td>
				
				<td align="center">
					<input type="text" name="descf" value="<?=number_format($field_detalle['DescuentoFijo'], 2, ',', '.')?>" style="width:97%; text-align:right;" class="cell" onblur="numeroBlur(this); this.className='cell';" onfocus="numeroFocus(this); this.className='cellFocus';" onchange="setMontosProveedorItem();" />
				</td>
				...
				<td align="center">
					<input type="text" name="comparar" value="<?=number_format($precio_unitario_final, 2, ',', '.')?>" style="width:98%; text-align:right;" class="cell" readonly="readonly" />
				</td>
				...
				<td align="center"><?=formatFechaDMA($field_detalle['FechaDocumento'])?></td>
