...
<table width="1000" class="tblForm">
    ...
    <tr>
		...
		<td><!--cambio de la funcion loadSelectDependiente por getDependencias y se agrego la funcion getOptionsSelect en el onchange para que se filtraran los centros de costo, F: 13/02/2014 Guidmar-->
			<select id="CodDependencia" style="width:275px;" <?=$disabled_ver?> onchange="getOptionsSelect(this.value, 'centro_costo', 'CodCentroCosto', true);">
...
<table width="1000" class="tblBotones">
	<tr>
		<td align="right" class="gallery clearfix">
			...
			<input type="button" class="btLista" value="Borrar" id="btBorrar" onclick="quitarLinea(this, 'detalles');"  /> | 
...
<table width="100%" class="tblLista">
	...
	while($field_detalle = mysql_fetch_array($query_detalle)) {
		...
		<tr class="trListaBody" onclick="mClk(this, 'sel_detalles');" id="detalles_<?=$nrodetalles?>">
			...
			<td align="center">
            	<input type="text" name="CantidadRecibida" class="cell" style="text-align:right;" value="<?=number_format($field_detalle['CantidadRecibida'], 4, ',', '.')?>"  onchange="setMontosAlmacen(this.form);" <?=$disabled_item?> />
            </td>
			<td align="center"><!-- onBlur="numeroBlur(this);" onFocus="numeroFocus(this);" -->
            	<input type="text" name="PrecioUnit" class="cell" style="text-align:right;" value="<?=number_format($_PrecioUnit, 4, ',', '.')?>" onFocus="this.value=''"  onchange="setMontosAlmacen(this.form);" <?=$dPrecioUnit?> />
            </td>
			<td align="center">
