...
<body onload="consultarEstadoReq('');buscarActaOrdenCompra();">
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Ordenes de Compra para el Control Perceptivo</td>
...
<div style="width:990px; height:15px" class="divFormCaption">Ordenes Generadas</div>
<table width="989" height="147" border="0" class="tblForm">
<tr><td height="5"></td></tr>
<tr> <!-- ///////////  PRIMER ////////// -->
  <td><form id="fromActa"></form></td>
</tr>
   <tr>
		<td colspan="2" class="tagForm"><table width="931" border="0" align="center" cellpadding="0" cellspacing="1">
                      <tr>
                        ...
                        <td width="83" align="center" valign="middle">
                          <input type="button" name="Submit3" value="Buscar" onclick="buscarActaOrdenCompra();" />
                      </td>
                        ...
                        <td width="81" align="center" valign="middle"><input type="button" name="Submit5" value="Control Perceptivo" onclick="mostrarPaginaControlPerceptivo();" /></td>
                        <td align="center" valign="middle"><input type="button" name="input" value="Modificar Controles Perceptivos Realizados" onclick="location.href='lg_controlperceptivo_busqueda.php';" /></td>
          </tr>
                    </table>
					...
					<table width="100%" border="0" class="tblLista" align="center" cellpadding="0" cellspacing="2">
						<thead>
						  <tr class="trListaHead" width="100%">
							<td width="20%"><div align="center">N° ORDEN</div></td>
							<td width="40%"><div align="center">PROVEEDOR</div></td>
							<!--<td width="40%"><div align="center">FECHA DE PROMETIDA</div></td>-->
						  </tr>
					  	</thead>
