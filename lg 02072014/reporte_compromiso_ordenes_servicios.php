...
<script language="javascript" >
	function llamadoTabReporte(tab) {
		...
		if (tab == "general") form.action = "reporte_compromiso_ordenes_servicios_pdf.php";
		else form.action = "reporte_compromiso_ordenes_servicios_detalle_pdf.php";	
		form.submit();
	}
</script>
</head>
...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Ordenes de Servicios Distribuci&oacute;n/Comprometidas</td>
		<td align="right"><a class="cerrar"; href="framemain.php">[Cerrar]</a></td>
	</tr>
</table><hr width="100%" color="#333333" />

<form name="frmentrada" id="frmentrada" method="post" action="reporte_compromiso_ordenes_servicios_pdf.php" target="iReporte">
