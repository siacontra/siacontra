...
function verificarEvaluacionDesempenioEmpleado(form, accion) {
	...
	for(i=0; n=frmdetalles_tab2.elements[i]; i++) {
		...
		if (n.name == "txtcalificacion_tab2") {
			if (n.value.trim() != "") detalles_tab2 += setNumero(n.value) + "|";
	...
	//	Funciones (Tab3)...
	var detalles_tab3 = "";
	var peso_tab3 = new Number(0.00);
	var frmdetalles_tab3 = document.getElementById("frmdetalles_tab3");
	var cantdetalles_tab3 = new Number(document.getElementById("cantdetalles_tab3").value);
	for(i=0; n=frmdetalles_tab3.elements[i]; i++) {
		if (n.name == "txtfuncion_tab3") {
			if (n.value.trim() != "") detalles_tab3 += n.value + "|";
			else { error_tab3 = true; break; }
		}
		if (n.name == "txtcalificacion_tab3") {
			if (n.value.trim() != "") detalles_tab3 += setNumero(n.value) + "|";
			else { error_tab3 = true; break; }
		}
		if (n.name == "txtpeso_tab3") {
			if (n.value.trim() != "") { detalles_tab3 += setNumero(n.value) + ";"; peso_tab3 += setNumero(n.value); }
			else { error_tab3 = true; break; }
		}
	}
	var len = detalles_tab3.length; len--;
	detalles_tab3 = detalles_tab3.substr(0, len);
	//	---------------------------
	...
	for(i=0; n=frmdetalles_tab5.elements[i]; i++) {
		...
		if (n.name == "txtcalificacion_tab5") {
			if (n.value.trim() != "") detalles_tab5 += setNumero(n.value) + "|";
			else { error_tab5 = true; break; }
		}
	...
	for(i=0; n=frmdetalles_tab6.elements[i]; i++) {
		...
		if (n.name == "sltprioridad_tab6") {
			if (n.value.trim() != "") detalles_tab6 += n.value + "|";
			else { error_tab6 = true; break; }
		}
		if (n.name == "txtcodcurso_tab6") {
			if (n.value.trim() != "") detalles_tab6 += n.value + "|";
			else { error_tab6 = true; break; }
		}
		if (n.name == "txtobjetivo_tab6") detalles_tab6 += n.value + "|";
	}
	...
	else if (error_tab5) alert("¡En la ficha de Objetivos y Metas dejó campos obligatorios vacios!");
	else if (error_tab6) alert("¡En la ficha de Necesidad de Capacitación dejó campos obligatorios vacios!");
	else if (error_tab2_8) alert("¡En la ficha Desempeño el peso debe ser un valor entre 1 y 8!");
	...
	else if (error_tab5_1050) alert("¡En la ficha Objetivos y Metas el peso debe ser un valor entre 10 y 50!");
	else if (peso_tab5 != 50) alert("¡En la ficha de Objetivos y Metas la suma del peso no puede ser diferente de 50!");
...
function setTotalesCalificacionPesoDesempeno(id) {
	...
	var clase = document.getElementById("txtpeso_tab2_"+id).className; //ojo
