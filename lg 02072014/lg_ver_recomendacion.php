...
<body onload="consultarEstadoReq('');buscarRecomendacionRealizada();">
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Ver  Recomendaci&oacute;n </td>
...
<div style="width:895px; height:15px" class="divFormCaption">Recomendaciones Realizadas </div>
		...
		<td colspan="2" class="tagForm"><table width="894" border="0" align="center" cellpadding="0" cellspacing="1">
                      <tr>
                        ...
                        <td width="70" align="center" valign="middle">
                          <input type="button" name="Submit3" value="Buscar" onclick="buscarRecomendacionRealizada();" />
                      </td>
                        <td width="58" align="center" valign="middle">
                          <input type="button" name="Submit4" value="Limpiar" onclick="xGetElementById('codigoRecomendacionBusqueda').value='';" />
                       </td>
                        <!--<td width="68" align="center" valign="middle"><input type="button" name="Submit5" value="Revisar" onclick="revisarRecomendacion();" /></td>-->
