...
<body onload="buscarMaestroUtiles();">
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Maestro Beneficio &Uacute;tiles </td>
...
<div style="width:895px; height:15px" class="divFormCaption">Maestro Beneficio &Uacute;tiles </div>
...
<tr> <!-- ///////////  PRIMER ////////// -->
  <td></td>
   ...
   <tr>
		<td colspan="2" class="tagForm"><table width="850" border="0" align="center" cellpadding="0" cellspacing="1">
                      <tr>
                        <td width="166" height="28"  align="right"><label>B&uacute;squeda por N&uacute;mero:</label></td>
                        <td width="259">
                          <input name="numMaestroUtiles" id="numMaestroUtiles" type="text" size="40" maxlength="60" class="campoTexto" onkeyup="llamadoGenericoEvento(event,'buscarMaestroUtiles',this.id)" />                        </td>
                        <td width="82" align="center" valign="middle">
                          
                          <div align="right">
                            <input type="button" name="Submit3" value="Buscar" onclick="buscarMaestroUtiles();" />                      
                          </div></td><td width="129" align="center" valign="middle">
                          <div align="left"></div></td>
                        <td width="65" align="center" valign="middle">
                            <input type="button" name="" value="Nuevo" onclick="location.href='rh_maestro_nuevo_utiles.php';" />                       </td>
                        <td width="73" align="center" valign="middle"><input type="button" name="Submit5" value="Modificar" onclick="cargarDatosModificarMaestroutiles();" />                        </td>
                        <td width="68"><input type="button" name="input" value="Eliminar" onclick="eliminarMaestroUtiles();" /></td>
          </tr>
                    </table>
	      <input type="hidden" id="fila" name="hiddenField" value="0" />
		  <input type="hidden" id="estiloFila" name="hiddenField2" value="0" />
		  <input type="hidden" id="codigoMaestroUtiles" name="hiddenField3" value="0"/>
					...
					<table width="100%" border="0" class="tblLista" align="center" cellpadding="0" cellspacing="2">
						<thead>
						  <tr class="trListaHead" width="100%">
							<td width="18%"><div align="center">N&Uacute;MERO</div></td>
							<td width="51%"><div align="center">DESCRIPCI&Oacute;N</div></td>
							<td width="17%"><div align="center">PERIODO</div></td>
							<td width="14%"><div align="center">MONTO</div></td>
						  </tr>
					  	</thead>
