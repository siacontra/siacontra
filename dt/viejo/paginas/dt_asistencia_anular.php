...
<div id="Contenido">
						<div>
                        	...
                        	<center>   <b> <font size="4">Anular Asistencia</font></b></center>
                            <br>
                            <form name="form1" action="procesar_asistencia_anular.php?a=1" method="post" onSubmit="return valid(this)">
                           ...
                           <input type="hidden" name="co_asistencia" maxlength="10" value="<?php echo $row['co_asistencia'] ?>" id="co_asistencia" >
                             ...
                             <!--       <tr>
                               ...
                               <!------------------------------------------------------------------------------>	
                                	...
                                	<tr>
                                    	<td align="left"><input type="submit" name="enviar" value="Anular" onClick="javascript:procesar();"/></td>
        								<td /></td>
                                    </tr>
    							</table>
                            </form>	 
