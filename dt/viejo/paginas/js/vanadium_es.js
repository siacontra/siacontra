	...
	Vanadium
			.addValidatorTypes( [
					...
					[
							...
							"<br>Por favor, use sólo números en este campo. <br>Evite espacios u otros caracteres, tales como: - . , /" ],
					[
							"alpha",
							function(a) {
								return Vanadium.validators_types.empty.test(a)
					...
					[
							...
							"<br>Introduzca una dirección de correo electrónico válida. Por ejemplo: xxx@domain.com ." ],
					[
							"url",
							function(a) {
								return Vanadium.validators_types.empty.test(a)
					...
					[
							...
							"<br>Utilice este formato de fecha: dd/mm/aaaa.<br>Por ejem. 01/02/1982 para el 01 de febrero <br>de 1982." ],
					[
							"date_nacimiento",
							function(a) {
