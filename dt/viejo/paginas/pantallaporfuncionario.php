			...
			<body>
				...
				<div id="Contenido">
				  <div align="justify" >
                        ...
                        <br>
                        <br>
                        	<center><bold><font size="4">Listado por Funcionario</font></bold></center>
                            <form name="form1"action="proceso_generarfuncionario.php?a=1" method="post" onSubmit="return valid(this)" >
                            <br>
