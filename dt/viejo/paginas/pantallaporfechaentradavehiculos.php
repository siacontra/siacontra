			...
			<div id="container">
				...
				<div id="Contenido">
				  <div align="justify" >
                        ...
                        <br>
                        <center>
                        	  <bold><font size="4">Entrada de Vehiculos por fecha</font></bold></center>
                            <br>
                        	<form action="proceso_generarreporfechaentradavehiculos.php?a=1" method="post" onSubmit="return valid(this)">
