...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Asistencia Tecnica | Asignar</td>
...
<div id="Contenido">
						<div>
                        	...
                        	<center>   <b> <font size="4">Aprobar Asistencia</font></b></center>
                            <br>
                            <form name="form1" action="procesar_asistencia_aprobar.php?a=1" method="post" onSubmit="return valid(this)">
                           ...
                           <input type="hidden" name="co_asistencia" maxlength="10" value="<?php echo $row['co_asistencia'] ?>" id="co_asistencia" >
                             ...
                             <!--       <tr>
                               ...
                               <!------------------------------------------------------------------------------>	
                                	...
                                	<tr>
                                    	<td align="left"><input type="submit" name="enviar" value="Aprobar" onClick="javascript:procesar();"/></td>
