...
<table width="1000" class="tblLista">
 <tr> <input type="hidden" id="registro" name="registro"/>
  ...
  <td align="right">
    ...
    <input type="button" name="btAsignar"       id="btAsignar"    class="btLista" value="Asignar"   onclick="cargarPaginaAgregar(this.form, 'dt_asistencia_asignar.php?regresar=dt_asistencias_lista&fEstado=<?=$fEstado;?>&fOrganismo=<?=$fOrganismo;?>&fBuscarPor=<?=$fBuscarPor;?>&fDependencia=<?=$fDependencia;?>&fSituacionActivo=<?=$fSituacionActivo;?>&fClasf20=<?=$fClasf20;?>&DescpClasf20=<?=$DescpClasf20;?>&fClasificacion=<?=$fClasificacion;?>&fubicacion=<?=$fubicacion;?>&BuscarValor=<?=$BuscarValor;?>&fubicacion2=<?=$fubicacion2;?>&DescpClasificacion=<?=$DescpClasificacion;?>');"/>  
