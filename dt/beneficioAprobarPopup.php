...
<tr>
 <td class="titulo">Beneficio | Aprobar</td>
 <td align="right"><a class="cerrar" style="cursor:pointer" onclick="cargarPagina(document.getElementById('frmentrada'), 'beneficioAprobar?limit=<?=$_POST['limit']?>');";>[Cerrar]</a></td>
</tr>
...
<input type='hidden' name='registro' id='registro' value='".$coBeneficio."' />";
...
<tr>
 ...
 <td width="91" align="right"><input type="hidden" id="registro" name="registro" value="<?=$coBeneficio?>" /></td>
 <td width="129">&nbsp;</td>
...
<tr>
  ...
  <td colspan="2"><select name="sel_institucion" id="sel_institucion" disabled="disabled" >
    </select>
    *</td>
  <td>&nbsp;</td>
  </tr>
...
<center>
<input name="btaprobar" type="button" id="btaprobar" value="Aprobar" onclick="aprobarBeneficio(form)"/>
...
function aprobarBeneficio(form){
   ...
   <SCRIPT LANGUAGE="JavaScript">
	...
	//alert(registro);
	cargarDatosBeneficio(registro,"VER");
	</script>
