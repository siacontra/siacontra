...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Maestro Instituciones | Ver Institucion</td>
...
<div style="width:100%" class="divFormCaption">Datos</div>
<table width="100%" class="tblForm">
  ...
  <tr>
    <td class="tagForm">Nombre Institucion:</td>
    <td><input name="txt_nombremedico" type="text" id="txt_nombremedico" size="100" readonly maxlength="100"  value="<?=$fieldE['descripcioninsthcm'];?>"/>*</td>
  </tr>	
<tr>
    <td class="tagForm">Direccion:</td>
    <td><input name="txt_nombremedico" type="text" id="txt_nombremedico" size="100" readonly maxlength="100"  value="<?=$fieldE['direccion'];?>"/>*</td>
  </tr>
  <tr>
    <td class="tagForm">Telefono :</td>
    <td><label for="txt_telefono"></label>
      <input name="txt_telefono" type="text" id="txt_telefono" readonly value="<?=$fieldE['telefonos'];?>" </td>
  </tr>
