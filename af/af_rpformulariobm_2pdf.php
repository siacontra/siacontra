...
$texto = ucfirst($texto) ;
	...
	$this->SetXY(10,34);$this->SetFont('Arial', 'B', 8);
						...
						$this->SetFont('Arial', '', 8);$this->Cell(80, 3, $f_cons['DescpCentroCosto'], 0, 0, 'L');
						$this->SetFont('Arial', 'B', 8);
						$this->Cell(17, 3, 'SERVICIO:', 0, 0, 'L');
						$this->SetFont('Arial', '', 8);	$this->Cell(80, 3, utf8_decode($f_cons['Dependencia']), 0, 1, 'L');
	...
	$this->VCell(7, 21, utf8_decode('Concepto de Movimiento'), 1, 0, 'C');
    $this->VCell(8, 21, utf8_decode('Cantidad'), 1, 0, 'C');	
	$this->VCell(30, 21, utf8_decode('N° Identificación'), 1, 0, 'C');
	$this->Cell(108, 21, utf8_decode('NOMBRE Y DESCRIPCION DE LOS BIENES, REFERENCIA DE LOS COMPROBANTES Y DE LOS PRECIOS UNITARIOS'), 1, 0, 'C');
...
if($ractivo!=0)
   for($i=0; $i<$ractivo; $i++){
	  ...
	  $pdf->SetFont('Arial', '', 9);
	  $pdf->SetWidths(array(10,10,10,7,8,30,108,30,30));
...
/*$pdf->SetDrawColor(0, 0, 0); $pdf->SetFillColor(202, 202, 202); $pdf->SetTextColor(0, 0, 0);
	...
	$pdf->Cell(120,2,'',0,0,'C');    $pdf->Cell(127,2,$nivel02.' '.utf8_decode($nombreCompleto02),0,1,'C');
