...
<table width="100%" cellspacing="0" cellpadding="0">
 <tr>
  <td class="titulo">Activos | Etiquetas</td>
  <td align="right">
...
<center><input type='submit' name='btBuscar' value='Generar' onclick='cargarEtiquetaActivos(this.form);'></center>
<br /><div style='width:900;' class='divDivision'>Etiquetas Activos</div>
<form/><br />";
?>
...
<center>
<iframe name="af_etiquetaactivospdf" id="af_etiquetaactivospdf" style="border:solid 1px #CDCDCD; width:900px; height:400px; visibility:false; display:false;" ></iframe>
</center>
<form/>
</body>
</html>
