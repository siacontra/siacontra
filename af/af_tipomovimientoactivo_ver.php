...
<table width="700" class="tblForm">
	...
	<tr>
		...
		<td><input name="descripcion" type="text" id="descripcion" maxlength="255" value="<?=htmlentities($field['DescpMovimiento']);?>" style="width:90%;" readonly/>*</td>
	</tr>
	<tr>
	...
	<td>
		...
		<input name="ult_fecha" type="text" id="ult_fecha" size="25"  disabled="disabled" value="<?=$field['UltimaFechaModif'];?>"/>
	</td>
	</tr>
</table>
<!--<center> 
