...
<form id="frmentrada" name="frmentrada" action="af_activosmenoreseditar.php?limit=0"  onsubmit="return modificarActivosMenores(this);">
<? 
 echo"
...
<tr>
  ...
  <td colspan="3"><textarea id="descripcionLocal" name="descripcionLocal" cols="160" rows="4"><?=$field['Descripcion']; ?></textarea><!--<input type="button" id="btCargar" name="btCargar" value="..." onclick="cargarVentanaLista(this.form, 'af_listactivoslogistica.php?limit=0&campo=2','height=500, width=820, left=200, top=100, resizable=yes');"/>--></td>
  <td></td>
</tr>
<tr>
  <td class="tagForm">Descrip. Corta:</td>
  <td><input type="text" name="descripcionCorta" id="descripcionCorta" size="164" value="<?=$field['DescpCorta'];?>"/></td>
</tr>
</table>
...
<tr>
   ...
   <td width="245">
     <? if($field['Estado']=='PE'){?>
          <input type="radio" id="radio1" checked value="A" onclick="chekeador(this.form, this.id);" />Pendiente <input type="radio" id="radio2" value="I" onclick="chekeador(this.form, this.id);" />Activado
   <? }else{?>
          <input type="radio" id="radio1" value="A" onclick="chekeador(this.form, this.id);" />Pendiente <input type="radio" id="radio2" checked value="I" onclick="chekeador(this.form, this.id);" /> Activado
   <? }?></td>
...
?>
 ...
 <td width="361" colspan="2" class="gallery clearfix"><input type="text" id="proveedor" name="proveedor" size="8" value="<?=$fsur['CodProveedor'];?>" disabled/> <input type="text" id="nomb_proveedor" name="nomb_proveedor" size="51" value="<?=$fsur['NombreProveedor'];?>" readonly/>
