...
class PDF extends FPDF {
	...
	function Header() {
		...
		$this->Cell(190, 5,utf8_decode( 'Contralor�a del Estado Sucre'), 0, 1, 'C');
		$this->Cell(190, 5, utf8_decode('Divisi�n de Recursos Humanos'), 0, 1, 'C'); $this->Ln();
		...
		$this->Cell(140, 5, 'DESCRIPCI�N', 1, 0, 'C', 1);
