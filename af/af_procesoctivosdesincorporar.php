...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Desincorporar | Activo Mayor</td>
		<td align="right"><a class="cerrar" href="" onclick="window.close();">[cerrar]</a></td>
	</tr>
</table>
<hr width="100%" color="#333333" />

<form id="frmentrada" name="frmentrada" onsubmit="return DesincorporarActivo(this);">
...
<center><input type="submit" name="btAprobar" id="btAprobar" value="Desincorporar"/><input type="button" name="btCancelar" id="btCancelar" value="Cancelar" onclick="window.close();"/></center>
</form>
