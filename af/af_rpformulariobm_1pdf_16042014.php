...
/*$pdf->SetDrawColor(0, 0, 0); $pdf->SetFillColor(202, 202, 202); $pdf->SetTextColor(0, 0, 0);
	...
	*/
		...
		$pdf->SetFillColor(255, 255, 255);
	//	$pdf->SetXY(10, 227);
		$pdf->Rect(10, 227, 48.75, 25, "D"); 
		$pdf->Rect(58.75, 227, 48.75, 25, "D");
		$pdf->Rect(107.5, 227, 48.75, 25, "D");
		$pdf->Rect(156.25, 227, 48.75, 25, "D");
		$pdf->SetFont('Arial', 'B', 8);
		
		///$pdf-GetY();
		$ancho = 79.33;
		$pdf->Cell($ancho , 5, 'EMITIDO POR', 1, 0, 'L');
		$pdf->Cell($ancho , 5, 'REVISADO POR', 1, 0, 'L');
		$pdf->Cell($ancho , 5, 'CONFORMADO POR', 1, 0, 'L');
	   
	   	$pdf->Ln();
	   	$pdf->SetFont('Arial', 'B', 7);
	    $pdf->Cell($ancho , 5, utf8_decode('NOMBRE COMPLETO IIIIIIIII'), 1, 0, 'L');
		$pdf->Cell($ancho , 5, utf8_decode('NOMBRE COMPLETO IIIIIIIII'), 1, 0, 'L');
		$pdf->Cell($ancho , 5, utf8_decode('NOMBRE COMPLETO IIIIIIIII'), 1, 0, 'L');
		
		$pdf->Ln();
	    $pdf->Cell($ancho , 5, utf8_decode('CARGO DE CONTRALORIA'), 1, 0, 'L');
		$pdf->Cell($ancho , 5, utf8_decode('CARGO DE CONTRALORIA'), 1, 0, 'L');
		$pdf->Cell($ancho , 5, utf8_decode('CARGO DE CONTRALORIA'), 1, 0, 'L');
		...
		##
		/*$pdf->SetFont('Arial', 'B', 7);
		$pdf->SetXY(10, 233); $pdf->MultiCell(48.75, 3, utf8_decode('CECILIO'), 0, 'L');
		$pdf->SetXY(58.75, 233); $pdf->MultiCell(48.75, 3, utf8_decode('CECILIO'), 0, 'L');
		$pdf->SetXY(107.5, 233); $pdf->MultiCell(48.75, 3, utf8_decode('CECILIO'), 0, 'L');
		$pdf->SetXY(156.25, 233); $pdf->MultiCell(48.75, 3, utf8_decode('CECILIO'), 0, 'L');
		##
		$pdf->SetXY(10, 240); $pdf->MultiCell(48.75, 3, utf8_decode('CECILIO'), 0, 'C');
		$pdf->SetXY(58.75, 240); $pdf->MultiCell(48.75, 3,utf8_decode('CECILIO'), 0, 'C');
		$pdf->SetXY(107.5, 240); $pdf->MultiCell(48.75, 3, utf8_decode('CECILIO'), 0, 'C');
		$pdf->SetXY(156.25, 240); $pdf->MultiCell(48.75, 3, utf8_decode('CECILIO'), 0, 'C');*/
$pdf->Output();
?>  
