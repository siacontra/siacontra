...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Lista de Actuaciones Fiscales (Detalle)</td>
		<td align="right"><a class="cerrar" href="framemain.php">[cerrar]</a></td>
	</tr>
</table><hr width="100%" color="#333333" /><br />

<form name="frmentrada" id="frmentrada" action="gehen.php?anz=pf_actuacion_fiscal_detalle_lista" method="post">
...
<table width="1050" class="tblBotones">
	<tr>
		...
		<td align="right">
			<input type="button" id="btVer" value="Ver" style="width:75px; <?=$btVer?>" onclick="cargarOpcion2(this.form, 'gehen.php?anz=pf_actuacion_fiscal_form&opcion=ver&origen=ejecucion', 'BLANK', 'height=650, width=900, left=100, top=0, resizable=no', 'registro');" />
		</td>
	</tr>
</table>
