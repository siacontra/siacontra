...
<form name="frmentrada" id="frmentrada" action="gehen.php?anz=pf_actuacion_fiscal_actividades" method="POST" onsubmit="return actuacion_fiscal_actividades_terminar(this);">
...
<table width="800" class="tblForm">
	<tr>
		...
		<td>
        	...
        	<input type="text" id="CodActuacion" value="<?=$field['CodActuacion']?>" style="width:110px;" class="codigo" disabled="disabled" /> - 
