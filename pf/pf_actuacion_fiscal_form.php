...
<table width="800" class="tblBotones">
	<tr>
		<td align="right" class="gallery clearfix">
			...
			<input type="button" class="btLista" value="Borrar" onclick="quitarLinea(this, 'actividades'); setFechaActividades();"   />
		</td>
	</tr>
</table>
<center>
	...
	if ($opcion != "nuevo") {
		...
		while ($field_actividades = mysql_fetch_array($query_actividades)) {
			...
			/*if ($field_actividades['Estado'] == "EJ")
				...
				$tiempo = $field_actividades['ProrrogaAcu'] + $field_actividades['Duracion'];
			...
			<tr class="trListaBody" onclick="mClk(this, 'sel_actividades');" id="<?=$field_actividades['CodActividad']?>">
                ...
                <td align="center">
                    ...
                    <input type="hidden" name="Prorroga" value="<?=$field_actividades['ProrrogaAcu']?>" />
                </td>
                <td align="center">
                    <?=$FechaInicioReal?>
