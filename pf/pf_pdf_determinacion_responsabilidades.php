...
if ($codigo != "") $filtro = "WHERE af.CodDeterminacion = '".$codigo."'";
...
class PDF extends FPDF {
	...
	function Header() {
		...
		$this->SetXY(25, 15); $this->MultiCell(150, 4, $field_mast['Dependencia'], 0, 'L');
		//------
		...
		$this->SetXY(10, 30);
		$this->Cell(195, 10, utf8_decode('DETERMINACION DE RESPONSABILIDADES ('.$field_mast['CodDeterminacion'].')'), 0, 1, 'C');
		$this->Ln(5);
		//------
...
$sql = "SELECT
		...
		WHERE afd.CodDeterminacion = '".$field_mast['CodDeterminacion']."' 
