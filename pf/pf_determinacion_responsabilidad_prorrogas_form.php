...
<form name="frmentrada" id="frmentrada" action="gehen.php?anz=<?=$action?>" method="POST" onsubmit="return determinacion_responsabilidad_prorrogas(this, '<?=$accion?>');">
...
<table width="800" class="tblForm">
	...
	<tr>
		...
		<td class="gallery clearfix">
        	<input type="text" id="CodDeterminacion" value="<?=$field_mast['CodDeterminacion']?>" style="width:110px;" disabled="disabled" />
            <a href="../lib/listas/listado_determinacion_responsabilidad.php?filtrar=default&cod=&nom=&ventana=prorrogas&iframe=true&width=1100&height=525" rel="prettyPhoto[iframe1]" style=" <?=$display_modificar?>">
...
<table width="1075" class="tblLista">
	...
	if ($opcion != "nuevo") {
		$sql = "SELECT
				...
				WHERE vjd.CodDeterminacion = '".$field_mast['CodDeterminacion']."'
