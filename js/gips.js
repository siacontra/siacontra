(function ($) {
    $.fn.extend({
        gips: function (options) {
            var settings = $.extend({ delay: 500, autoHide: false, pause: 5000, animationSpeed: 500, placement: 'top', theme: 'purple', imagePath: 'images/close.png', text: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et.',idGlobo:'idDefecto' }, options);
            return this.each(function () {
                ...
                var toolTipContainer = $('<div  id="'+settings.idGlobo+'0"  class="gips-container"><div id="'+settings.idGlobo+'1"  class="gips-body ' + settings.theme + '">' + settings.text + '' +
                                        '' + closebtn + '</div><div id="'+settings.idGlobo+'2"  class="gips-icon gips-icon-' + iconDirection + ' ' + settings.theme + '"></div></div>');
