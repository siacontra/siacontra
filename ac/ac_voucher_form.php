...
elseif ($opcion == "modificar" || $opcion == "ver" || $opcion == "anular" || $opcion == "aprobar") {
	...
	//	valores
	$MotivoAnulacion=$field_mast['MotivoAnulacion'];
...
<table width="960" class="tblForm">
    ...
    <? if ($MotivoAnulacion != "") {?><tr>
    <td class="tagForm">Raz&oacute;n Anulaci&oacute;n:</td>
    <td colspan="3">
<input type="text" name="Motivo" value="<? echo $MotivoAnulacion; ?>" style="width:95%;" disabled />
</td></tr>
...
<? } ?>
  ...
  <? if ($opcion == "anular") {?>  <tr>
		...
		<td class="tagForm">Raz&oacute;n Anulaci&oacute;n:</td>
		<td colspan="3"><input type="text"  id="motivo" name="motivo" value="<?=($field_mast['MotivoAnulacion'])?>" style="width:95%;" <?=$disabled_anulacion?> /></td>
	</tr> <? } ?>
</table>
...
<table width="960" class="tblBotones">
	<tr>
    	<td> 
			<input type="button" class="btLista" id="btCuenta" value="Sel. Cuenta" onclick="abrirListado('detalle', 'codcuenta', 'nomcuenta', 'listado_cuentas_contables', 'height=800, width=850, left=50, top=50');" <?=$disabled_ver?> />
			...
			<input type="button" class="btLista" id="btPersona" value="Sel. Persona" onclick="abrirListado('detalle', 'codpersona', 'nompersona', 'listado_personas', 'height=800, width=750, left=50, top=50');" <?=$disabled_ver?> />
        </td>
		<td align="right">
