...
//// ------------------------------------------------------------------------------
echo "
<form name='frmentrada' id='frmentrada' method='POST' action='rp_balancecomprobacionpdf.php'  target='reporte'>
...
<tr>
 ...
 <td align='right'>Periodo:</td>
  <td align='left'>
    ...
    <input type='text' name='fPeriodo' id='fPeriodo' size='8' maxlength='7' $dPeriodo value='$fPeriodo'/></td>
</tr>
...
<center><input type='submit' name='btBuscar' value='Buscar' onclick='filtroReporteLibroDeComprobacion(this.form, 0);'></center>
