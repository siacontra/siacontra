...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Maestro de Cooperativas | Actualizaci&oacute;n</td>
...
<form id="frmentrada" name="frmentrada" action="cooperativas.php" method="POST" onsubmit="return verificarCooperativa(this, 'ACTUALIZAR');">

<?php
include("fphp.php");
connect();
$sql="SELECT * FROM rh_cooperativa WHERE CodCooperativa='".$_POST['registro']."'";
...
if ($rows!=0) {
	...
	<table width='700' class='tblForm'>
	  <tr>
	    ...
	    <td><input name='codigo' type='text' id='codigo' size='3' maxlength='3' value='".$field['CodCooperativa']."' readonly /></td>
	  </tr>
	  <tr>
	    <td class='tagForm'>Descripci&oacute;n:</td>
	    <td><input name='descripcion' type='text' id='descripcion' size='75' maxlength='100' value='".$field['NombreCoop']."' />*</td>
	  </tr>
	  <tr>
	    <td class='tagForm'>Objeto:</td>
	    <td><input name='objeto' type='text' id='objeto' size='75' maxlength='255' value='".$field['ObjetoCoop']."' /></td>
	  </tr>
	  <tr>
