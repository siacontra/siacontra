...
function abrirConstancia(form, pag, param) {
	...
	window.open("pdf_constancia_sb.php?registros="+registros, "", "toolbar=no, menubar=no, location=no, scrollbars=yes, height=800, width=800, left=200, top=200, resizable=yes");
	window.open("pdf_constancia_sinsueldo.php?registros="+registros, "", "toolbar=no, menubar=no, location=no, scrollbars=yes, height=800, width=800, left=200, top=200, resizable=yes");
