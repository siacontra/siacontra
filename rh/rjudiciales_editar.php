...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Retenciones Judiciales | Modificar Registro</td>
...
<form name="frmentrada" id="frmentrada" action="rjudiciales.php" method="POST" onsubmit="return verificarRetencionJudicial(this, 'ACTUALIZAR');">
...
<table width="700" class="tblForm">
	...
	<tr>
		...
		<td><input name="fresolucion" type="text" id="fresolucion" size="15" maxlength="10" value="<?=formatFechaDMA($field['FechaResolucion'])?>" />*</td>
	</tr>
	<tr>
		<td class="tagForm">Expediente:</td>
		<td><input name="expediente" type="text" id="expediente" size="30" maxlength="30" value="<?=($field['Expediente'])?>" />*</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input name="juzgado" type="text" id="juzgado" size="100" maxlength="255" value="<?=($field['Juzgado'])?>" />*</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><textarea name="comentarios" id="comentarios" style="width:90%; height:50px;"><?=($field['Observaciones'])?></textarea></td>
	</tr>
	<tr>
		<td class="tagForm">Estado:</td>
		<td>
        	<? if ($field['Estado'] == "A") $flagactivo = "checked"; else $flaginactivo = "checked"; ?>
			<input type="radio" name="estado" id="activo" <?=$flagactivo?> /> Activo &nbsp;
			<input type="radio" name="estado" id="inactivo" <?=$flaginactivo?> /> Inactivo
		</td>
	</tr>
</table>
<center> 
...
<table width="100%" class="tblLista">
	...
	while ($field_det = mysql_fetch_array($query_det)) {
		...
		?>
        <tr class="trListaBody" onclick="mClk(this, 'seldetalle');" id="<?=$field_det['CodConcepto']?>">
            <td align="center">
