...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Maestro Intituciones</td>
		<td align="right"><a class="cerrar" href="framemain.php">[Cerrar]</a></td>
	</tr>
</table><hr width="100%" color="#333333" />

<form name="frmentrada" action="hcm_instituciones.php" method="POST">
<table width="800" class="tblBotones">
  <tr>
    ...
    <td align="right">
			<input name="btNuevo" type="button" class="btLista" id="btNuevo" value="Nuevo" onclick="cargarPagina(this.form, 'hcm_institucion_nuevo.php');" />
			...
			<input name="btEliminar" type="button" class="btLista" id="btEliminar" value="Eliminar" onclick="controlador(this.form, 'hcm_instituciones.php?accion=ELIMINAR', '1', 'ASIGNACIONESPECIFICO', 'lib/InstitucionesControlador.php');"  disabled="disabled" />
...
<table width="800" class="tblLista">
  <tr class="trListaHead">
    ...
    <th width="418" scope="col" align="left">Nombre Institucion HCM</th>
    <th width="204" scope="col" align="left">Telefonos</th>
	...
	else  $sql="SELECT * FROM rh_institucionhcm ORDER BY idInstHcm";
	$query=mysql_query($sql) or die ($sql.mysql_error());
	...
	while ($field=mysql_fetch_array($query))
	{
	 	...
	 	echo "
		<tr class='trListaBody' onclick='mClk(this, \"registro\");' onmouseover='mOvr(this);' onmouseout='mOut(this);' id='".$field['idInstHcm']."'>
			<td align='center'>".$field['idInstHcm']."</td>
	    <td>".$field['descripcioninsthcm']."</td>
		<td> ".$field['telefonos']." </td>
		<td align='right'></td>
		</tr>";
	}
	echo "
