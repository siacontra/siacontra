...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td align="right"><a class="cerrar" href="javascript:" onclick="cargarPagina(document.getElementById('frmentrada'), 'permisos.php?limit=<?=$_POST['limit']?>&filtro=<?=$_POST["filtro"]?>');">[cerrar]</a></td>
	</tr>
...
<table width="700" class="tblForm">
  ...
  <tr>
    ...
    <td>
		<input name="fdesde" type="text" id="fdesde" size="15" maxlength="10" value="<?=$fdesde?>" <?=$disabled?> onchange="getTotalDiasPermisos();" /> - 
		<input name="fhasta" type="text" id="fhasta" size="15" maxlength="10" value="<?=$fhasta?>" <?=$disabled?> onchange="getTotalDiasPermisos();" /> * 
  ...
  <tr>
    ...
    <td>
		<input name="hdesde" type="text" id="hdesde" size="3" maxlength="5" value="<?=$hdesde?>" <?=$disabled?> onchange="getTotalDiasPermisos();" />
		<select name="turnodesde" id="turnodesde" <?=$disabled?> onchange="getTotalDiasPermisos();">
			<?php getMeridian($merdesde, 0); ?>
		</select> - 
		<input name="hhasta" type="text" id="hhasta" size="3" maxlength="5" value="<?=$hhasta?>" <?=$disabled?> onchange="getTotalDiasPermisos();" />
...
<input name="bt_cancelar" type="button" id="bt_cancelar" value="Cancelar" onClick="cargarPagina(this.form, 'permisos.php?limit=<?=$_POST["limit"]?>&filtro=<?=$_POST["filtro"]?>');" />
</center><br />
<?php
//	FILTRO..............
echo "
