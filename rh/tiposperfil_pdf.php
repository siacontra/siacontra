...
function Cabecera($pdf) {
	...
	$pdf->Cell(190, 10, 'Tipos de Perfil de Nómina', 0, 1, 'C');	
...
Cabecera($pdf);
//	Cuerpo
$query=mysql_query("SELECT CodPerfil, Perfil, Estado FROM tipoperfilnom ORDER BY CodPerfil") or die ($sql.mysql_error());
