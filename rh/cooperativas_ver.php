...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Maestro de Cooperativas | Ver Registro</td>
...
include("fphp.php");
connect();
$sql="SELECT * FROM rh_cooperativa WHERE CodCooperativa='".$_GET['registro']."'";
...
if ($rows!=0) {
	...
	<table width='700' class='tblForm'>
	  ...
	  <tr>
	    ...
	    <td><input name='descripcion' type='text' id='descripcion' size='75' maxlength='100' value='".$field['NombreCoop']."' readonly /></td>
	  </tr>
	  <tr>
	    <td class='tagForm'>Objeto:</td>
	    <td><input name='objeto' type='text' id='objeto' size='75' maxlength='255' value='".$field['ObjetoCoop']."' readonly /></td>
	  </tr>
	  <tr>
