...
<table width="550" class="tblForm">
	...
	<tr>
		...
		<td><input name="descripcion" type="text" id="descripcion" style="width:90%;" maxlength="50" value="<?=($field['Descripcion'])?>" disabled="disabled" /></td>
	</tr>
	<tr>
...
<table width="550" class="tblLista">
	...
	while ($field_subgrupo = mysql_fetch_array($query_subgrupo)) {
		...
		<tr class="trListaBody">
			...
			<td><?=($field_subgrupo['Descripcion'])?></td>
