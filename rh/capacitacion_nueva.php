...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Capacitaci&oacute;n | Nuevo Registro</td>
...
<form id="frmentrada" name="frmentrada" action="<?=$regresar?>.php" method="POST" onsubmit="return verificarCapacitacion(this, 'GUARDAR');">
...
<table width="900" align="center">
  <tr>
		<td>
			...
			<ul>
			<!-- CSS Tabs -->
			<? if($tab1){?><li><a onclick="document.getElementById('tab1').style.display='block'; document.getElementById('tab2').style.display='none';" href="#">Capacitaci&oacute;n</a></li><? }?>
			<? if($tab2){?><li><a onclick="document.getElementById('tab1').style.display='none'; document.getElementById('tab2').style.display='block';" href="#">Fundamentaci&oacute;n</a></li><? }?>
			<? if($tab3){?><li><a onclick="javascript:alert('&iexcl;DEBE GUARDAR PRIMERO LA CAPACITACI&Oacute;N!');" href="#">Participantes</a></li><? }?>
...
<table width="900" class="tblForm">
	<tr>
		...
		<td><input name="codigo" type="text" id="codigo" size="10" readonly /></td>
	</tr>	
	<tr>
	...
	<tr>
		...
		<td colspan="3">
			<input name="codcentro" type="hidden" id="codcentro" value="<?=$field['CodCentro']?>" />
	...
	<tr>
	    ...
	    <td><input name="tel" type="text" id="tel" size="15" maxlength="15" value="<?=$field['Telefono']?>" /></td>
	...
	<tr>
	    ...
	    <td><input name="costo" type="text" id="costo" size="30" dir="rtl" value="<?=$field['CostoEstimado']?>" /><em>(999999,99)</em></td>
		<td class="tagForm">Monto Asumido:</td>
	    <td><input name="asumido" type="text" id="asumido" size="30" dir="rtl" value="<?=$field['MontoMaxAsumido']?>" /><em>(999999,99)</em></td>
	</tr>
	<tr>
		<td class="tagForm">Monto Utilizado:</td>
	    <td><input name="utilizado" type="text" id="utilizado" size="30" dir="rtl" value="<?=$field['MontoAsumido']?>" /><em>(999999,99)</em></td>
...
<table width="900" class="tblForm">
	...
	<tr><td><textarea name="funda1" id="funda1" cols="200" rows="3"><?=$field['Funadamentacion1']?></textarea></td></tr>
	...
	<tr><td><textarea name="funda2" id="funda2" cols="200" rows="3"><?=$field['Funadamentacion2']?></textarea></td></tr>
	<tr><td>3. Dias y horario mas factibles para el dictado:</td></tr>
	<tr><td><textarea name="funda3" id="funda3" cols="200" rows="3"><?=$field['Funadamentacion3']?></textarea></td></tr>
	<tr><td>4. &iquest;Qu&eacute; se espera desp&uacute;es de la capacitaci&oacute;n?:</td></tr>
	<tr><td><textarea name="funda4" id="funda4" cols="200" rows="3"><?=$field['Funadamentacion4']?></textarea></td></tr>
	<tr><td>5. &iquest;C&oacute;mo hace hoy su trabajo?:</td></tr>
	<tr><td><textarea name="funda5" id="funda5" cols="200" rows="3"><?=$field['Funadamentacion5']?></textarea></td></tr>
	<tr><td>6. &iquest;Hay colaboradores dentro de la empresa que puedan dictar este curso?:</td></tr>
	<tr><td><textarea name="funda6" id="funda6" cols="200" rows="3"><?=$field['Funadamentacion6']?></textarea></td></tr>
	</tr>
</table>
</div>
