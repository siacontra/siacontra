...
<script type="text/javascript" language="javascript">
	...
	//alert('trabajando para ustedes');
	//document.getElementById('btRevisar').style='display:blok';
	//document.getElementById('btRevisar').readOnly=true;
	//document.getElementById('btAprobar').disabled=false;
