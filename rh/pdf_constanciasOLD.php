...
foreach ($trabajadores as $persona) {
	...
	while ($field = mysql_fetch_array($query)) {
		...
		$pdf->SetFont('Arial', 'B', 12);
		$pdf->SetXY(25, 205); $pdf->Cell(170, 10, utf8_decode($pie1), 0, 1, 'C');
		
		
		$pdf->SetFont('Arial', '',12);
		$pdf->SetXY(25, 210); $pdf->Cell(170, 10, utf8_decode($pie2), 0, 1, 'C');
		$pdf->SetXY(25, 215); $pdf->Cell(170, 10, utf8_decode($pie3), 0, 1, 'C');
		$pdf->SetXY(25, 219); $pdf->Cell(170, 10, utf8_decode($pie4), 0, 1, 'C');
		$pdf->SetXY(25, 232); $pdf->Cell(170, 10, utf8_decode($pie5), 0, 1, 'C');
