...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Maestro de Sindicatos | Ver Registro</td>
...
include("fphp.php");
connect();
$sql="SELECT * FROM rh_sindicatos WHERE CodSindicato='".$_GET['registro']."'";
...
if ($rows!=0) {
	...
	<table width='700' class='tblForm'>
	  ...
	  <tr>
	    ...
	    <td><input name='descripcion' type='text' id='descripcion' size='60' maxlength='30' value='".$field['Nombre']."' readonly /></td>
	  </tr>
	  <tr>
	    <td class='tagForm'>Descripci&oacute;n:</td>
	    <td><input name='descripcion2' type='text' id='descripcion2' size='75' maxlength='255' value='".$field['Descripcion']."' readonly /></td>
	  </tr>
		<tr>
