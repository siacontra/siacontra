...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td align="right"><a class="cerrar" href="javascript:" onclick="cargarPagina(document.getElementById('frmentrada'), 'jubilacion_proceso_listado.php?limit=0');">[cerrar]</a></td>
	</tr>
</table><hr width="100%" color="#333333" />

<form id="frmentrada" name="frmentrada" action="jubilacion_proceso_listado.php" method="POST" onsubmit="return verificarProcesoJubilacion(this, '<?=$accion?>');">
...
<input name="bt_cancelar" type="button" id="bt_cancelar" value="Cancelar" onclick="cargarPagina(document.getElementById('frmentrada'), 'jubilacion_proceso_listado.php?limit=0');" />
</center>
