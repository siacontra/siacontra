...
foreach ($trabajadores as $persona) {
	...
	/*	$sueldo = number_format($field['NivelSalarial'], 2, ',', '.');
		...
		$pdf->SetFont('Arial', 'B', 12);
		$pdf->SetXY(25, 180); $pdf->Cell(170, 10, utf8_decode($pie1), 0, 1, 'C');
		
		
		$pdf->SetFont('Arial', '',12);
		$pdf->SetXY(25, 185); $pdf->Cell(170, 10, utf8_decode($pie2), 0, 1, 'C');
		$pdf->SetXY(25, 190); $pdf->Cell(170, 10, utf8_decode($pie3), 0, 1, 'C');
		$pdf->SetXY(25, 195); $pdf->Cell(170, 10, utf8_decode($pie4), 0, 1, 'C');
		$pdf->SetXY(25, 200); $pdf->Cell(170, 10, utf8_decode($pie5), 0, 1, 'C');
