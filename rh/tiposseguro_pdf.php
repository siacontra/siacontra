...
function Cabecera($pdf) {
	...
	$pdf->Cell(190, 10, 'Maestro de Tipos de Seguro', 0, 1, 'C');	
...
Cabecera($pdf);
//	Cuerpo
$query=mysql_query("SELECT CodTipSeguro, Descripcion, Estado FROM rh_tiposeguro ORDER BY CodTipSeguro") or die ($sql.mysql_error());
