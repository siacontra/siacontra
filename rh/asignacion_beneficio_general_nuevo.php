...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Maestro Asignación Global | Nuevo Registro</td>
...
<form id="frmentrada" name="frmentrada" action="asignacion_global.php" method="POST" onsubmit="return verificarAsignacionGlobal(this, 'GUARDAR');">
<?php
include("fphp.php");
connect();
...
$sql="SELECT MAX(numAyudaG) AS CANT FROM rh_ayudamedicaglobal";
...
<div style="width:900px" class="divFormCaption">Datos de la asignación global</div>
<table width="900" class="tblForm">
  <tr>
    <td class="tagForm">Código :</td>
    <td><input name="txt_codigo" type="text" id="txt_codigo" size="3" maxlength="3" readonly value="<?=$codigo?>" /></td>
  </tr>
  <tr>
    <td class="tagForm">Descripci&oacute;n:</td>
    <td><input name="txt_descripcion" type="text" id="descripcion" size="60" maxlength="30" />*</td>
  </tr>	
  <tr>
    <td class="tagForm">Limite :</td>
    <td><label for="txt_limite"></label>
      <input name="txt_limite" type="text" id="txt_limite" value="0,00"  style="text-align:right" onkeypress="return(formatoMoneda(this,'.',',',event));"/> 
      Bs.F</td>
  </tr>
  <tr>
    <td class="tagForm">&nbsp;</td>
