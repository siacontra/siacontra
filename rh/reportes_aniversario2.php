...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Reporte de Tiempo de Servicio</td>
		<td align="right"><a class="cerrar"; href="framemain.php">[Cerrar]</a></td>
	</tr>
</table><hr width="100%" color="#333333" />

<form name="frmentrada" id="frmentrada" method="post" action="pdf_aniversario2.php" target="iAniversario">
...
<table width="1000" class="tblFiltro">
	...
	<tr>
		<td width="125" align="right">Estatus:</td>
		<td colspan="3">
	...
	<tr>
		<td width="250" align="right">Mes de Cambio o Aniversario:</td>
		<td colspan="3">
...
<br /><div class="divDivision">Listado de Empleados</div><br />
