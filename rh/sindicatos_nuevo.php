...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Maestro de Sindicatos | Nuevo Registro</td>
...
<form id="frmentrada" name="frmentrada" action="sindicatos.php" method="POST" onsubmit="return verificarSindicato(this, 'GUARDAR');">
<?php 
include("fphp.php");
connect();
...
<table width="700" class="tblForm">
  ...
  <tr>
    ...
    <td><input name="descripcion2" type="text" id="descripcion2" size="75" maxlength="255" /></td>
  </tr>
	<tr>
