...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Maestro de Cursos | Nuevo Registro</td>
...
<form id="frmentrada" name="frmentrada" action="cursos.php" method="POST" onsubmit="return verificarCurso(this, 'GUARDAR');">
<?php
include("fphp.php");
connect();
  ...
  <tr>
    ...
    <td>
			<select name="area" id="area">
				<option value=""></option>
				<?php getMiscelaneos($field['AreaCurso'], "AREACURSO", 0); ?>
			</select>*
		</td>
  </tr>
  <tr>
