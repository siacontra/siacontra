...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Maestro Asignación de beneficio | Nuevo Registro</td>
...
<form id="frmentrada" name="frmentrada" action="asignacion_beneficio.php" method="POST" onsubmit="return verificarAsignacion(this, 'GUARDAR');">
<?php
include("fphp.php");
connect();
...
$sql="SELECT MAX(numAyudaE) AS CANT FROM rh_ayudamedicaespecifica";
...
<table width="900" class="tblForm">
  ...
  <tr>
    ...
    <td align="left">
	<?php 
		$sql ='SELECT * FROM rh_ayudamedicaglobal';
		$query=mysql_query($sql) or die ($sql.mysql_error());
		$rows=mysql_num_rows($query);
		//$field=mysql_fetch_array($query);
		/*
  ...
  <tr>
    ...
    <td><input name="txt_descripcion" type="text" id="txt_descripcion" size="60" maxlength="100" />*</td>
  </tr>	
  <tr>
