...
foreach ($trabajadores as $persona) {
	...
	while ($field = mysql_fetch_array($query)) {
		...
		//$pie4 = ("Emanada del Despacho de la Contralora General de la República,");
		//$pie5 = ("pPublicada en G.O.Nº 40.254 de fecha 19-09-2013");
		...
		$pdf->Ln(15);
		$pdf->SetFont('Arial', 'B', 12);
		$pdf->SetXY(25, 225); $pdf->Cell(170, 10, utf8_decode($pie1), 0, 1, 'C');
		
		
		$pdf->SetFont('Arial', '',12);
		$pdf->SetXY(25, 230); $pdf->Cell(170, 10, utf8_decode($pie2), 0, 1, 'C');
		$pdf->SetXY(25, 235); $pdf->Cell(170, 10, utf8_decode($pie3), 0, 1, 'C');
		$pdf->SetXY(25, 239); $pdf->Cell(170, 10, utf8_decode($pie4), 0, 1, 'C');
		$pdf->SetXY(25, 252); $pdf->Cell(170, 10, utf8_decode($pie5), 0, 1, 'C');
