...
$pdf->SetFont('Arial', 'B', 8);
$pdf->SetXY(120, $y+20); $pdf->MultiCell(190, 5, utf8_decode('LIC. CESAR GRANADOS'), 0, 'L');//$pdf->Cell(190, 5, utf8_decode('Nathalie Ordosgoite  ___________'), 0, 1, 'L');
$pdf->SetFont('Arial', '', 8);
$pdf->SetXY(120, $y+25); $pdf->MultiCell(190, 5, utf8_decode('DIRECTOR GENERAL'), 0, 'L');//$pdf->Cell(190, 5, utf8_decode('ASISTENTE ADMINISTRATIVO V GRADO 09 PASO D'), 0, 1, 'L');
