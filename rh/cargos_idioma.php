...
echo "
<form name='frmreporta' action='cargos_idioma.php' method='POST' onSubmit='return verificarCargoIdioma(this, \"".$registro."\");'>
...
<table width='700' class='tblBotones'>
	<tr>
		<td align='right'>
			...
			<input name='btBorrar' type='button' id='btBorrar' value='Eliminar Idioma' onClick='eliminarSubCargo(this.form, \"cargos_idioma.php?accion=ELIMINAR&registro=".$_GET['registro']."\");' />
		</td>
	</tr>
</table>";
...
if ($_GET['accion']=="ELIMINAR") {
	$sql="DELETE FROM rh_cargoidioma WHERE CodIdioma='".$_POST['det']."' AND CodCargo='".$_GET['registro']."'";
