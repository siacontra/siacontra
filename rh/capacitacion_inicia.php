...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Capacitaci&oacute;n | <?=$accion?></td>
...
<table width="900" align="center">
  <tr>
		<td>
			...
			<ul>
			<!-- CSS Tabs -->
			<? if($tab1){?><li><a onclick="document.getElementById('tab1').style.display='block'; document.getElementById('tab2').style.display='none'; document.getElementById('tab3').style.display='none'; document.getElementById('tab4').style.display='none'; document.getElementById('tab5').style.display='none';" href="#">Capacitaci&oacute;n</a></li><? }?>
			<? if($tab2){?><li><a onclick="document.getElementById('tab1').style.display='none'; document.getElementById('tab2').style.display='block'; document.getElementById('tab3').style.display='none'; document.getElementById('tab4').style.display='none'; document.getElementById('tab5').style.display='none';" href="#">Fundamentaci&oacute;n</a></li><? }?>
			<? if($tab3){?><li><a onclick="document.getElementById('tab1').style.display='none'; document.getElementById('tab2').style.display='none'; document.getElementById('tab3').style.display='block'; document.getElementById('tab4').style.display='none'; document.getElementById('tab5').style.display='none';" href="#">Participantes</a></li><? }?>
			<? if($tab4){?><li><a onclick="document.getElementById('tab1').style.display='none'; document.getElementById('tab2').style.display='none'; document.getElementById('tab3').style.display='none'; document.getElementById('tab4').style.display='block'; document.getElementById('tab5').style.display='none';" href="#">Horario</a></li><? }?>
			<? if($tab5){?><li><a onclick="document.getElementById('tab1').style.display='none'; document.getElementById('tab2').style.display='none'; document.getElementById('tab3').style.display='none'; document.getElementById('tab4').style.display='none'; document.getElementById('tab5').style.display='block';" href="#">Gastos</a></li><? }?>
...
<center>
<? if ($accion=="Iniciar"){ ?> <input type="submit" value="Iniciar Capacitaci&oacute;n" /> <? }?>
<? if ($accion=="Terminar"){ ?> <input type="submit" value="Terminar Capacitaci&oacute;n" /> <? }?>
