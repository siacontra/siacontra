...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Antecedentes de Servicio</td>
...
if ($filtrar=="DEFAULT") {
	...
	$filtro="AND (me.CodOrganismo=*".$_SESSION["FILTRO_ORGANISMO_ACTUAL"]."* AND me.CodDependencia=*".$_SESSION["FILTRO_DEPENDENCIA_ACTUAL"]."*)";
}
...
//
echo "
<form name='frmentrada' action='antecedenes_listado.php?filtro=".$filtro."' method='POST' onsubmit='return false'>
...
<center><input type='button' name='btBuscar' value='Buscar' onclick='filtroEmpleadosAntecedentes(this.form, ".$limit.");'></center>
		...
		<td valign="top">
			<table width="1000" class="tblBotones">
			  <tr>
			    ...
			    <td align="right">
						<input name="btAgregar" type="button" id="btAgregar" value="Listado de Antecedentes" onclick="cargarOpcion(this.form, 'antecedentes_empleado.php', 'SELF');" />
					</td>
			  </tr>
			</table>
			...
			<table width="1000" class="tblLista">
				...
				<script type='text/javascript' language='javascript'>
					totalRegistrosAgregar($registros, \"$_ADMIN\", \"$_INSERT\", \"$_UPDATE\", \"$_DELETE\");
