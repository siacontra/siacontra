			...
			var menuItems = [
				["Gesti&oacute;n", , , , , , "0", , , , , ],
					...
					["|Vacaciones", , , , , , , , , , , ],
						...
						["||Revisar Solicitud", "<?=$_PARAMETRO["PATHSIA"]?>rh/gehen.php?anz=rh_vacaciones_lista&lista=revisar&filtrar=default&concepto=01-0029&_APLICACION="+_A, , , , d['01-0029'], , , , , , ],
						["||Conformar Solicitud", "<?=$_PARAMETRO["PATHSIA"]?>rh/gehen.php?anz=rh_vacaciones_lista&lista=conformar&filtrar=default&concepto=01-0028&_APLICACION="+_A, , , , d['01-0028'], , , , , , ],
					...
					["|Jubilaciones y Pensiones", , , , , , , , , , , ],
						["||Listado de Antecedentes", "<?=$_PARAMETRO["PATHSIA"]?>rh/antecedentes_listado.php?limit=0&filtrar=DEFAULT&concepto=01-0021&_APLICACION="+_A, , , , d['01-0021'], , , , , , ],
						["||Procesar Jubilaciones", "<?=$_PARAMETRO["PATHSIA"]?>rh/jubilacion_proceso_listado.php?limit=0&filtrar=DEFAULT&concepto=01-0022&_APLICACION="+_A, , , , d['01-0022'], , , , , , ],
						["||Aprobar Jubilaciones", "<?=$_PARAMETRO["PATHSIA"]?>rh/jubilacion_aprobar_listado.php?limit=0&filtrar=DEFAULT&concepto=01-0023&_APLICACION="+_A, , , , d['01-0023'], , , , , , ],
				...
				["Procesos", , , , , , "0", , , , , ],
					...
					["|HCM", , , , , , , , , , , ],
						["||Crear Solicitud", "<?=$_PARAMETRO["PATHSIA"]?>rh/beneficioCrear.php?concepto=05-0014", , , , d['05-0014'], , , , , , ],
						["||Listar Solicitud", "<?=$_PARAMETRO["PATHSIA"]?>rh/beneficioListar.php?concepto=05-0015", , , , d['05-0015'], , , , , , ],
						["||Revisar Solicitud", "<?=$_PARAMETRO["PATHSIA"]?>rh/beneficioRevisar.php?concepto=05-0016", , , , d['05-0016'], , , , , , ],
						["||Aprobar Solicitud", "<?=$_PARAMETRO["PATHSIA"]?>rh/beneficioAprobar.php?concepto=05-0017", , , , d['05-0017'], , , , , , ],
					
					    ["||Planilla de Solicitud", "<?=$_PARAMETRO["PATHSIA"]?>rh/hcm_planilla.php?concepto=05-0015", , , , d['05-00015'], , , , , , ],
					
					["|Útiles", , , , , , , , , , , ],
						["||Crear beneficio Útiles", "<?=$_PARAMETRO["PATHSIA"]?>rh/beneficiosUtiles.php?concepto=05-0018", , , , d['05-0018'], , , , , , ],
						["||Listar beneficio Útiles", "<?=$_PARAMETRO["PATHSIA"]?>rh/listarBeneficiosUtiles.php?concepto=05-0019", , , , d['05-0019'], , , , , , ],
				...
				["Reportes", , , , , , "0", , , , , ],
					["|Empleados", , , , , , , , , , , ],
						...
						["||(Prueba) Tiempo de Servicio", "<?=$_PARAMETRO["PATHSIA"]?>rh/reportes_aniversario2.php?concepto=02-0003&_APLICACION="+_A, , , , d['02-0003'], , , , , , ],
...
["||Disponibilidad presupuestaria partidas 401, 407", "<?=$_PARAMETRO["PATHSIA"]?>rh/rh_disponibilidad.php?concepto=02-0015&_APLICACION="+_A, , , , d['02-0015'], , , , , , ],
				  ...
				  ["|Permisos", , , , , , , , , , , ],
					["||Reposos Médicos", "<?=$_PARAMETRO["PATHSIA"]?>rh/reportes_eventos_reposo.php?filtrar=DEFAULT&concepto=02-0006&_APLICACION="+_A, , , , d['02-0006'], , , , , , ],
				...
				["Admin.", , , , , , "0", , , , , ],
					["|Seguridad", , , , , , , , , , , ],
						...
						["||Cambio de Clave","<?=$_PARAMETRO["PATHSIA"]?>comunes/gehen.php?anz=usuarios_cambio_clave&opcion=modificar&filtrar=default&concepto=04-0001", , , , d['01-0016'], , , , , , ],
