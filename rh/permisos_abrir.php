...
function Cabecera($pdf) {
	...
	$pdf->Image('../imagenes/logos/contraloria.jpg', 15, 12, 30, 30);
	...
	$pdf->SetXY(186, 30); $pdf->SetFont('Arial', 'B', 9); $pdf->Cell(18, 5, date('d/m/Y'), 0, 1, 'C');
...
$pdf->SetXY(51, $y); $pdf->SetFont('Arial', 'B', 9); $pdf->Cell(153, 5, 'NOMBRES Y APELLIDOS:', 0, 1, 'L');
...
$y=157;
$pdf->Rect(10, $y, 100, $h1); $pdf->Rect(110, $y, 95, $h1);
$pdf->SetXY(11, $y); $pdf->SetFont('Arial', 'B', 9); $pdf->Cell(98, 5, 'NOMBRES Y APELLIDOS:', 0, 1, 'L');
