...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Maestro de Idiomas | Nuevo Registro</td>
...
<form id="frmentrada" name="frmentrada" action="idiomas.php" method="POST" onsubmit="return verificarIdioma(this, 'GUARDAR');">
...
<table width="700" class="tblForm">
  ...
  <tr>
    ...
    <td><input name="descripcionl" type="text" id="descripcionl" size="40" maxlength="25" />*</td>
  </tr>
  <tr>
    <td class="tagForm">Descripci&oacute;n Extranjera:</td>
    <td><input name="descripcione" type="text" id="descripcione" size="40" maxlength="25" /></td>
  </tr>
  <tr>
