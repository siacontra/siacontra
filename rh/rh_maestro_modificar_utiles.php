<?php
	...
	$sql = "SELECT * 
				FROM rh_utilesayuda where codutilesayuda=".$_GET['codigoMaestroUtiles'];
...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Maestro Modificar Ayuda Útiles </td>
		...
		<td width="1057" height="119" colspan="2" valign="top" class="tagForm"><table width="798" border="0" align="center" cellpadding="0" cellspacing="1">
                      ...
                      <tr>
                        ...
                        <td colspan="2" align="left" valign="middle"><label>
                          <input name="numBeneficio" type="text" id="numBeneficio" disabled="disabled" onkeyup="soloNumero(this.id)" value="<?=$resp['numutilesayuda'];?>" size="5" maxlength="2" />
                        </label></td>
                        <td width="120">&nbsp;</td>
                        <td width="53"><input  type="hidden" id="codUtilesAyuda" value="<?=$_GET['codigoMaestroUtiles'];?>" /></td>
                        <td width="58">&nbsp;</td>
                      </tr>
                      <tr>
                        <td height="28"  align="right"><div align="right">Descripci&oacute;n:</div></td>
                        <td width="300" align="left" valign="middle"><label>
                          <input name="descripcionUtiles" type="text" id="descripcionUtiles" onkeyup="validarCadenaCampo(this.id,2,'.,-/:;')" value="<?=$resp['descripcionutiles'];?>" size="50" maxlength="99" />
                        </label></td>
                      ...
                      <tr>
                        ...
                        <td colspan="2" align="left" valign="middle"><label>
							  <input name="periodoUtiles" type="text" id="periodoUtiles" onkeyup="validarCadenaCampo(this.id,4,'-')" value="<?=$resp['periodoutiles'];?>" size="10" maxlength="7" />
                        </label></td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                      ...
                      <tr>
                        ...
                        <td colspan="2" align="left" valign="middle"><label>
                          ...
                          <input name="montoUtiles" type="text" id="montoUtiles" onkeypress="return(formatoMoneda(this,'.',',',event));" value="" size="10" maxlength="8" />
                        </label></td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
...
<center>
	<input type="button" onclick="modificarMaestroUtiles();" value="Guardar Registro" />
	...
	<?php
		echo "<script type='text/JavaScript' >
			...
			xGetElementById('montoUtiles').value = toCurrency(".$resp['montoasignado'].");
