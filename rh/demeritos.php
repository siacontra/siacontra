...
$sql = "SELECT
			...
			rh_meritosfaltas.FechaIni, 
			rh_meritosfaltas.FechaFin, 
			...
			(SELECT mastmiscelaneosdet.Descripcion FROM mastmiscelaneosdet WHERE mastmiscelaneosdet.CodDetalle=rh_meritosfaltas.Clasificacion AND mastmiscelaneosdet.CodMaestro='DEMERITO') AS Clasificacion 
		FROM rh_meritosfaltas 
		WHERE 
			rh_meritosfaltas.Tipo = 'D' AND 
...
$sql = "SELECT
		...
		FROM
			rh_meritosfaltas mf
			INNER JOIN mastmiscelaneosdet md ON (mf.Clasificacion = md.CodDetalle AND md.CodMaestro = 'DEMERITO')
