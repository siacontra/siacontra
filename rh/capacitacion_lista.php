...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Lista de Capacitaciones</td>
...
$MAXLIMIT=30;
if ($filtrar=="DEFAULT") {
	$filtro="(r.Estado=*P*)AND (r.CodOrganismo=*".$_SESSION["FILTRO_ORGANISMO_ACTUAL"]."*)";
	$_POST['chkstatus']="1";
	$_POST['fstatus']="P";
...
<input type='hidden' name='regresar' id='regresar' value='capacitacion_lista' />
...
<table width='1000' class='tblFiltro'>
	<tr>
		...
		<td>
			<input type='checkbox' name='chkstatus' value='1' $obj[10] onclick='enabledStatus(this.form);' />
			<select name='fstatus' id='fstatus' class='selectMed' $obj[11]>
				<option value=''></option>";
				getStatusCapacitacion($obj[12], 0);
				echo "
			</select>
		</td>
	</tr>
...
<center><input type='button' name='btBuscar' value='Buscar' onclick='filtroCapacitaciones(this.form, ".$limit.", \"capacitacion_lista.php\");'></center>
...
<table width="1000" class="tblBotones">
  <tr>
    ...
    <td align="right">
		<input name="btNuevo" type="button" class="btLista" id="btNuevo" value="Nuevo" onclick="cargarPagina(this.form, 'capacitacion_nueva.php?tab1=1&tab2=1&tab3=1&tab4=0&tab5=0&tab6=0&tab7=0');" />
		<input name="btEditar" type="button" class="btLista" id="btEditar" value="Editar" onclick="cargarOpcion(this.form, 'capacitacion_editar.php?tab1=1&tab2=1&tab3=1&tab4=0&tab5=0&tab6=0&tab7=0', 'SELF');" />
		<input name="btVer" type="button" class="btLista" id="btVer" value="Ver" onclick="cargarOpcion(this.form, 'capacitacion_ver.php?tab1=1&tab2=1&tab3=1&tab4=1&tab5=0&tab6=0&tab7=1', 'BLANK', 'height=700, width=1100, left=0, top=100, resizable=no');" />
		<input name="btPDF" type="button" class="btLista" id="btPDF" value="PDF" onclick="cargarVentana(this.form, 'capacitacion_pdf.php', 'height=800, width=800, left=200, top=200, resizable=yes');" /> |  
		<input name="btAprobar" type="button" class="btLista" id="btAprobar" value="Aprobar" disabled="disabled" />
		<input name="btIniciar" type="button" class="btLista" id="btIniciar" value="Iniciar" disabled="disabled" />
		<input name="btTerminar" type="button" class="btLista" id="btTerminar" value="Terminar" disabled="disabled" />
	</td>
  </tr>
</table>
