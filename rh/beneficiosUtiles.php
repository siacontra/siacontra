...
$anho = date('Y');
$sqlUtiles="SELECT COUNT(nroBeneficioUtiles) AS NRO FROM rh_beneficiarioutiles ";
...
<center>
<input name="btguardar" type="submit" id="btguardar" value="Guardar Registro" onclick="validarCampoBeneficio('GUARDAR')"/>
