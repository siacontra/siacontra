...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Editar Contrato</td>
...
if ($rows!=0) {
	...
	echo "
	<form name='frmentrada' action='contratos_editar.php' method='POST' onsubmit='return verificarContrato(this, \"ACTUALIZAR\");'>
	...
	<table width='700' class='tblForm'>
	    ...
	    <td>
				<input name='vcontratod' type='text' id='vcontratod' size='15' maxlength='10' value='".$vcond."' /> -
				<input name='vcontratoh' type='text' id='vcontratoh' size='15' maxlength='10' value='".$vconh."'  $dvconh />
				*<i>(dd-mm-yyyy)</i>
			</td>
	  </tr>
		<tr>
	  ...
	  <tr>
	    ...
	    <td><input name='firma' type='text' id='firma' size='15' maxlength='10' value='".$fechafirma."' $disabled /><i>(dd-mm-yyyy)</i></td>
	  </tr>
		<tr>
	    <td class='tagForm'>Comentarios:</td>
	    <td><textarea name='coment' id='coment' rows='4' cols='100'>".utf8_decode($field['Comentarios'])."</textarea></td>
	  </tr>
	  <tr>
