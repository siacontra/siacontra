...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Maestro de Cargos | Ver</td>
...
<table width='750' class='tblForm'>
	<tr>
		...
		<td>
			<select name='tipocargo' id='tipocargo' class='selectMed' onchange='getOptions_2(this.id, \"nivelcargo\"); setCargo(this.form);' disabled>
				<option value=''></option>";
	...
	<tr>
		...
		<td>
			<select name='nivelcargo' id='nivelcargo' class='selectMed' onchange='setCargo(this.form);' disabled>
				<option value=''></option>";
	...
	<tr>
		...
		<td>
			<select name='grupo' id='grupo' class='selectMed' onchange='getOptions_2(this.id, \"serie\")' disabled>
				<option value=''></option>";
	...
	<tr>
		...
		<td>
			<select name='serie' id='serie' class='selectMed' onchange='setCargo(this.form);' disabled>
				<option value=''></option>";
    ...
    <tr>
        ...
        <td><input type='text' name='codcargo' id='codcargo' size='8' maxlength='4' value = '".$field['CodDesc']."' disabled /></td>
    </tr>
	<tr>
		<td class='tagForm'>Descripci&oacute;n:</td>
		<td><input name='descripcion' type='text' id='descripcion' size='60' maxlength='100' value='".$field['DescripCargo']."' disabled />*</td>
	</tr>
    <tr>
        <td class='tagForm'>Descripci&oacute;n Gen&eacute;rica:</td>
        <td><textarea name='descripcion_generica' id='descripcion_generica' cols='100' rows='3' disabled>".($field['DescGenerica'])."</textarea>*</td>
    </tr>	
	<tr>
		<td class='tagForm'>Categor&iacute;a del Cargo:</td>
		<td>
			<select name='ttra' id='ttra' class='selectMed' onchange='getGradosCargo(this.form, this.value);' disabled>
				<option value=''></option>";
	...
	<tr>
		...
		<td>
			<select name='gcargo' id='gcargo' onchange='getSueldoCargo(this.form, this.value)' disabled>
				<option value=''></option>";
	...
	<tr>
		...
		<td>
			<select name='plantilla_competencias' id='plantilla_competencias' disabled>
				<option value=''></option>";
...
<center> 
<input name='bt_cancelar' type='button' id='bt_cancelar' value='Cancelar' onClick='window.close();' />
</center><br />";
?>
</form>
...
<table align='center' cellpadding='0' cellspacing='0'>
	<tr>
    <td valign='top'>
			<iframe class='frameTab' style='height:250px; width:744px;' src='cargos_reporta.php?accion=VER&registro=".$_POST['registro']."'></iframe>
		</td>
  </tr>
</table><br />
...
<table align='center' cellpadding='0' cellspacing='0'>
	<tr>
    <td valign='top'>
			<iframe class='frameTab' style='height:250px; width:744px;' src='cargos_relaciones.php?accion=VER&registro=".$_POST['registro']."'></iframe>
		</td>
  </tr>
</table>";
?>
...
<table align='center' cellpadding='0' cellspacing='0'>
	<tr>
    <td valign='top'>
			<iframe class='frameTab' style='height:500px; width:744px;' src='cargos_funciones.php?accion=VER&codcargo=".$_POST['registro']."'></iframe>
		</td>
  </tr>
</table>";
?>
...
<table align='center' cellpadding='0' cellspacing='0'>
	<tr>
    <td valign='top'>
			<iframe class='frameTab' style='height:175px; width:744px;' src='cargos_formacion.php?accion=VER&registro=".$_POST['registro']."'></iframe>
		</td>
  </tr>
</table><br />
...
<table align='center' cellpadding='0' cellspacing='0'>
	<tr>
    <td valign='top'>
			<iframe class='frameTab' style='height:175px; width:744px;' src='cargos_idioma.php?accion=VER&registro=".$_POST['registro']."'></iframe>
		</td>
  </tr>
</table><br />
...
<table align='center' cellpadding='0' cellspacing='0'>
	<tr>
    <td valign='top'>
			<iframe class='frameTab' style='height:175px; width:744px;' src='cargos_informatica.php?accion=VER&registro=".$_POST['registro']."'></iframe>
		</td>
  </tr>
</table>";
?>
...
<table align='center' cellpadding='0' cellspacing='0'>
	<tr>
    <td valign='top'>
			<iframe class='frameTab' style='height:500px; width:744px;' src='cargos_experiencia.php?accion=VER&registro=".$_POST['registro']."'></iframe>
		</td>
  </tr>
</table>";
?>
...
<table align='center' cellpadding='0' cellspacing='0'>
	<tr>
    <td valign='top'>
			<iframe class='frameTab' style='height:500px; width:744px;' src='cargos_riesgos.php?accion=VER&registro=".$_POST['registro']."'></iframe>
		</td>
  </tr>
</table>";
?>
...
<table align='center' cellpadding='0' cellspacing='0'>
	<tr>
    <td valign='top'>
			<iframe class='frameTab' style='height:500px; width:744px;' src='cargos_sub.php?accion=VER&registro=".$_POST['registro']."'></iframe>
		</td>
  </tr>
</table>";
?>
...
<table align='center' cellpadding='0' cellspacing='0'>
	<tr>
    <td valign='top'>
			<iframe class='frameTab' style='height:500px; width:744px;' src='cargos_cursos.php?accion=VER&registro=".$_POST['registro']."'></iframe>
		</td>
  </tr>
</table>";
?>
...
<table align='center' cellpadding='0' cellspacing='0'>
	<tr>
    <td valign='top'>
			<iframe class='frameTab' style='height:500px; width:744px;' src='cargos_metas.php?accion=VER&registro=".$_POST['registro']."'></iframe>
		</td>
  </tr>
</table>";
?>
...
<table align='center' cellpadding='0' cellspacing='0'>
	<tr>
    <td valign='top'>
			<iframe class='frameTab' style='height:500px; width:744px;' src='cargos_competencias.php?accion=VER&codcargo=".$_POST['registro']."&accion=EDITAR'></iframe>
		</td>
  </tr>
</table>";
?>
...
<table align='center' cellpadding='0' cellspacing='0'>
	<tr>
    <td valign='top'>
			<iframe class='frameTab' style='height:500px; width:744px;' src='cargos_evaluacion.php?accion=VER&codcargo=".$_POST['registro']."&accion=EDITAR'></iframe>
		</td>
  </tr>
</table>";
?>
...
<table align='center' cellpadding='0' cellspacing='0'>
	<tr>
    <td valign='top'>
			<iframe class='frameTab' style='height:250px; width:744px;' src='cargos_ambiente.php?accion=VER&codcargo=".$_POST['registro']."&accion=EDITAR'></iframe>
		</td>
  </tr>
</table><br />
...
<table align='center' cellpadding='0' cellspacing='0'>
	<tr>
    <td valign='top'>
			<iframe class='frameTab' style='height:250px; width:744px;' src='cargos_esfuerzo.php?accion=VER&codcargo=".$_POST['registro']."&accion=EDITAR'></iframe>
		</td>
  </tr>
</table>";
?>
...
<table align='center' cellpadding='0' cellspacing='0'>
	<tr>
    <td valign='top'>
			<iframe class='frameTab' style='height:500px; width:744px;' src='cargos_habilidades.php?accion=VER&codcargo=".$_POST['registro']."&accion=EDITAR'></iframe>
		</td>
  </tr>
</table>";
?>
