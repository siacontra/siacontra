...
//
echo "
<form name='frmentrada' id='frmentrada' method='post' action='pdf_eventos_control2.php'>
...
<center><input type='button' name='btBuscar' value='Buscar' onclick='filtroPDFEventosControl2(this.form, 0);'></center>
