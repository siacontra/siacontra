	...
	<tr>
    	<td class="optmenu8" width="200" valign="top">
            ...
            <a href="javascript:" onclick="cargarOpcion2(document.getElementById('frmentrada'), 'gehen.php?anz=empleados_nivelaciones_form', 'SELF', '', $('#registro').val());" onmouseover="setMsj(12);" onmouseout="setMsj(0);">
			  ...
			  <li>
            <a href="javascript:" onclick="cargarOpcion2(document.getElementById('frmentrada'), 'gehen.php?anz=empleados_historial_form', 'SELF', '', $('#registro').val());" onmouseover="setMsj(12);" onmouseout="setMsj(0);">
                Historial de cargos
            </a>
			</li>
            ...
            <table width="800" class="tblBotones">
                <tr>
                    ...
                    <td align="right">
						...
						<input name="btPDF" type="button" class="btLista" id="btPDF" value="Ver Historico"  onclick="cargarOpcion(this.form, 'empleados_historico_pdf.php?default=0', 'BLANK', 'height=800, width=800, left=200, top=200, resizable=yes');" /> 
