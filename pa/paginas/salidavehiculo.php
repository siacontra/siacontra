                   		    ...
                   		    <p><strong>Nro.</strong>
                                ...
                                <tr>
                                	...
                                	<tr>
                                     ...
                                     <tr>
                                		<td align="center" style="font-size:13px"><label><strong>Tipo de Salida:</strong></label>                                		  <br /></td>
      						 			<td style="font-size:11px">
      						 			<select name="salidalocal" class=":required">
                                        ...
                                        <td>
                                         <?
												...
												$query="select * from mastpersonas as mp,mastempleado as me WHERE mp.CodPersona = me.CodPersona 
													AND me.CodDependencia='0037' and me.Estado='A'"; 
												$resp=mysql_query($query); 
												...
												for($i=0;$i<mysql_num_rows($resp); $i++) 
													...
													$nombresapellidos=utf8_decode($fila['NomCompleto']);
  													echo '<option value="'.$fila['CodPersona'].'">'.htmlentities($nombresapellidos).'</option>'; 
													} 
												echo '</select>';  
	  											?>
                                        </td>
