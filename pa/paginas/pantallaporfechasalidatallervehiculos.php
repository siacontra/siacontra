			...
			<div id="container">
				...
				<div id="Contenido">
				  <div align="justify" >
                        ...
                        <br>
                        <center>
                        	  <bold><font size="4">Salida de Vehiculos al Taller por fecha</font></bold></center>
                            <br>
                        	<form action="proceso_generarreporfechasalidatallervehiculos.php?a=1" method="post" onSubmit="return valid(this)">
