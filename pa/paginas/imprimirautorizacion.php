				...
				<div id="container">
					...
					<div id="Contenido">
						<div align="justify" >
                        	...
                        	<table align="center">
                            <tr> <td>
                            <form action="../pdf/pdfimprimirautorizacion.php?id_salida=<? echo $_REQUEST['id_salida'];?>" method="post" onSubmit="return valid(this)" target="_blank">
