                            ...
                            <form name="form1" action="proceso_mantenimientopreventivo.php?a=1" method="post" onSubmit="return valid(this)">
                                ...
                                <tr>
                                	<td align="left" style="font-size:11px" colspan="2"><label><strong><br>
									  ...
									  echo $fila['cod_veh'];
	  								  ?>
                                      <input name="cod_veh" type="hidden" value="<? echo $fila['cod_veh'];?>">
                                  <br /></td>
                                   ...
                                   <tr>
                                	<td align="left" style="font-size:11px" colspan="2"><label><strong><br>
									  ...
									  echo $fila['placa'];
	  								  ?>
                                    <input name="placa" type="hidden" value="<? echo $fila['placa'];?>">
<br /></td>
                                    <td style="font-size:11px">&nbsp;</td>
        							</tr>
                                    <tr>
                                	...
                                	<td align="left" style="font-size:11px" colspan="2"><label><strong><br>
									  ...
									  echo $fila['ano'];
	  								  ?>
                                      <input name="ano" type="hidden" value="<? echo $fila['ano'];?>">
                                  <br /></td>
                                  ...
                                  <tr>
                                	<td align="left" style="font-size:11px" colspan="2"><label><strong><br>
                                	  ...
                                	  <?
									  echo $fila['serialmotor'];
	  								  ?>
                                      <input name="serialmotor" type="hidden" value="<? echo $fila['serialmotor'];?>">
                                  <br /></td>
                                    <td style="font-size:11px">&nbsp;</td>
       							  </tr>
                                  <tr>
                                		<td align="left" style="font-size:11px" colspan="2"><label>                                		  <strong><br>
                                		  ...
                                		  <?
									  echo $fila['serialcarro'];
	  								  ?>
                                          <input name="serialcarro" type="hidden" value="<? echo $fila['serialcarro'];?>">
                                      <br /></td>
                                        <td style="font-size:11px"><p><br />
                                        </p></td>
      						 		</tr>
                                    <tr>
                                		<td align="left" style="font-size:11px" colspan="2"><label>                                		  <strong><br>
                                		  ...
                                		  <?
									  echo $fila['nrocarroceria'];
	  								  ?>
                                          <input name="nrocarroceria" type="hidden" value="<? echo $fila['nrocarroceria'];?>">
                                      <br /></td>
                                        <td style="font-size:11px"><p><br />
                                        </p></td>
      						 		</tr>
                                    <tr>
									  ...
									  echo $fila['marca'];
	  								  ?>
                                          <input name="marca" type="hidden" value="<? echo $fila['marca'];?>">
                                      <br /></td>
                                        <td style="font-size:11px"><p><br />
                                        </p></td>
      						 		</tr>
                                     <tr>
                                		<td align="left" style="font-size:11px" colspan="2"><label>                                		  <strong>                               		    <br>
                                		  ...
                                		  <?
												include('acceso_db_siaces.php');
												$query="select * from mastdependencias where Estado='A'"; 
												...
												for($i=0;$i<mysql_num_rows($resp); $i++) 
    												...
    												$fila=mysql_fetch_array($resp); 
  													echo '<option value="'.$fila['CodDependencia'].'">'.$fila['Dependencia'].'</option>'; 
													} 
												echo '</select>';
	  								  ?>
                                     ...
                                     <tr>
                                		<td align="left" style="font-size:11px" colspan="2"><label><strong>Responsable:</strong></label>
                                		  <?
												...
												$queryp="select * from mastpersonas as mp,mastempleado as me WHERE mp.CodPersona = me.CodPersona and me.Estado='A'
													"; 
												$respp=mysql_query($queryp); 
												echo '<select name="personal" class=":required">';
												echo '<option selected value="0">Seleccione el Personal Asignado';   
												for($i=0;$i<mysql_num_rows($respp); $i++) 
													{
													$filap=mysql_fetch_array($respp); 
													$nombresapellidos=$filap['NomCompleto'];
  													echo '<option value="'.$filap['CodPersona'].'">'.$nombresapellidos.'</option>'; 
													} 
												echo '</select>';  
	  											?>
                                        </td>
