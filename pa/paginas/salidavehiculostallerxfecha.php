...
$pdf->addText(400,18,10,'Listado de Salidas de Vehiculos del Taller');
...
$queEmp = "SELECT * FROM  tallersalida WHERE fecha BETWEEN '$desde' AND '$hasta'";
...
$txttit =  " <b>Salidas de Vehiculos del Taller entre Fechas:  " .$desdes."  al " .$hastas."</b>\n";
