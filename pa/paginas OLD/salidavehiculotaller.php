...
<html>
        ...
        $(document).ready(function() {
           $("#datepicker").datepicker();
            ...
            <?
			$result = mysql_query("select MAX(id_tallersal) from tallersalida"); 
							$resultado = mysql_result ($result, 0); 
							$id_tallersal = $resultado; 
							$id_tallersal=$id_tallersal+1;
				...
				<div id="container">
					...
					<div id="Contenido">
						<div align="justify" >
                        	...
                        	<center>
                        	  <strong>
                        	  <bold><font size="4">Taller Salida de Vehiculo/Automóvil</font></bold>
                        	  </strong>
               	        </center>
                            <br>
                            <form name="form1" action="proceso_salidavehiculotaller.php?a=1" method="post" onSubmit="return valid(this)">
                   		  ...
                   		  <td align="left"width="313" style="font-size:11px"><blockquote>
                   		    <p><strong>Nro.</strong>
                   		      ...
                   		      <input name="id_tallersal" type="text" size="2" maxlength="11" disabled value="<? echo"$id_tallersal";?>">
                   		      <strong>Fecha</strong>
                   		  <input name="fecha" type="hidden" value="<? echo date('d/m/y');?>" size="4" > 
                                 ...
                                 <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="hora" onBlur="CheckTime(this)" size="5" maxlength="11" class=":required"/>
      						 			  <span style="font-size:13px">
      						 			  <label><strong>Fecha llegada:</strong></label>
                                          </span>
                                          <input type="text" name="fechaestim"size="8" id="datepicker"/>
                                          <input name="fechaestim" type="hidden" value="<? echo date('d/m/y');?>" size="4" >
                                      <br /></td>
                                    </tr>
                                     <tr>
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                		<td align="right" style="font-size:13px"><label><strong>Condiciones:</strong></label>                                		  <br /></td>
      						 			<td ><input type="text" size="42" name="condiciones" class=":required"/><br /></td>
                                    </tr>
                                    <tr>
