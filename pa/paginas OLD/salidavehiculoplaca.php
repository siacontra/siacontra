				...
				<div id="container">
					...
					<div id="Contenido">
						<div align="justify" >
                        	...
                        	<center>
                        	  <strong>
                        	  <bold><font size="4">Salida Vehiculo/Automóvil</font></bold>
                        	  </strong>
               	        </center>
                            <br>
                            <form name="form1" action="proceso_enviarsalidavehiculo.php?a=1" method="post" onSubmit="return valid(this)">
