		...
		.extend( {
			getElementType : function(a) {
				...
				case (a.nodeName.toUpperCase() == "INPUT"):
					throw new Error(
							"Vanadium::getElementType - Cannot use Vanadium on an "
									+ a.type + " input!");
				default:
					throw new Error(
							"Vanadium::getElementType - Element must be an input, select, or textarea!")
				}
			},
	...
	Vanadium
			.addValidatorTypes( [
					[
							...
							function(a, b) {
								return 'The value should be equal to <span class="'
					...
					[
							...
							function(a, b) {
								return 'The value should be <span class="'
										+ Vanadium.config.message_value_class
										+ '">' + b + "</span> characters long."
							} ],
					[
							"min_length",
							function(a, b) {
							...
							function(a, b) {
								return 'The value should be at least <span class="'
										+ Vanadium.config.message_value_class
										+ '">' + b + "</span> characters long."
							} ],
					[
							...
							function(a, b) {
								return 'The value should be at most <span class="'
										+ Vanadium.config.message_value_class
										+ '">' + b + "</span> characters long."
							} ],
					[
							...
							function(b, c) {
								var a = document.getElementById(c);
								if (a) {
									return 'The value should be the same as <span class="'
											+ Vanadium.config.message_value_class
											+ '">'
											+ (jQuery(a).attr("name") || a.id)
											+ "</span> ."
								} else {
					...
					[
							...
							function(a, b) {
								var c = b.split("/");
								if (c.length == 3 && c[0] == "") {
									return 'The value should match the <span class="'
											+ Vanadium.config.message_value_class
											+ '">'
											+ b.toString()
											+ "</span> pattern."
								} else {
									return 'provided parameter <span class="'
											+ Vanadium.config.message_value_class
											+ '">'
											+ b.toString()
											+ "</span> is not valid Regexp pattern."
								}
							} ] ]);
