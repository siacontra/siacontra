...
$pdf->addText(400,18,10,'Listado de Entradas de Vehiculos al Taller');
...
$queEmp = "SELECT * FROM tallerentrada WHERE fecha BETWEEN '".$desde."' AND '".$hasta."' order by fecha";
...
$titles = array(
				...
				'nombretaller'=>'<b>Taller</b>',
				'motivo'=>'<b>Motivo</b>',
				'seguro'=>'<b>Cobertura Seguro</b>',
				'institucion'=>'<b>OCobertura Institucion</b>',
...
$txttit =  " <b>      Entradas de Vehiculos al Taller entre Fechas: " .$desdes."  al " .$hastas."</b>\n";
