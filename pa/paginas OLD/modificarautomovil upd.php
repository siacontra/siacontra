								...
								<form action="proceso_editarautomovil.php" method="post">
                                		...
                                		<td align="right" style="font-size:13px"><strong>Año:</strong></td> 
      									<td><label> 
        										...
        										do { 
													$y=date(Y)-$i;
													$i=$i+1;
													$list=$list.'<option'.if ($ano =$y) .' selected '.;.'>'.$y.'</option>';
												/*	<option>--</option>
                                                    <option>2013</option>
                                                    <option>2012</option>
                                                    <option>2011</option>
                                    ...
                                    <tr>
                                        ...
                                        <td><select name="basico"> 
          											<option <? if ($basico ="0") ;?> selected value= "0">--</option>
                                                    <option <? if ($basico ="1") ;?> selected value= "1">Sedán</option>
                                                    <option <? if ($basico ="2") ;?> selected value= "2">Tres puertas, cinco puertas</option>
                                                    <option <? if ($basico ="3") ;?> selected value= "3">Familiar</option>
                                                    <option <? if ($basico ="4") ;?> selected value= "4">Cupé</option>
                                                    <option <? if ($basico ="5") ;?> selected value= "5">Hardtop</option>
                                                    <option <? if ($basico ="6") ;?> selected value= "6">Deportivo utilitario</option>
                                                    <option <? if ($basico ="7") ;?> selected value= "7">Todoterreno</option>
                                                    <option <? if ($basico ="8") ;?> selected value= "8">Camioneta</option>
                                                    </select>
  
											
											<input type="text" type="hidden"  name="basico" value="<? echo"$basico";?>"/></td>
      						 		</tr>
                                    <tr>
