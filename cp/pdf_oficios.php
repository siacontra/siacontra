...
foreach ($trabajadores as $persona) {
	...
	while ($field = mysql_fetch_array($query)) {
		...
		$pie2 = utf8_decode("CONTRALOR (I) DEL ESTADO MONAGAS");
		...
		$pie5 = utf8_decode("publicada en G.O.Nº 405.296 de fecha 19-09-2013");
		...
		$pie6 = utf8_decode("Hacia laTransparencia, Fortalecimiento y Consolidación  del Sistema Nacional de Control Fiscal. ");
