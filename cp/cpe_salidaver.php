...
<table class="tblForm" width="895px" border="0">
 ...
 <td><input type="text" id="fecha_recibido" name="fecha_recibido" size="10" maxlength="10" value="<?=$fecha;?>"/>*(dd-mm-aaaa)</td>
  ...
  <tr>
    ...
    <td><input type="text" id="remitente_int" name="remitente_int" size="60" value="<?=htmlentities($fa['0'])?>" disabled/></td>
    <td class="tagForm">Cargo:</td>
    <td><input type="text" id="cargoremitente_int" name="cargoremitente_int" size="60" value="<?=htmlentities($fa['1'])?>" disabled/></td>
  </tr>
  <tr>
    <td height="5"></td>
  </tr>
