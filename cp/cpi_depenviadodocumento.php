...
<tr>
  ...
  <tr>
    <td width="119" align="center"><img src="../imagenes/logos/contraloria.jpg" style="height:60px; width:80px" /></td>
    <td width="397">
...
<tr><td width="707">
  ...
  <tr>
   <td width="3"></td>
   <td width="124" align="center"><img src="../imagenes/logos/contraloria.jpg" style="height:60px; width:80px" /></td>
   <td width="10"></td>
   <td width="420">
   <!-- *********************** -->
   <table cellpadding="0" cellspacing="0">
...
<tr><td>
  ...
  <tr>
    <td width="58"></td>
    <td align="center" width="600"><font face="Arial" size="2"><?=htmlentities($fd['DescripCargo'])?></font></td>
    <td width="61"></td>
  </tr>
  <?
