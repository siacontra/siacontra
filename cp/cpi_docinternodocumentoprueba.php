...
<?
 ...
 if($rcon!=0){
   ...
   for($i=0; $i<$rcon; $i++){
	...
	if($fcon['CC']=='S')
	 {
			$dep_cc.='C.c. '.$fc['Dependencia'].'<br/>';
	 }
	 else
	 {
			$nombre=$fc['NomCompleto'];
			$dep=$fc['Dependencia'];
			$car=$fc['DescripCargo'];
	 }
 }
...
<table id="Padre" name="Padre" align="center" cellpadding="0" cellspacing="0" valign="top" style="margin-y:0" >
<tr>
<td>
<? 
...
?>
<table id="principal"  align="center" HEIGHT="900"   valign='top'  style="margin-y:0" >
<tr valign="top"><td width="707" height="92">
  <!-- ************* *************************** MEMORANDUM ********************************************** -->
  <table align="center">
  <tr><td>
  <!-- CABECERA DEL DOCUMENTO -->
  <table width="679" align="right" id="cabecera" cellpadding="0" cellspacing="0" valign="top" style="margin-y:0" >
  <tr>
   <td width="3"></td>
...
<tr><td height="29">
   ...
   <tr>
    ...
    <td width="26"></td>
    <td width="396"></td>
    <td width="170" align="left"><font face="Arial"><b>N&ordm;: <?=$cod_documentocompleto?></b></font></td>
   </tr>
   </table>
   <!-- *********************** -->
</td></tr>
...
<tr><td height="129">
  ...
  <table id="cuerpo1" cellpadding="0" cellspacing="0" valign="top" style="margin-y:0" >
  <tr>
    <td width="34"></td>
        <td width="79"><font face="Arial"  style=" font-size:14px; line-height: 1.2em"><b>PARA</b></font></td>
    <td width="563"><font face="Arial"  style=" font-size:14px; line-height: 1.2em"><b>: <?=htmlentities($dep);?></b></font></td>
  </tr>
  <tr>
    <td width="34"></td>
    <td width="79"></td>
    <td width="563"><font face="Arial" style=" font-size:14px; line-height: 1em">: <?=htmlentities($nombre.' / '.$car);?></font></td>
  </tr>
   <tr><td height="5"></td></tr>
  <tr>
    <td></td>
...
<tr><td height="101">
  ...
  <tr>
    <td width="58"></td>
    <td align="center" height="25"><font face="Arial" size="3">Atentamente,</font></td>
    <td width="61"></td>
  </tr>
  <tr>
    <td width="58"></td>
  ...
  <?
   ...
   $fd = mysql_fetch_array($qd); 
    ...
    if(stristr($fd['DescripCargo'], ' ', true) == 'DIRECTOR')
    {
        $dir = stristr($fd['DescripCargo'], ' ', true);
    }
    else 
	$dir =$fd['DescripCargo'];
  ?>
    <td width="58"></td>
    <td align="center" width="365"><font face="Arial" size="3"><b><?=htmlentities($fb['NomCompleto'])?></b></font></td>
    <td width="61"></td>
  </tr>
  <tr>
    <td width="58"></td>
...
<tr valign='bottom'><td height="auto">
  <!-- *********************** -->
 <table width="686" id="pie_pagina" valign='bottom'>
	 	    <tr>
     <td width="26"></td>
     <td width="70" colspan="2"><font face="Arial" size="1"><?=$dep_cc?></font></td>
    
     <td width="149" align="right"></td>
  </tr>
  <tr valign='baseline'>
     <td width="26" height="20" ></td>
     <td width="70" height="20" ><font face="Arial" size="2"><?=$fa['MediaFirma']?></font></td>
     <td width="421"></td>
     <td width="149" align="right"></td>
  </tr>
  <tr valign='baseline'>
     <td width="26" height="20" ></td>
     <td width="120" height="20" colspan ="2"><font face="Arial" size="1"><?=$fa['DescripcionAnexo']?></font></td>
...
<tr valign="bottom"><td height="20">
  <!-- *********************** -->
			   ...
			   <tr><td>
						...
						<tr><td colspan="2" align="right" style=" font-size:10px; line-height: 0.8em;"><b></b></td></tr>
						</table>
			  </td></tr>	   
...
<tr>
  ...
  <tr>
    <td width="119" align="center"><img src="imagenes/logos/contraloria.jpg" width="64" height="83"/></td>
    <td width="397">
...
<? list($ano, $meses, $dia) = SPLIT('[-]',$fa['FechaRegistro']);
...
<tr><td width="707">
  ...
  <tr>
   <td width="3"></td>
   <td width="124" align="center"><img src="../imagenes/logos/contraloria.jpg" style="height:75px; width:120px" /></td>
   <td width="10"></td>
   <td width="420">
   <!-- *********************** -->
   <table cellpadding="0" cellspacing="0">
  ...
  <tr>
   ...
   <!-- *********************** -->   </td>
   <td width="266" align="center"><img src="imagenes/logoContraloria.jpg" style="height:80px; width:80px"/></td>
  </tr>
  <tr>
    <td></td>
    <td></td>
    <td></td>
    <td colspan="2"><div align="right">Matur&iacute;n,
      <?=$dia;?> 
      de 
      <?=$mes;?> 
      de 
...
<tr><td>
   ...
   <tr>
    ...
    <td width="0"></td>
    <td width="268"></td>
    <td width="148" align="center"><font size="3" face="Arial"><b>CIRCULAR</b></font></td>
    <td width="0"></td>
  </tr>
  <tr><td height="5"></td></tr>
  </table>
...
<tr><td>
  ...
  ?>
    <td width="58"></td>
    <td align="center" width="365"><font face="Arial" size="2"><?=htmlentities($fb['NomCompleto'])?></font></td>
    <td width="61"></td>
  </tr>
  <tr>
    <td width="58"></td>
...
<tr><td>
  ...
  <tr valign='baseline'>
     <td width="26" height="20" ></td>
     <td width="70" height="20" colspan="2"><font face="Arial" size="1"><?=htmlentities($fa['DescripcionAnexo'])?></font></td>
