...
<tr>
  ...
  <table width="800px" class="tblBotones">
   <tr>
 	<td align="right">
    <input type="button" class="btLista" id="btInsertarEmpleado" value="Ins. Org." onclick="Verificar()|cargarVentana(this.form,'lista_organismosext.php?limit=0&ventana=insertarDestinatarioOrgExt&tabla=item', 'height=600, width=800, left=50, top=50, resizable=yes');" />
    <input type="button" class="btLista" id="btInsertarDependencia" value="Ins. Dep." onclick="Verificar()|cargarVentana(this.form,'lista_dependenciasext.php?limit=0&ventana=insertarDestinatarioDepExt&tabla=item', 'height=600, width=800, left=50, top=50, resizable=yes');" />
    ...
    <tr>
      ...
      <table width="800px" class="tblLista">
       <tr>
        ...
        <th scope="col" class="trListaHead">Atención</th>
        </tr>
