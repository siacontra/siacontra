...
<table width="700" class="tblForm">
  ...
  <tr>
    ...
    <td>
    	<? if ($field['FlagSocial'] == "S") $orgsocialS= "checked"; else $orgsocialN = "checked"; ?>
			<input name="control" type="radio" value="S" <?=$orgsocialS?> disabled /> Si
			<input name="control" type="radio" value="N" <?=$orgsocialN?> disabled /> No
	  </td>
  </tr>
    <tr>
    <td class="tagForm">Org. Social:</td>
