 ...
 if($rcon!=0){
   ...
   for($i=0; $i<$rcon; $i++){
	 ...
	 /*$sb = "select 
			  ...
			  from 
				   mastdependencias md
				   inner join mastpersonas mp on (md.CodPersona = me.CodPersona) 
				   inner join mastempleado me on (mp.CodPersona = me.Codpersona)
				   inner join rh_puestos rp on (rp.CodCargo = me.CodCargo)
			 where 
				     mp.Codpersona='".$fa['Cod_Remitente']."'";*/
...
/*
			select 
			  ...
			  from 
				   mastdependencias md
				   inner join mastempleado me on (md.CodDependencia=me.CodDependencia)
				   inner join mastpersonas mp on (mp.CodPersona = me.CodPersona) 
				   inner join rh_puestos rp on (rp.CodCargo = me.CodCargo)
			 where 
				     mp.Codpersona='".$fa['Cod_Remitente']."'*/
//and md.CodInterno = '".$fa['CodInterno']."'
//echo $sb;
...
?>
<table id="Padre" name="Padre" align="center" cellpadding="0" cellspacing="0" HEIGHT="850">
<tr>
<td>
<? 
...
?>
<table id="principal"  align="center" height="792" border='0px' >
...
<tr><td height="29">
   ...
   <tr>
    ...
    <td width="26"></td>
    <td width="436"></td>
    <td width="150"><font face="Arial"><b>N&ordm;: <?=$cod_documentocompleto?></b></font></td>
   </tr>
   </table>
   <!-- *********************** -->
</td></tr>
...
<tr><td height="101">
  ...
  ?>
    <td width="58"></td>
    <td align="center" width="365"><font face="Arial" size="3"><?=htmlentities($fb['NomCompleto'])?></font></td>
    <td width="61"></td>
  </tr>
  <tr>
    <td width="58"></td>
