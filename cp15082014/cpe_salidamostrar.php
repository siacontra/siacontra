...
<form name="framemain" action="<?=$regresar?>.php?limit=0&accion=guardarContenido" method="post">
...
<tr>
  ...
  <tr>
     ...
     <td width="122" class="tagForm">Fecha Documento:</td>
         ...
         ?>
     <td width="319"><input type="text" id="fecha_documento" name="fecha_documento" size="10" value="<?=$f_registro;?>" style="text-align:right" readonly/>*(dd-mm-aaaa)</td>
  </tr>
  </table>
  </td>
</tr>
<tr>
 ...
 <tr>
     ...
     <td><input type="text" id="ndoc_completo" name="ndoc_completo" size="22" value="<?=$f['Cod_DocumentoCompleto']?>" readonly/></td>
 <tr>
 ...
 <tr>
  ...
  <tr>
     <td colspan="4">
		<p>
		  <textarea class="ckeditor" cols="80" id="editor1" name="editor1" rows="10" readonly="readonly"></textarea>
		</p>
    </td>
  </tr>
</table>
<center>
    <input type="submit" value="Guardar Registro"/><input type="button" value="Cancelar" onClick="cargarPagina(this.form,'<?=$regresar?>.php?limit=0');" />
</center>
</form>
</body>
</html>
