...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Maestro Particular | Ver Registro</td>
...
<tr>
 ...
 <td><input type="text" id="cedula" name="cedula" size="15" maxlength="12" value="<?=$f['Cedula']?>" readonly/>*</td>
</tr>
<tr>
 <td class="tagForm">Nombre y Apellido:</td>
 <td><input type="text" id="nombre" name="nombre" size="40" value="<?=$f['Nombre']?>" readonly/>*</td>
</tr>
<!--<tr>
 <td class="tagForm">apellido(s):</td>
 <td><input type="text" id="apellido" name="apellido" size="40" value="<?=$f['Apellido']?>" readonly/>*</td>
</tr>-->
<tr>
 <td class="tagForm">Direcci&oacute;n:</td>
 <td><input type="text" id="direccion" name="direccion" size="20" value="<?=$f['Direccion']?>" readonly/></td>
</tr>
<tr>
 <td class="tagForm">Nro. Tel&eacute;fono:</td>
 <td><input type="text" id="telefono" name="telefono" size="20" value="<?=$f['Telefono']?>" readonly/></td>
</tr>
<tr>
 <td class="tagForm">Cargo:</td>
 <td><input type="text" id="cargo" name="cargo" size="40" value="<?=$f['Cargo']?>" readonly/></td>
</tr>
