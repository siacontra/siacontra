...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Maestro Particular | Nuevo Registro</td>
...
<form id="frmentrada" name="frmentrada" action="cpe_particular.php?limit=0&accion=guardarParticular" method="post">
...
<tr> 
 ...
 <td width="494"><input type="text" id="cod_particular" name="cod_particular" size="8" maxlength="4" readonly="readonly"/></td>
</tr>
<tr><td height="10"></td></tr>
<tr>
 <td class="tagForm">N° Cedula:</td>
 <td><input type="text" id="cedula" name="cedula" size="15" maxlength="12"/>*</td>
</tr>
<tr>
...
<!--<tr>
 ...
 <td><input type="text" id="apellido" name="apellido" size="40"/>*</td>
</tr>-->
<tr>
...
<tr>
 ...
 <td><input type="text" id="telefono" name="telefono" size="20"/></td>
</tr><tr>
