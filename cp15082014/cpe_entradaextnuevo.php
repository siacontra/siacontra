...
<form name="frmentrada" id="frmentrada" action="framemain.php?limit=0&accion=GuardarEntradaExterna" method="post" onsubmit="return VerificarDatos(this);">
 ...
 <tr>
   <td><!--//// ---------------------------------------------------------------------------//// -->
    ...
    <input name="cod_cargoremit" type="hidden" id="cod_cargoremit" value="" />
        <input name="nomempleado" id="nomempleado" type="text" size="61" />
...
function VerificarDatos(formulario){
  ...
  if(formulario.activar.checked==true){
	  ...
	  if (!allValid) { 
		alert("TTT Elija el Particular Remitente haciendo click en el boton \"...\""); 
		formulario.nombreParticular.focus(); 
		return (false); 
	  }
  }
